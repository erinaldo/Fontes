...
If XmlChildEx(oXml, UPPER("_esocial")) <> NIL
	oXMLSeek := XmlChildEx(oXml, UPPER("_esocial"))
	If XmlChildEx(oXMLSeek, UPPER("_envioloteeventos")) <> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_envioloteeventos"))
		If XmlChildEx(oXMLSeek, UPPER("_eventos")) <> NIL
			oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_eventos"))
			If XmlChildEx(oXMLSeek, UPPER("_evento")) <> NIL
				oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evento"))
				
				If valtype(oXMLSeek) == 'A'
					oXMLSeek := oXMLSeek[1]
				EndIf
				
				If XmlChildEx(oXMLSeek, UPPER("_esocial")) <> NIL
					oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_esocial"))
				EndIf
			EndIf
		EndIf
	EndIf
EndIf
/*
Inicio do processamento do Eventos
1005
1010
1020
1030
...
If XmlChildEx(oXMLSeek, UPPER("_evtTabEstab"))<> NIL  //Evento 1005
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evtTabEstab"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "1005"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_evtTabEstab:_ideEmpregador:_nrInsc:text
			GPlogMsg( "***GETEVENTO*** Identificado o evento evtTabEstab.", nil )
		EndIf
	EndIf

ElseIf XmlChildEx(oXMLSeek, UPPER("_evttabrubrica"))<> NIL //Evento 1010
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evttabrubrica"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "1010"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_evttabrubrica:_ideEmpregador:_nrInsc:text
...
ElseIf XmlChildEx(oXMLSeek, UPPER("_evtTabLotacao"))<> NIL //Evento 1020
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evtTabLotacao"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "1020"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_evtTabLotacao:_ideEmpregador:_nrInsc:text
			GPlogMsg( "***GETEVENTO*** Identificado o evento evtTabLotacao.", nil )
		EndIf
	EndIf

ElseIf XmlChildEx(oXMLSeek, UPPER("_evtTabCargo"))<> NIL //Evento 1030
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evtTabCargo"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "1030"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_evtTabCargo:_ideEmpregador:_nrInsc:text
			GPlogMsg( "***GETEVENTO*** Identificado o evento evtTabCargo.", nil )
		EndIf
	EndIf

ElseIf XmlChildEx(oXMLSeek, UPPER("_evtTabHorTur"))<> NIL //Evento 1050	
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evtTabHorTur"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "1050"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_evtTabHorTur:_ideEmpregador:_nrInsc:text
			GPlogMsg( "***GETEVENTO*** Identificado o evento evtTabHorTur.", nil )
		EndIf
	EndIf

ElseIf XmlChildEx(oXMLSeek, UPPER("_evtAdmissao"))<> NIL //Evento 2200	
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evtAdmissao"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "2200"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_evtAdmissao:_ideEmpregador:_nrInsc:text
			GPlogMsg( "***GETEVENTO*** Identificado o evento evtAdmissao.", nil )
		EndIf
	EndIf

ElseIf XmlChildEx(oXMLSeek, UPPER("_evtTSVInicio"))<> NIL //Evento 2300	
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_evtTSVInicio"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "2300"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_evtTSVInicio:_ideEmpregador:_nrInsc:text
...
ElseIf XmlChildEx(oXMLSeek, UPPER("_retornoProcessamentoLoteEventos"))<> NIL //Evento retorno
	oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_retornoProcessamentoLoteEventos"))
	If XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))<> NIL
		oXMLSeek := XmlChildEx(oXMLSeek, UPPER("_ideEmpregador"))
		If XmlChildEx(oXMLSeek, UPPER("_nrInsc"))<> NIL
			cEvento := "RETORNO"
			cXmlFit := oXMLSeek:_nrInsc:text //oXMLSeek:_retornoProcessamentoLoteEventos:_ideEmpregador:_nrInsc:text
