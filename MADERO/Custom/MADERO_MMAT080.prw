...
static function lotCopy(oTempEmps, oTempRegs, aExceptions)
	...
	Local oRegua   := MaderoProcess():new( {|process| prepareCopy(process, aProcess, oTempEmps, aStruct,{/*duplicates*/}, @aExceptions) })
...
static function simpleCopy(oTemp, aDuplicates, aExceptions)
	...
	Local lContinue := .T.
	Local aProcess := {}
	Local oRegua   := MaderoProcess():new( {|process| prepareCopy(process, aProcess, oTemp, {getStruct()}, aDuplicates,@aExceptions) })
