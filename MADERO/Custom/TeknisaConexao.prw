...
Local oRestClient
Local cReturn
Local cUrl := SuperGetMv("MD_TEKURL",,"http://172.16.0.132:8099/api")
Private oXml
	...
	If oRestClient:Get()
		...
		If oXml != Nil .And. type("oXml:_RETORNOS:_RETORNO:_RETORNO:_INTEGRADO:TEXT") != "U"
			...
			Else
				ConOut("Erro naConexao: "+oXml:_RETORNOS:_RETORNO:_RETORNO:_MENSAGEM:TEXT)
				::oEventLog:broken("Conexao: "+oXml:_RETORNOS:_RETORNO:_RETORNO:_MENSAGEM:TEXT, "", .T.)
			EndIf
		EndIf
	EndIf
