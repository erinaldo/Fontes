...
Local lRet := .T.
	...
	Z05->Z05_VALOR1	:= U_CharToVal(oMovimento:_SANGRIA:TEXT,"Z05_VALOR")
	Z05->Z05_VALOR2	:= U_CharToVal(oMovimento:_SISTEMA:TEXT,"Z05_VALOR")
	Z05->Z05_VALOR	:= U_CharToVal(oMovimento:_VRMOVIMENTO:TEXT,"Z05_VALOR")
