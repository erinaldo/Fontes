	...
	Local aErros := {}
		...
		dbSelectArea("NNR")
			...
			If !( NNR->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Armazém padrão não cadastrado - [FILIAL:"+cFilAnt+"][COD. ARM:"+cLocPad+"]" )
			EndIf
			...
			If !( Z18->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Grupo Teknisa Nível 1 não cadastrado - [FILIAL:"+cFilAnt+"][TEK NIVEL 1:"+B1_XN1+"]" )
			EndIf
			...
			If !( Z19->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Grupo Teknisa Nível 2 não cadastrado - [FILIAL:"+cFilAnt+"][TEK NIVEL 2:"+B1_XN2+"]" )
			EndIf
			...
			If !( Z20->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Grupo Teknisa Nível 3 não cadastrado - [FILIAL:"+cFilAnt+"][TEK NIVEL 3:"+B1_XN3+"]" )
			EndIf
			...
			If !( Z21->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Grupo Teknisa Nível 4 não cadastrado - [FILIAL:"+cFilAnt+"][TEK NIVEL 4:"+B1_XN4+"]" )
			Endif
			...
			If !( SX5->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Tipo customizado de produto não cadastrado - [FILIAL:"+cFilAnt+"][B1_XTIPO:"+B1_XTIPO+"]" )
			Endif

			SX5->(DbSeek(xFilial("SX5")+"Z3"+B1_XTIPO))
			If !( SX5->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Classe de produto não cadastrada - [FILIAL:"+cFilAnt+"][B1_XCLAS:"+B1_XCLAS+"]" )
			Endif
			...
			If !( SX5->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Classe de produto não cadastrada - [FILIAL:"+cFilAnt+"][B1_TIPO:"+B1_TIPO+"]" )
			Endif
			...
			If !( SX5->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Origem não cadastrada - [FILIAL:"+cFilAnt+"][B1_ORIGEM:"+B1_ORIGEM+"]" )
			Endif
			...
			If !( SAH->( Found() ) )
				lErro := .T.
				lErroGlb := .T.
				AADD(aErros,"Unidade de medida não cadastrada - [FILIAL:"+cFilAnt+"][B1_UM:"+B1_UM+"]" )
			Endif
