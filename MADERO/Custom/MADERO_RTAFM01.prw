...
If nOpcX == 3
	If Len( aTits := U_RTAFM01A( cPrefix, cTipo, cNaturez, cCodFor, cLojFor, dEmissao, dEmissao ) ) > 0
		SE2->( dbGoTo( aTits[ 1 ] ) )
		lExistSE2 := .T.
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function RTAFM01A( cPrefix, cTipo, cNaturez, cCodFor, cLojFor, dEmiDe, dEmiAte, lSaldo )
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function RTAFM01B( dDatEmi, cTipoTit, nValor, aProvisorios )
...
Else
	...
	If nTipo > 0
		...
		lRet := U_RTAFM01B( dFimPer, cTipoEfe, nValor, aProvisorios )
	EndIf
EndIf
