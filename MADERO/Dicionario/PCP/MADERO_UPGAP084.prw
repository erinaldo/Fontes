...
/*/
//--------------------------------------------------------------------
User Function UPGAP084( cEmpAmb, cFilAmb )
...
Local   cDesc2    := " dos processos implementados no GAP 084.                                                "
...
aAdd( aSX2, { ;
	'ZIA'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZIA'+cEmpr																, ; //X2_ARQUIVO
	'TIPOS ETIQUETAS - PCP'													, ; //X2_NOME
	'TIPOS ETIQUETAS - PCP'													, ; //X2_NOMESPA
	'TIPOS ETIQUETAS - PCP'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	'ZIB'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZIB'+cEmpr																, ; //X2_ARQUIVO
	'PRODUTO - TIPOS DE ETIQUETAS'											, ; //X2_NOME
	'PRODUTO - TIPOS DE ETIQUETAS'											, ; //X2_NOMESPA
	'PRODUTO - TIPOS DE ETIQUETAS'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Inf.Nutricio'															, ; //X3_TITULO
	'Inf.Nutricio'															, ; //X3_TITSPA
	'Inf.Nutricio'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Impressora'															, ; //X3_TITULO
	'Impressora'															, ; //X3_TITSPA
	'Impressora'															, ; //X3_TITENG
	'Impressora'															, ; //X3_DESCRIC
	'Impressora'															, ; //X3_DESCSPA
	'Impressora'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Qt. Etiqueta'															, ; //X3_TITULO
	'Qt. Etiqueta'															, ; //X3_TITSPA
	'Qt. Etiqueta'															, ; //X3_TITENG
	'Quantidade Etiqueta'													, ; //X3_DESCRIC
	'Quantidade Etiqueta'													, ; //X3_DESCSPA
	'Quantidade Etiqueta'													, ; //X3_DESCENG
	'99999'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'TipoEtiqueta'															, ; //X3_TITULO
	'TipoEtiqueta'															, ; //X3_TITSPA
	'TipoEtiqueta'															, ; //X3_TITENG
	'Tipo Etiqueta'															, ; //X3_DESCRIC
	'Tipo Etiqueta'															, ; //X3_DESCSPA
	'Tipo Etiqueta'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Imprime no Apontamento'												, ; //X3_DESCRIC
	'Imprime no Apontamento'												, ; //X3_DESCSPA
	'Imprime no Apontamento'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Desc.Etiquet'															, ; //X3_TITULO
	'Desc.Etiquet'															, ; //X3_TITSPA
	'Desc.Etiquet'															, ; //X3_TITENG
	'Desc.Etiqueta'															, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSIX, { ;
	'ZIB'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZIB_FILIAL+ZIB_PRODUT+ZIB_TPETQ'										, ; //CHAVE
	'Produto+Etiqueta'														, ; //DESCRICAO
	'Produto+Etiqueta'														, ; //DESCSPA
	'Produto+Etiqueta'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSXA, { ;
	'SB1'																	, ; //XA_ALIAS
	'9'																		, ; //XA_ORDEM
	'Tab.Preco'																, ; //XA_DESCRIC
	'Tab.Preco'																, ; //XA_DESCSPA
	'Tab.Preco'																, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
