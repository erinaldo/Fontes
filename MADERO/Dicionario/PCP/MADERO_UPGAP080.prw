...
/*/
//--------------------------------------------------------------------
User Function UPGAP080( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Prd Perd Rec'															, ; //X3_TITULO
	'Prd Perd Rec'															, ; //X3_TITSPA
	'Prd Perd Rec'															, ; //X3_TITENG
	'Prod apont perda recupera'												, ; //X3_DESCRIC
	'Prod apont perda recupera'												, ; //X3_DESCSPA
	'Prod apont perda recupera'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
