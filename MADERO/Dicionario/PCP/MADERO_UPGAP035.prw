...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Empenho de Produção'													, ; //XB_DESCRI
	'Empenho de Produção'													, ; //XB_DESCSPA
	'Empenho de Produção'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SD4'																	} ) //XB_CONTEM
...
aAdd( aSX3, { ;
	...
	11																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Tara Padrão'															, ; //X3_TITULO
	'Tara Padrão'															, ; //X3_TITSPA
	'Tara Padrão'															, ; //X3_TITENG
	'Tara Padrão do produto'												, ; //X3_DESCRIC
	'Tara Padrão do produto'												, ; //X3_DESCSPA
	'Tara Padrão do produto'												, ; //X3_DESCENG
