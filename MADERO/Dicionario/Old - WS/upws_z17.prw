...
/*/
//--------------------------------------------------------------------
User Function UPWS_Z17( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPWS_Z17" )
				Else
					MsgStop( "Atualização não Realizada.", "UPWS_Z17" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, {'Z17','02','Z17_COD','C',15,0,'Cod. Produto','Cod. Produto','Cod. Produto','Codigo so Produto','Codigo so Produto','Codigo so Produto','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','SB1',0,Chr(254) + Chr(192),'','','U','N','A','R','','ExistCpo("SB1")','','','','','','','','','','','','N','','','N','','',''} )
...
aHlpPor := {}
aAdd( aHlpPor, 'Codigo so Produto' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ17_COD   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_COD" )
...
PutHelp( "PZ17_XSTINT", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XSTINT" )

aHlpPor := {}
aAdd( aHlpPor, 'Data ult.integr.Teknisa' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ17_XDINT ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XDINT" )

aHlpPor := {}
aAdd( aHlpPor, 'Hora ult.intgr. Telnisa' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ17_XHINT ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XHINT" )

aHlpPor := {}
aAdd( aHlpPor, 'Codigo externo do produto' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ17_XCODEX", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XCODEX" )

aHlpPor := {}
aAdd( aHlpPor, 'Cod. Arv. Produto' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ17_XCDARV", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XCDARV" )

aHlpPor := {}
aAdd( aHlpPor, 'Emp. Teknisa' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ17_XEMP  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XEMP" )

aHlpPor := {}
aAdd( aHlpPor, 'Cod Filial Teknisa' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ17_XFIL  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XFIL" )
...
PutHelp( "PZ17_XATIVO", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z17_XATIVO" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPWS_Z17" ) ) ) ;
