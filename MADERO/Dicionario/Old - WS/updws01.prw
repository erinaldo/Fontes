...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDWS01" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDWS01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aHlpPor := {}
aAdd( aHlpPor, 'Código externo do componente (sub' )
aAdd( aHlpPor, 'produto)' )
aHlpEng := {}
aHlpSpa := {}
...
aHlpPor := {}
aAdd( aHlpPor, 'Número de integrações do' )
...
aHlpPor := {}
aAdd( aHlpPor, 'Data da última integração' )
...
aHlpPor := {}
aAdd( aHlpPor, 'Hora da última integração' )
aAdd( aHlpPor, 'com o TEKNISA' )
aHlpEng := {}
aHlpSpa := {}
