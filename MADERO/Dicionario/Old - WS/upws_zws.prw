...
/*/
//--------------------------------------------------------------------
User Function UPWS_ZWS( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPWS_ZWS" )
				Else
					MsgStop( "Atualização não Realizada.", "UPWS_ZWS" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, {'ZWS','11','ZWS_ITCONF','N',12,0,'Confirmados','Confirmados','Confirmados','Número de item integrados','Número de item integrados','Número de item integrados','@E 999,999,999,999','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','N','A','R','','','','','','','','','','','','','','N','','','N','','',''} )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPWS_ZWS" ) ) ) ;
