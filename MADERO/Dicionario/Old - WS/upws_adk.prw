...
/*/
//--------------------------------------------------------------------
User Function UPWS_ADK( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPWS_ADK" )
				Else
					MsgStop( "Atualização não Realizada.", "UPWS_ADK" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, {'ADK','35','ADK_XEMP','C',2,0,'Empr.Teknisa','Empr.Teknisa','Empr.Teknisa','Codigo empresa Teknisa','Codigo empresa Teknisa','Codigo empresa Teknisa','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','N','A','R','','','','','','','','','','1','','','','N','','','N','','',''} )
aAdd( aSX3, {'ADK','37','ADK_XFIL','C',4,0,'Fil.Teknisa','Fil.Teknisa','Fil.Teknisa','Codigo Filial Teknisa','Codigo Filial Teknisa','Codigo Filial Teknisa','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','N','A','R','','','','','','','','','','1','','','','N','','','N','','',''} )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPWS_ADK" ) ) ) ;
