...
/*/
//--------------------------------------------------------------------
User Function GFINA04( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "GFINA04" )
				Else
					MsgStop( "Atualização não Realizada.", "GFINA04" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SE3'																	, .T. }, ; //X3_ARQUIVO
	{ '32'																	, .T. }, ; //X3_ORDEM
	{ 'E3_XNFCOB'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'NF Cobranca'															, .T. }, ; //X3_TITULO
	{ 'NF Cobranca'															, .T. }, ; //X3_TITSPA
	{ 'NF Cobranca'															, .T. }, ; //X3_TITENG
	{ 'Nota Fiscal de Cobranca'												, .T. }, ; //X3_DESCRIC
	{ 'Nota Fiscal de Cobranca'												, .T. }, ; //X3_DESCSPA
	{ 'Nota Fiscal de Cobranca'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
