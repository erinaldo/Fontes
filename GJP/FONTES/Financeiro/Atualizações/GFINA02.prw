...
/*/
//--------------------------------------------------------------------
User Function GFINA02( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "GFINA02" )
				Else
					MsgStop( "Atualização não Realizada.", "GFINA02" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Marcado'																, .T. }, ; //X3_TITSPA
	{ 'Marcado'																, .T. }, ; //X3_TITENG
	{ 'Item marcado'														, .T. }, ; //X3_DESCRIC
	{ 'Item marcado'														, .T. }, ; //X3_DESCSPA
	{ 'Item marcado'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
