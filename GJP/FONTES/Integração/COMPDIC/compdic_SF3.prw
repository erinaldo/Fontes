...
/*/
//--------------------------------------------------------------------
User Function COMP_SF3( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	{ 'SF3'																	, .T. }, ; //X3_ARQUIVO
	{ '01'																	, .T. }, ; //X3_ORDEM
	{ 'F3_REPROC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Perm.Reproc.'														, .T. }, ; //X3_TITULO
	{ 'Perm.Reproc.'														, .T. }, ; //X3_TITSPA
	{ 'Allow Reproc'														, .T. }, ; //X3_TITENG
	{ 'Permitir Reprocessamento'											, .T. }, ; //X3_DESCRIC
	{ 'Permitir Reprocesamiento'											, .T. }, ; //X3_DESCSPA
	{ 'Allow Reprocessing'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	{ 'Origin/Destination Difal'											, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SF3'																	, ; //INDICE
	'9'																		, ; //ORDEM
	'F3_FILIAL+DTOS(F3_ENTRADA)+F3_NFISCAL+F3_SDOC+F3_CLIEFOR+F3_LOJA+F3_CFO+STR(F3_ALIQICM,5,2)', ; //CHAVE
	'DT Entrada + Nota Fiscal + Série Doc. + Clien/Fornec + Loja + Cod. Fis'	, ; //DESCRICAO
	'Fch Entrada + Factura + Serie Doc. + Clien/Provee + Tienda + Cod. Fisc'	, ; //DESCSPA
	'Inflow Date + Invoice + Series Doc. + Cust./Sup. + Unit + Fiscal Code'		, ; //DESCENG
	'S'																		, ; //PROPRI
	'XXX+XXX+XXX+XXX+XXX+13'												, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SF3'																	, ; //INDICE
	'A'																		, ; //ORDEM
	'F3_FILIAL+F3_CLIEFOR+F3_LOJA+F3_NFISCAL+F3_SDOC'						, ; //CHAVE
	'Clien/Fornec + Loja + Nota Fiscal + Série Doc.'						, ; //DESCRICAO
	'Clien/Provee + Tienda + Factura + Serie Doc.'							, ; //DESCSPA
	'Cust./Sup. + Unit + Invoice + Series Doc.'								, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SF3'																	, ; //INDICE
	'B'																		, ; //ORDEM
	'F3_FILIAL+F3_SDOC+F3_NFISCAL+F3_CLIEFOR+F3_LOJA+F3_IDENTFT'			, ; //CHAVE
	'Série Doc. + Nota Fiscal + Clien/Fornec + Loja + Ident. SFT'			, ; //DESCRICAO
	'Serie Doc. + Factura + Clien/Provee + Tienda + Ident. SFT'				, ; //DESCSPA
	'Series Doc. + Invoice + Cust./Sup. + Unit + SFT Ident.'				, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SF3'																	, ; //INDICE
	'C'																		, ; //ORDEM
	'F3_FILIAL+F3_NFISCAL+F3_SDOC'											, ; //CHAVE
	'Nota Fiscal + Série Doc.'												, ; //DESCRICAO
	'Factura + Serie Doc.'													, ; //DESCSPA
	'Invoice + Series Doc.'													, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
