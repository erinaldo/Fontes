...
/*/
//--------------------------------------------------------------------
User Function COMP_SLR( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'IIF(IsInCallStack("FATA701").And.(!FindFunction("LjFTvd").Or.!LjFTVD()),FTVDProd(.T.),Lj7Prod(.T.)) .AND. LjInfoKit()', .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'Desconto do Item'													, .T. }, ; //X3_DESCRIC
	{ 'Descuento del Item'													, .T. }, ; //X3_DESCSPA
	{ 'Item Discount'														, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'LR_VALDESC'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 4																		, .T. }, ; //X3_DECIMAL
	{ 'Valor Desc'															, .T. }, ; //X3_TITULO
	{ 'Valor Dsct.'															, .T. }, ; //X3_TITSPA
	{ 'Discount'															, .T. }, ; //X3_TITENG
	{ 'Valor do Desconto'													, .T. }, ; //X3_DESCRIC
	{ 'Valor del Descuento'													, .T. }, ; //X3_DESCSPA
	{ 'Discount Value'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.9999'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
...
aAdd( aSX3, { ;
	...
	{ 'Alíc. ICMS'															, .T. }, ; //X3_TITSPA
	{ 'ICMS Rate'															, .T. }, ; //X3_TITENG
	{ 'Aliquota de ICMS'													, .T. }, ; //X3_DESCRIC
	{ 'Alícuota de ICMS'													, .T. }, ; //X3_DESCSPA
	{ 'ICMS Rate'															, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E2'																	, .T. }, ; //X3_ORDEM
	{ 'LR_ALIQISS'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Aliq. ISS'															, .T. }, ; //X3_TITULO
	{ 'Alíc. ISS'															, .T. }, ; //X3_TITSPA
	{ 'ISS Rate'															, .T. }, ; //X3_TITENG
	{ 'Aliquota de ISS'														, .T. }, ; //X3_DESCRIC
	{ 'Alícuota de ISS'														, .T. }, ; //X3_DESCSPA
	{ 'ISS Rate'															, .T. }, ; //X3_DESCENG
	{ '@E 99.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E3'																	, .T. }, ; //X3_ORDEM
	{ 'LR_BASEISS'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Base de ISS'															, .T. }, ; //X3_TITULO
	{ 'Base de ISS'															, .T. }, ; //X3_TITSPA
	{ 'ISS Base'															, .T. }, ; //X3_TITENG
	{ 'Base de Cálculo do ISS'												, .T. }, ; //X3_DESCRIC
	{ 'Base de cálculo del ISS'												, .T. }, ; //X3_DESCSPA
	{ 'ISS Calc. Base'														, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E4'																	, .T. }, ; //X3_ORDEM
	{ 'LR_ALQIRRF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Aliq. IRRF'															, .T. }, ; //X3_TITULO
	{ 'Alíc. IRRF'															, .T. }, ; //X3_TITSPA
	{ 'IRRF Rate'															, .T. }, ; //X3_TITENG
	{ 'Aliquota de IRRF'													, .T. }, ; //X3_DESCRIC
	{ 'Alícuota de IRRF'													, .T. }, ; //X3_DESCSPA
	{ 'IRRF Rate'															, .T. }, ; //X3_DESCENG
	{ '@E 99.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E5'																	, .T. }, ; //X3_ORDEM
	{ 'LR_VALIRRF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Valor IRRF'															, .T. }, ; //X3_TITULO
	{ 'Valor IRRF'															, .T. }, ; //X3_TITSPA
	{ 'IRRF Value'															, .T. }, ; //X3_TITENG
	{ 'Valor de IRRF'														, .T. }, ; //X3_DESCRIC
	{ 'Valor de IRRF'														, .T. }, ; //X3_DESCSPA
	{ 'IRRF Value'															, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E6'																	, .T. }, ; //X3_ORDEM
	{ 'LR_BASIRRF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Base de IRRF'														, .T. }, ; //X3_TITULO
	{ 'Base de IRRF'														, .T. }, ; //X3_TITSPA
	{ 'IRRF Base'															, .T. }, ; //X3_TITENG
	{ 'Base de Cálculo do IRRF'												, .T. }, ; //X3_DESCRIC
	{ 'Base de Cálculo del IRRF'											, .T. }, ; //X3_DESCSPA
	{ 'IRRF Calc. Base'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E7'																	, .T. }, ; //X3_ORDEM
	{ 'LR_ALIQCOF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Aliq. Cofins'														, .T. }, ; //X3_TITULO
	{ 'Alíc. Cofins'														, .T. }, ; //X3_TITSPA
	{ 'Cofins Rate'															, .T. }, ; //X3_TITENG
	{ 'Aliq. de Retencao Cofins'											, .T. }, ; //X3_DESCRIC
	{ 'Alíc. de Retención Cofins'											, .T. }, ; //X3_DESCSPA
	{ 'Cofins Withhold. Rate'												, .T. }, ; //X3_DESCENG
	{ '@E 99.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E8'																	, .T. }, ; //X3_ORDEM
	{ 'LR_BASEPIS'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Base Pis'															, .T. }, ; //X3_TITULO
	{ 'Base Pis'															, .T. }, ; //X3_TITSPA
	{ 'Pis Base'															, .T. }, ; //X3_TITENG
	{ 'Base de Retencao de Pis'												, .T. }, ; //X3_DESCRIC
	{ 'Base de retención de Pis'											, .T. }, ; //X3_DESCSPA
	{ 'Pis Withhold. Base'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'E9'																	, .T. }, ; //X3_ORDEM
	{ 'LR_BASECOF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Base Confins'														, .T. }, ; //X3_TITULO
	{ 'Base Confins'														, .T. }, ; //X3_TITSPA
	{ 'Cofins Base'															, .T. }, ; //X3_TITENG
	{ 'Base de Retencao Cofins'												, .T. }, ; //X3_DESCRIC
	{ 'Base de retención Cofins'											, .T. }, ; //X3_DESCSPA
	{ 'Cofins Withhold. Base'												, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'F0'																	, .T. }, ; //X3_ORDEM
	{ 'LR_ALIQPIS'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Aliq. Pis'															, .T. }, ; //X3_TITULO
	{ 'Alíc. Pis'															, .T. }, ; //X3_TITSPA
	{ 'Pis Rate'															, .T. }, ; //X3_TITENG
	{ 'Aliq. de Retencao de Pis'											, .T. }, ; //X3_DESCRIC
	{ 'Alíc. de Retención de Pis'											, .T. }, ; //X3_DESCSPA
	{ 'Pis Withhold. Rate'													, .T. }, ; //X3_DESCENG
	{ '@E 99.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'F1'																	, .T. }, ; //X3_ORDEM
	{ 'LR_BASCSLL'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Base de CSLL'														, .T. }, ; //X3_TITULO
	{ 'Base de CSLL'														, .T. }, ; //X3_TITSPA
	{ 'CSLL Base'															, .T. }, ; //X3_TITENG
	{ 'Base de Calculo do CSLL'												, .T. }, ; //X3_DESCRIC
	{ 'Base de cálculo del CSLL'											, .T. }, ; //X3_DESCSPA
	{ 'CSLL Calculation Base'												, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'F2'																	, .T. }, ; //X3_ORDEM
	{ 'LR_ALQCSLL'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Aliq. CSLL'															, .T. }, ; //X3_TITULO
	{ 'Alíc. CSLL'															, .T. }, ; //X3_TITSPA
	{ 'CSLL Rate'															, .T. }, ; //X3_TITENG
	{ 'Aliquota de CSLL'													, .T. }, ; //X3_DESCRIC
	{ 'Alícuota de CSLL'													, .T. }, ; //X3_DESCSPA
	{ 'CSLL Rate'															, .T. }, ; //X3_DESCENG
	{ '@E 99.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLR'																	, .T. }, ; //X3_ARQUIVO
	{ 'F5'																	, .T. }, ; //X3_ORDEM
	{ 'LR_POSIPI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Pos.IPI/NCM'															, .T. }, ; //X3_TITULO
	{ 'Pos.IPI/NCM'															, .T. }, ; //X3_TITSPA
	{ 'Pos.IPI/NCM'															, .T. }, ; //X3_TITENG
	{ 'Nomenclatura Ext.Mercosul'											, .T. }, ; //X3_DESCRIC
	{ 'Nomenclatura Ext.Mercosul'											, .T. }, ; //X3_DESCSPA
	{ 'Ext.Nomenclature Mercosul'											, .T. }, ; //X3_DESCENG
	{ '@R 9999.99.99'														, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
