...
/*/
//--------------------------------------------------------------------
User Function COMP_FO9( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'FO9'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'FO9'+cEmpr																, ; //X2_ARQUIVO
	'Fatura Hotel x Notas'													, ; //X2_NOME
	'Factura Hotel vs. Notas'												, ; //X2_NOMESPA
	'Hotel Invoice x Invoices'												, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
	'FO9_FILIAL+FO9_NUMFAT+FO9_CLIFAT+FO9_LOJFAT+FO9_SERIE+FO9_NUMDOC'		, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	...
	{ 'Ítem'																, .T. }, ; //X3_TITSPA
	{ 'Item'																, .T. }, ; //X3_TITENG
	{ 'Item da Fatura'														, .T. }, ; //X3_DESCRIC
	{ 'Ítem de la factura'													, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data Emissão'														, .T. }, ; //X3_TITULO
	{ 'Fecha Emissã'														, .T. }, ; //X3_TITSPA
	{ 'Issue Date'															, .T. }, ; //X3_TITENG
	{ 'Data de Emissão.'													, .T. }, ; //X3_DESCRIC
	{ 'Fecha de emisión'													, .T. }, ; //X3_DESCSPA
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!INCLUI,Posicione(' + DUPLAS  + 'SL1' + DUPLAS  + ',2,FWxFilial(' + DUPLAS  + 'SL1' + DUPLAS  + ')+FO9->FO9_SERIE+FO9->FO9_NUMDOC,' + DUPLAS  + 'L1_EMISNF' + DUPLAS  + '), CTOD(' + SIMPLES + '' + SIMPLES + ') )', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Valor'																, .T. }, ; //X3_TITSPA
	{ 'Value'																, .T. }, ; //X3_TITENG
	{ 'Valor da nota.'														, .T. }, ; //X3_DESCRIC
	{ 'Valor de la factura'													, .T. }, ; //X3_DESCSPA
	{ 'Invoice Value'														, .T. }, ; //X3_DESCENG
	{ '@E 9,999,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!INCLUI,Posicione("SL1",2,FWxFilial("SL1")+FO9->FO9_SERIE+FO9->FO9_NUMDOC,"L1_VLRTOT"), 0 )', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSIX, { ;
	'FO9'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'FO9_FILIAL+FO9_NUMFAT+FO9_CLIFAT+FO9_LOJFAT+FO9_SERIE+FO9_NUMDOC'		, ; //CHAVE
	'Num. Fatura + Cod. Cliente + Loja + Série + Num. Doc.'					, ; //DESCRICAO
	'Nº Factura + Cód. Cliente + Tienda + Serie + Nº Doc.'					, ; //DESCSPA
	'Inv Number + Cust Code + Store + Series + Doc Number'					, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
