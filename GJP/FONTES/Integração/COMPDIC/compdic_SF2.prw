...
/*/
//--------------------------------------------------------------------
User Function COMP_SF2( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'D1'																	, .T. }, ; //X3_ORDEM
	{ 'F2_CHVNFE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 44																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Chave NFe'															, .T. }, ; //X3_TITULO
	{ 'Clave eFact'															, .T. }, ; //X3_TITSPA
	{ 'NFe Key'																, .T. }, ; //X3_TITENG
	{ 'Chave da NFe SEFAZ'													, .T. }, ; //X3_DESCRIC
	{ 'Clave de la eFact y SEFAZ'											, .T. }, ; //X3_DESCSPA
	{ 'SEFAZ NFe Key'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
