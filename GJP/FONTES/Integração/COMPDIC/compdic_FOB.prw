...
/*/
//--------------------------------------------------------------------
User Function COMP_FOB( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'FOB'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'FOB'+cEmpr																, ; //X2_ARQUIVO
	'Fatura Hotel x Comissao'												, ; //X2_NOME
	'Factura Hotel vs. Comisión'											, ; //X2_NOMESPA
	'Hotel x Commission Invoice'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
	'FOB_FILIAL+FOB_NUMFAT+FOB_CLIFAT+FOB_LOJFAT+FOB_PREFIX+FOB_NUM+FOB_PARCEL+FOB_TIPO', ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	{ 'FOB'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'FOB_NUMFAT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Num. Fatura'															, .T. }, ; //X3_TITULO
	{ 'Nº Factura'															, .T. }, ; //X3_TITSPA
	{ 'Inv Num'																, .T. }, ; //X3_TITENG
	{ 'Número da Fatura'													, .T. }, ; //X3_DESCRIC
	{ 'Número de la factura'												, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	{ 'Código del cliente.'													, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	{ 'Prefijo del título'													, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	{ 'Número del título'													, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	{ 'FOB'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'FOB_PARCEL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Parcela'																, .T. }, ; //X3_TITULO
	{ 'Cuota'																, .T. }, ; //X3_TITSPA
	{ 'Installm.'															, .T. }, ; //X3_TITENG
	{ 'Parcela do Título'													, .T. }, ; //X3_DESCRIC
	{ 'Cuota del título'													, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	...
	{ 'Tipo del título'														, .T. }, ; //X3_DESCSPA
	{ 'Bill Type'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'FOB'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'FOB_VALOR'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr titulo'															, .T. }, ; //X3_TITULO
	{ 'Val Título'															, .T. }, ; //X3_TITSPA
	{ 'Bill Value'															, .T. }, ; //X3_TITENG
	{ 'Valor do título'														, .T. }, ; //X3_DESCRIC
	{ 'Valor del título'													, .T. }, ; //X3_DESCSPA
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E2_VALOR" ,.T.)'											, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Saldo del título'													, .T. }, ; //X3_DESCSPA
	{ 'Bill Balance'														, .T. }, ; //X3_DESCENG
	{ '@E 9,999,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E2_SALDO",.T.)'											, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E2_EMISSAO",.T.)'											, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Vencimento'															, .T. }, ; //X3_DESCRIC
	{ 'Vencimiento'															, .T. }, ; //X3_DESCSPA
	{ 'Due Date'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E2_VENCTO",.T.)'											, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'FOB'																	, .T. }, ; //X3_ARQUIVO
	{ '14'																	, .T. }, ; //X3_ORDEM
	{ 'FOB_VENCRE'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Venc Real'															, .T. }, ; //X3_TITULO
	{ 'Venc Real'															, .T. }, ; //X3_TITSPA
	{ 'Real Due Dt'															, .T. }, ; //X3_TITENG
	{ 'Vencimento Real'														, .T. }, ; //X3_DESCRIC
	{ 'Vencimiento real'													, .T. }, ; //X3_DESCSPA
	{ 'Real Due Date'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E2_VENCREA",.T.)'											, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'FOB'																	, .T. }, ; //X3_ARQUIVO
	{ '15'																	, .T. }, ; //X3_ORDEM
	{ 'FOB_TITFIL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Filial Ori'															, .T. }, ; //X3_TITULO
	{ 'Suc. Origen'															, .T. }, ; //X3_TITSPA
	{ 'Origin Bran.'														, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'FOB'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'FOB_FORCOM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Forne Comiss'														, .T. }, ; //X3_TITULO
	{ 'Prov. Comis.'														, .T. }, ; //X3_TITSPA
	{ 'Supp Comm'															, .T. }, ; //X3_TITENG
	{ 'Fornecedor Comissão'													, .T. }, ; //X3_DESCRIC
	{ 'Proveedor comisión'													, .T. }, ; //X3_DESCSPA
	{ 'Supplier Commission'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'FOB'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'FOB_LOJCOM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loja Comiss'															, .T. }, ; //X3_TITULO
	{ 'Tda. Comis'															, .T. }, ; //X3_TITSPA
	{ 'Store Comm'															, .T. }, ; //X3_TITENG
	{ 'Loja Comissão'														, .T. }, ; //X3_DESCRIC
	{ 'Tienda Comisión'														, .T. }, ; //X3_DESCSPA
	{ 'Store Commission'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'FOB'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'FOB_FILIAL+FOB_NUMFAT+FOB_CLIFAT+FOB_LOJFAT+FOB_PREFIX+FOB_NUM+FOB_PARCEL+FOB_TIPO', ; //CHAVE
	'Num. Fatura + Cod. Cliente + Loja + Prefixo + FOB_NUM+Parcela + Tipo'		, ; //DESCRICAO
	'Nº Factura + Cód. Cliente + Tienda + Prefijo + FOB_NUM+Cuota + Tipo'		, ; //DESCSPA
	'Inv Num + Cust Cd + Store + Prefix + FOB_NUM+Installm. + Type'			, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
