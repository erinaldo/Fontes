...
/*/
//--------------------------------------------------------------------
User Function COMP_FOC( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'FOC'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'FOC'+cEmpr																, ; //X2_ARQUIVO
	'Fatura Hotel x NFe'													, ; //X2_NOME
	''																		, ; //X2_NOMESPA
	''																		, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
	'FOC_FILIAL+FOC_NUMFAT+FOC_CLIFAT+FOC_LOJFAT+FOC_SERIE+FOC_NUMDOC'		, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!INCLUI, Posicione("SF2", 1, FWxFilial("SF2") + FOC->FOC_NUMDOC + FOC->FOC_SERIE, "F2_EMISSAO"), CTOD("") )', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!INCLUI, Posicione("SF2", 1, FWxFilial("SF2") + FOC->FOC_NUMDOC + FOC->FOC_SERIE, "F2_VALBRUT"), 0 )', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSIX, { ;
	'FOC'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'FOC_FILIAL+FOC_NUMFAT+FOC_CLIFAT+FOC_LOJFAT+FOC_SERIE+FOC_NUMDOC'		, ; //CHAVE
