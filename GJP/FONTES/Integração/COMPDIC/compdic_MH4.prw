...
/*/
//--------------------------------------------------------------------
User Function COMP_MH4( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'MH4'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'MH4'+cEmpr																, ; //X2_ARQUIVO
	'INF. ADICIONAIS ITENS RESERVA'											, ; //X2_NOME
	'INF. ADICIONAIS ITENS RESERVA'											, ; //X2_NOMESPA
	'INF. ADICIONAIS ITENS RESERVA'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'MH4'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'MH4_SERRPS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Serie RPS'															, .T. }, ; //X3_TITULO
	{ 'Serie RPS'															, .T. }, ; //X3_TITSPA
	{ 'Serie RPS'															, .T. }, ; //X3_TITENG
	{ 'Serie RPS'															, .T. }, ; //X3_DESCRIC
	{ 'Serie RPS'															, .T. }, ; //X3_DESCSPA
	{ 'Serie RPS'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH4'																	, .T. }, ; //X3_ARQUIVO
	{ '03'																	, .T. }, ; //X3_ORDEM
	{ 'MH4_DOCRPS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Numero RPS'															, .T. }, ; //X3_TITULO
	{ 'Numero RPS'															, .T. }, ; //X3_TITSPA
	{ 'Numero RPS'															, .T. }, ; //X3_TITENG
	{ 'Numero RPS'															, .T. }, ; //X3_DESCRIC
	{ 'Numero RPS'															, .T. }, ; //X3_DESCSPA
	{ 'Numero RPS'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH4'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'MH4_TIPPEN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Pensao'															, .T. }, ; //X3_TITULO
	{ 'Tipo Pensao'															, .T. }, ; //X3_TITSPA
	{ 'Tipo Pensao'															, .T. }, ; //X3_TITENG
	{ 'Tipo Pensao'															, .T. }, ; //X3_DESCRIC
	{ 'Tipo Pensao'															, .T. }, ; //X3_DESCSPA
	{ 'Tipo Pensao'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH4'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'MH4_VLRPEN'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Valor Pensao'														, .T. }, ; //X3_TITULO
	{ 'Valor Pensao'														, .T. }, ; //X3_TITSPA
	{ 'Valor Pensao'														, .T. }, ; //X3_TITENG
	{ 'Valor Pensao'														, .T. }, ; //X3_DESCRIC
	{ 'Valor Pensao'														, .T. }, ; //X3_DESCSPA
	{ 'Valor Pensao'														, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'MH4'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'MH4_VLRCAF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Valor Cafe'															, .T. }, ; //X3_TITULO
	{ 'Valor Cafe'															, .T. }, ; //X3_TITSPA
	{ 'Valor Cafe'															, .T. }, ; //X3_TITENG
	{ 'Valor Cafe'															, .T. }, ; //X3_DESCRIC
	{ 'Valor Cafe'															, .T. }, ; //X3_DESCSPA
	{ 'Valor Cafe'															, .T. }, ; //X3_DESCENG
	{ '@E 9,999,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'MH4'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'MH4_FILIAL+MH4_SERRPS+MH4_DOCRPS+MH4_ITEM'								, ; //CHAVE
	'Serie RPS+Numero RPS+Item'												, ; //DESCRICAO
	'Serie RPS+Numero RPS+Item'												, ; //DESCSPA
	'Serie RPS+Numero RPS+Item'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
