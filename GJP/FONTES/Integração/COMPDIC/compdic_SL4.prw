...
/*/
//--------------------------------------------------------------------
User Function COMP_SL4( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	{ 'SL4'																	, .T. }, ; //X3_ARQUIVO
	{ '53'																	, .T. }, ; //X3_ORDEM
	{ 'L4_CONHTL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Id RA Hotel'															, .T. }, ; //X3_TITULO
	{ 'Id RA Hotel'															, .T. }, ; //X3_TITSPA
	{ 'Id RA Hotel'															, .T. }, ; //X3_TITENG
	{ 'InternalId RA Hotel'													, .T. }, ; //X3_DESCRIC
	{ 'InternalId RA Hotel'													, .T. }, ; //X3_DESCSPA
	{ 'InternalId RA Hotel'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Contab S/N'															, .T. }, ; //X3_TITULO
	{ 'Contab S/N'															, .T. }, ; //X3_TITSPA
	{ 'Contab S/N'															, .T. }, ; //X3_TITENG
	{ 'Contab S/N'															, .T. }, ; //X3_DESCRIC
	{ 'Contab S/N'															, .T. }, ; //X3_DESCSPA
	{ 'Contab S/N'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
