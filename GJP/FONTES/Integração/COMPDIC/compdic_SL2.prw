...
/*/
//--------------------------------------------------------------------
User Function COMP_SL2( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	{ 'IRRF Calculation Base'												, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Confis Withhold. Rate'												, .T. }, ; //X3_DESCENG
	{ '@E 99.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Confis Withhold. Base'												, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Base de cálculo de CSLL'												, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	{ 'SL2'																	, .T. }, ; //X3_ARQUIVO
	{ 'F5'																	, .T. }, ; //X3_ORDEM
	{ 'L2_PREDIC'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ '%Red.do ICMs'														, .T. }, ; //X3_TITULO
	{ '%Red.ICMS'															, .T. }, ; //X3_TITSPA
	{ 'ICMs Red %'															, .T. }, ; //X3_TITENG
	{ '% Reducao da Base de ICMS'											, .T. }, ; //X3_DESCRIC
	{ '% Reducc. Base de ICMS'												, .T. }, ; //X3_DESCSPA
	{ 'ICMS Base Reduction %'												, .T. }, ; //X3_DESCENG
	{ '@E 99.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SL2'																	, ; //INDICE
	'7'																		, ; //ORDEM
	'L2_FILIAL+L2_SDOC+L2_DOC+L2_PRODUTO'									, ; //CHAVE
	'Série Doc. + Nota NF + Produto'										, ; //DESCRICAO
	'Serie Doc. + Num. Factura + Producto'									, ; //DESCSPA
	'Inv. Series + Invoice + Product'										, ; //DESCENG
	'S'																		, ; //PROPRI
	'XXX+XXX+SL2'															, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
