...
/*/
//--------------------------------------------------------------------
User Function COMP_SLX( cEmpAmb, cFilAmb )
...
aAdd( aSIX, { ;
	'SLX'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'LX_FILIAL+LX_PDV+LX_CUPOM+LX_SDOC+LX_ITEM+LX_HORA'						, ; //CHAVE
	'PDV + Cupom + Série Doc. + Item + Hora'								, ; //DESCRICAO
	'PDV + Comprobante + Serie Doc. + Item + Hora'							, ; //DESCSPA
	'POS + Coupon + Inv. Series + Item + Time'								, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
