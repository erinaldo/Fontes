...
/*/
//--------------------------------------------------------------------
User Function COMP_SD2( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	{ 'SD2'																	, .T. }, ; //X3_ARQUIVO
	{ '99'																	, .T. }, ; //X3_ORDEM
	{ 'D2_ITEMCC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Item Conta'															, .T. }, ; //X3_TITULO
	{ 'Item C.C.'															, .T. }, ; //X3_TITSPA
	{ 'Led.Acct.It.'														, .T. }, ; //X3_TITENG
	{ 'Item de Conta Contabil'												, .T. }, ; //X3_DESCRIC
	{ 'Item de Cuenta Contable'												, .T. }, ; //X3_DESCSPA
	{ 'Ledger Account Item'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Cl Val'															, .T. }, ; //X3_TITULO
	{ 'Clase Valor'															, .T. }, ; //X3_TITSPA
	{ 'Value Class'															, .T. }, ; //X3_TITENG
	{ 'Classe Valor Contabil'												, .T. }, ; //X3_DESCRIC
	{ 'Clase Valor Contable'												, .T. }, ; //X3_DESCSPA
	{ 'Accounting Value Class'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "CTB105EntC(,M->D2_EC05DB,,'05')"										, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "CTB105EntC(,M->D2_EC05CR,,'05')"										, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "CTB105EntC(,M->D2_EC06DB,,'06')"										, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "CTB105EntC(,M->D2_EC06CR,,'06')"										, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SD2'																	, .T. }, ; //X3_ARQUIVO
	{ 'S3'																	, .T. }, ; //X3_ORDEM
	{ 'D2_XDESCPR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descrição'															, .T. }, ; //X3_TITULO
	{ 'Descriçao'															, .T. }, ; //X3_TITSPA
	{ 'Descriçao'															, .T. }, ; //X3_TITENG
	{ 'Descrição do produto'												, .T. }, ; //X3_DESCRIC
	{ 'Descrição do produto'												, .T. }, ; //X3_DESCSPA
	{ 'Descrição do produto'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'POSICIONE("SB1",1,XFILIAL("SB1")+FWFLDGET("D2_COD"),"B1_DESC")'		, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SB1",1,XFILIAL("SB1")+SD2->D2_COD,"B1_DESC")'				, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Num. NFC-e'															, .T. }, ; //X3_TITULO
	{ 'Num. NFC-e'															, .T. }, ; //X3_TITSPA
	{ 'Num. NFC-e'															, .T. }, ; //X3_TITENG
	{ 'Número do cupom fiscal'												, .T. }, ; //X3_DESCRIC
	{ 'Número do cupom fiscal'												, .T. }, ; //X3_DESCSPA
	{ 'Número do cupom fiscal'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SD2'																	, .T. }, ; //X3_ARQUIVO
	{ 'S5'																	, .T. }, ; //X3_ORDEM
	{ 'D2_XAUTOP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Status NFC-e'														, .T. }, ; //X3_TITULO
	{ 'Status NFC-e'														, .T. }, ; //X3_TITSPA
	{ 'Status NFC-e'														, .T. }, ; //X3_TITENG
	{ 'Status NFC-e'														, .T. }, ; //X3_DESCRIC
	{ 'Status NFC-e'														, .T. }, ; //X3_DESCSPA
	{ 'Status NFC-e'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Não gera OP;2=OP não encerrada;3=OP encerrada4=inconsistência'		, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SD2'																	, .T. }, ; //X3_ARQUIVO
	{ 'S6'																	, .T. }, ; //X3_ORDEM
	{ 'D2_XLOGOP'															, .T. }, ; //X3_CAMPO
	{ 'M'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Log NFC-e'															, .T. }, ; //X3_TITULO
	{ 'Log NFC-e'															, .T. }, ; //X3_TITSPA
	{ 'Log NFC-e'															, .T. }, ; //X3_TITENG
	{ 'Log NFC-e'															, .T. }, ; //X3_DESCRIC
	{ 'Log NFC-e'															, .T. }, ; //X3_DESCSPA
	{ 'Log NFC-e'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
