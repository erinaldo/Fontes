...
/*/
//--------------------------------------------------------------------
User Function COMP_FO8( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'FO8'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'FO8'+cEmpr																, ; //X2_ARQUIVO
	'Fatura de Hotel'														, ; //X2_NOME
	'Factura hotel'															, ; //X2_NOMESPA
	'Hotel Invoice'															, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
	'FO8_FILIAL+FO8_NUM+FO8_CLI+FO8_LOJA'									, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	...
	{ 'Fecha'																, .T. }, ; //X3_TITSPA
	{ 'Date'																, .T. }, ; //X3_TITENG
	{ 'Data da Fatura'														, .T. }, ; //X3_DESCRIC
	{ 'Fecha de la factura'													, .T. }, ; //X3_DESCSPA
	{ 'Invoice Date'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo( "SA1", M->FO8_CLI )'										, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo( "SA1", M->FO8_CLI + M->FO8_LOJA )'							, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Desc. Client'														, .T. }, ; //X3_TITULO
	{ 'Desc. Client'														, .T. }, ; //X3_TITSPA
	{ 'Cust Descr'															, .T. }, ; //X3_TITENG
	{ 'Descrição do Cliente.'												, .T. }, ; //X3_DESCRIC
	{ 'Descripción del cliente'												, .T. }, ; //X3_DESCSPA
	{ 'Customer Description'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Iif(!INCLUI,Posicione("SA1",1,FWxFilial("SA1")+FO8->FO8_CLI+FO8->FO8_LOJA,"A1_NOME"), "")', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'Posicione("SA1",1,FWxFilial("SA1")+FO8->FO8_CLI+FO8->FO8_LOJA,"A1_NOME")', .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 'Estatus'																, .T. }, ; //X3_TITSPA
	{ 'Status'																, .T. }, ; //X3_TITENG
	{ 'Status Fatura.'														, .T. }, ; //X3_DESCRIC
	{ 'Estatus factura.'													, .T. }, ; //X3_DESCSPA
	{ 'Invoice Status'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Ativa;2=Cancelada'													, .T. }, ; //X3_CBOX
	{ '1=Activa;2=Anulada'													, .T. }, ; //X3_CBOXSPA
	{ '1=Active;2=Canceled'													, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSIX, { ;
	'FO8'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'FO8_FILIAL+FO8_NUM+FO8_CLI+FO8_LOJA'									, ; //CHAVE
	'Num. Fatura + Cod. Cliente + Loja'										, ; //DESCRICAO
	'Nº Factura + Cód. Cliente + Tienda'									, ; //DESCSPA
	'Inv Number + Cust Code + Store'										, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
