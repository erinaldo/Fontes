...
/*/
//--------------------------------------------------------------------
User Function COMP_SLQ( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	{ 'Sales Repr.'															, .T. }, ; //X3_TITENG
	{ 'Codigo do Vendedor'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo del Vendedor'													, .T. }, ; //X3_DESCSPA
	{ 'Seller Code'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'Existcpo("SA3")'														, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ '61'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_NSUTEF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Sequencia'															, .T. }, ; //X3_TITULO
	{ 'Secuencia'															, .T. }, ; //X3_TITSPA
	{ 'Sequence'															, .T. }, ; //X3_TITENG
	{ 'Numero Sequencial Trans.'											, .T. }, ; //X3_DESCRIC
	{ 'Numero Secuencial Trans.'											, .T. }, ; //X3_DESCSPA
	{ 'Transfer Sequent. Number'											, .T. }, ; //X3_DESCENG
	{ '!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ 'C1'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_NUMORC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'DAV'																	, .T. }, ; //X3_TITULO
	{ 'Numero DAV'															, .T. }, ; //X3_TITSPA
	{ 'DAV Number'															, .T. }, ; //X3_TITENG
	{ 'Define o numero da DAV'												, .T. }, ; //X3_DESCRIC
	{ 'Define numero de la DAV'												, .T. }, ; //X3_DESCSPA
	{ 'Definition of DAV Number'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ 'I4'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_VALCOMI'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr Comissao'														, .T. }, ; //X3_TITULO
	{ 'Val. Comis.'															, .T. }, ; //X3_TITSPA
	{ 'Comm Vl'																, .T. }, ; //X3_TITENG
	{ 'Valor de Comissão'													, .T. }, ; //X3_DESCRIC
	{ 'Valor de comisión'													, .T. }, ; //X3_DESCSPA
	{ 'Commission Value'													, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ 'I5'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_RESEHTL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 32																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Reserva Hote'														, .T. }, ; //X3_TITULO
	{ 'Reserva Hote'														, .T. }, ; //X3_TITSPA
	{ 'Hotel Res.'															, .T. }, ; //X3_TITENG
	{ 'Reserva Hotel'														, .T. }, ; //X3_DESCRIC
	{ 'Reserva hotel'														, .T. }, ; //X3_DESCSPA
	{ 'Hotel Reservation'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 41																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Lei Transp'															, .T. }, ; //X3_TITULO
	{ 'Ley Transp'															, .T. }, ; //X3_TITSPA
	{ 'Transp Law'															, .T. }, ; //X3_TITENG
	{ 'Lei da Transparência'												, .T. }, ; //X3_DESCRIC
	{ 'Ley de la Transparencia'												, .T. }, ; //X3_DESCSPA
	{ 'Transparency Law'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ 'I7'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_TOTMUN'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Impostos Mun'														, .T. }, ; //X3_TITULO
	{ 'Imptos Mun'															, .T. }, ; //X3_TITSPA
	{ 'City Tax'															, .T. }, ; //X3_TITENG
	{ 'Impostos Municipais'													, .T. }, ; //X3_DESCRIC
	{ 'Impuestos municipales'												, .T. }, ; //X3_DESCSPA
	{ 'City Taxes'															, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ 'I8'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_TOTFED'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Impostos Fed'														, .T. }, ; //X3_TITULO
	{ 'Imptos Fed'															, .T. }, ; //X3_TITSPA
	{ 'Fed Tax'																, .T. }, ; //X3_TITENG
	{ 'Impostos Federais'													, .T. }, ; //X3_DESCRIC
	{ 'Impuestos federales'													, .T. }, ; //X3_DESCSPA
	{ 'Federal Taxes'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ 'I9'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_TOTEST'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Impostos Est'														, .T. }, ; //X3_TITULO
	{ 'Imptos Est'															, .T. }, ; //X3_TITSPA
	{ 'State Tax'															, .T. }, ; //X3_TITENG
	{ 'Impostos Estaduais'													, .T. }, ; //X3_DESCRIC
	{ 'Impuestos estatales'													, .T. }, ; //X3_DESCSPA
	{ 'State Taxes'															, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SLQ'																	, .T. }, ; //X3_ARQUIVO
	{ 'J1'																	, .T. }, ; //X3_ORDEM
	{ 'LQ_PRONFCE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Protocolo'															, .T. }, ; //X3_TITULO
	{ ''																	, .T. }, ; //X3_TITSPA
	{ ''																	, .T. }, ; //X3_TITENG
	{ 'Num. Protocolo da NFCe'												, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
