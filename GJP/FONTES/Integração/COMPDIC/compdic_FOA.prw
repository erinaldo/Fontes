...
/*/
//--------------------------------------------------------------------
User Function COMP_FOA( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'FOA'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'FOA'+cEmpr																, ; //X2_ARQUIVO
	'Fatura Hotel x Titulo'													, ; //X2_NOME
	'Factura Hotel vs. Título'												, ; //X2_NOMESPA
	'Hotel Invoice x Bill'													, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
	'FOA_FILIAL+FOA_NUMFAT+FOA_CLIFAT+FOA_LOJFAT+FOA_PREFIX+FOA_NUM+FOA_PARCEL+FOA_TIPO', ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E1_VALOR")'												, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E1_SALDO")'												, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E1_EMISSAO")'												, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'FOA'																	, .T. }, ; //X3_ARQUIVO
	{ '13'																	, .T. }, ; //X3_ORDEM
	{ 'FOA_VENCTO'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Vencimento'															, .T. }, ; //X3_TITULO
	{ 'Vencimiento'															, .T. }, ; //X3_TITSPA
	{ 'Expiration'															, .T. }, ; //X3_TITENG
	{ 'Vencimento'															, .T. }, ; //X3_DESCRIC
	{ 'Vencimiento'															, .T. }, ; //X3_DESCSPA
	{ 'Expiration'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E1_VENCTO")'												, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'FOA'																	, .T. }, ; //X3_ARQUIVO
	{ '14'																	, .T. }, ; //X3_ORDEM
	{ 'FOA_VENCRE'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Venc Real'															, .T. }, ; //X3_TITULO
	{ 'Venc Real'															, .T. }, ; //X3_TITSPA
	{ 'Real Exp'															, .T. }, ; //X3_TITENG
	{ 'Vencimento Real'														, .T. }, ; //X3_DESCRIC
	{ 'Vencimiento real'													, .T. }, ; //X3_DESCSPA
	{ 'Real Expiration'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'FIN791INI("E1_VENCREA")'												, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(132) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'FIN791INI("E1_VENCREA")'												, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'FOA'																	, .T. }, ; //X3_ARQUIVO
	{ '15'																	, .T. }, ; //X3_ORDEM
	{ 'FOA_TITFIL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Filial Ori'															, .T. }, ; //X3_TITULO
	{ 'Suc Ori'																, .T. }, ; //X3_TITSPA
	{ 'Orig Branch'															, .T. }, ; //X3_TITENG
...
aAdd( aSIX, { ;
	'FOA'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'FOA_FILIAL+FOA_NUMFAT+FOA_CLIFAT+FOA_LOJFAT+FOA_PREFIX+FOA_NUM+FOA_PARCEL+FOA_TIPO', ; //CHAVE
	'Num. Fatura + Cod. Cliente + Loja + Prefixo + FOA_NUM+Parcela + Tipo'		, ; //DESCRICAO
	'Nº Factura + Cód. Cliente + Tienda + Prefijo + FOA_NUM+Cuota + Tipo'		, ; //DESCSPA
	'Inv Number + Cust Code + Store + Prefix + FOA_NUM+Installment + Type'		, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
