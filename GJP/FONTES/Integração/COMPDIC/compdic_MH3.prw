...
/*/
//--------------------------------------------------------------------
User Function COMP_MH3( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	'MH3'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'MH3'+cEmpr																, ; //X2_ARQUIVO
	'RPS x Reserva'															, ; //X2_NOME
	'RPS vs. Reserva'														, ; //X2_NOMESPA
	'RPS x Reservation'														, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	'S'																		, ; //X2_PYME
	'MH3_FILIAL+MH3_SERRPS+MH3_DOCRPS'										, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	{ 'MH3'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'MH3_SERRPS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Série do RPS'														, .T. }, ; //X3_TITULO
	{ 'Serie RPS'															, .T. }, ; //X3_TITSPA
	{ 'RPS Series'															, .T. }, ; //X3_TITENG
	{ 'Série do RPS'														, .T. }, ; //X3_DESCRIC
	{ 'Serie del RPS'														, .T. }, ; //X3_DESCSPA
	{ 'RPS Series'															, .T. }, ; //X3_DESCENG
	{ '!!!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Num. RPS'															, .T. }, ; //X3_TITSPA
	{ 'RPS No.'																, .T. }, ; //X3_TITENG
	{ 'Número do RPS'														, .T. }, ; //X3_DESCRIC
	{ 'Número del RPS'														, .T. }, ; //X3_DESCSPA
	{ 'RPS Number'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Checkin Rsv.'														, .T. }, ; //X3_TITULO
	{ 'Checkin Res.'														, .T. }, ; //X3_TITSPA
	{ 'Res Checkin'															, .T. }, ; //X3_TITENG
	{ 'Data Checkin da Reserva'												, .T. }, ; //X3_DESCRIC
	{ 'Fch Checkin de Reserva'												, .T. }, ; //X3_DESCSPA
	{ 'Reservation Checkin Date'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH3'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'MH3_DTOUT'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Checkout Rsv'														, .T. }, ; //X3_TITULO
	{ 'Checkout Res'														, .T. }, ; //X3_TITSPA
	{ 'Res Checkout'														, .T. }, ; //X3_TITENG
	{ 'Data Checkout da Reserva'											, .T. }, ; //X3_DESCRIC
	{ 'Fch Checkout de Reserva'												, .T. }, ; //X3_DESCSPA
	{ 'Reservation Checkout Date'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH3'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'MH3_RESERV'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 32																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Reserva'																, .T. }, ; //X3_TITULO
	{ 'Reserva'																, .T. }, ; //X3_TITSPA
	{ 'Reservation'															, .T. }, ; //X3_TITENG
	{ 'Código da Reserva'													, .T. }, ; //X3_DESCRIC
	{ 'Código de la reserva'												, .T. }, ; //X3_DESCSPA
	{ 'Reservation Code'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH3'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'MH3_TIPOUH'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tp.Un.Habit.'														, .T. }, ; //X3_TITULO
	{ 'Tp.Un.Habit.'														, .T. }, ; //X3_TITSPA
	{ 'House Un Tp'															, .T. }, ; //X3_TITENG
	{ 'Tipo Unidade Habitacional'											, .T. }, ; //X3_DESCRIC
	{ 'Tipo unidad habitacional'											, .T. }, ; //X3_DESCSPA
	{ 'Housing Unit Type'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH3'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'MH3_NUMUH'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Un. Habit.'															, .T. }, ; //X3_TITULO
	{ 'Un. Habit.'															, .T. }, ; //X3_TITSPA
	{ 'House Unit'															, .T. }, ; //X3_TITENG
	{ 'Unidade Habitacional'												, .T. }, ; //X3_DESCRIC
	{ 'Unidad habitacional'													, .T. }, ; //X3_DESCSPA
	{ 'Housing Unit'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH3'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'MH3_HOSPRI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Hóspede Pri.'														, .T. }, ; //X3_TITULO
	{ 'Huésped Pri.'														, .T. }, ; //X3_TITSPA
	{ 'Main Guest'															, .T. }, ; //X3_TITENG
	{ 'Hóspede Principal'													, .T. }, ; //X3_DESCRIC
	{ 'Huésped principal'													, .T. }, ; //X3_DESCSPA
	{ 'Main Guest'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'MH3'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'MH3_HOSPED'															, .T. }, ; //X3_CAMPO
	{ 'M'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Hospedes'															, .T. }, ; //X3_TITULO
	{ 'Huéspedes'															, .T. }, ; //X3_TITSPA
	{ 'Guests'																, .T. }, ; //X3_TITENG
	{ 'Nomes dos Hóspedes'													, .T. }, ; //X3_DESCRIC
	{ 'Nombres de los huéspedes'											, .T. }, ; //X3_DESCSPA
	{ "Guests' Names"														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Nombre del grupo'													, .T. }, ; //X3_DESCSPA
	{ 'Group Name'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Evento'																, .T. }, ; //X3_TITSPA
	{ 'Event'																, .T. }, ; //X3_TITENG
	{ 'Nome do Evento'														, .T. }, ; //X3_DESCRIC
	{ 'Nombre del evento'													, .T. }, ; //X3_DESCSPA
	{ 'Event Name'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Lançamentos'															, .T. }, ; //X3_TITULO
	{ 'Registros'															, .T. }, ; //X3_TITSPA
	{ 'Entries'																, .T. }, ; //X3_TITENG
	{ 'Lançamentos na reserva'												, .T. }, ; //X3_DESCRIC
	{ 'Registros en la reserva'												, .T. }, ; //X3_DESCSPA
	{ 'Reservation Entries'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Rateio'																, .T. }, ; //X3_TITSPA
	{ 'Rateio'																, .T. }, ; //X3_TITENG
	{ 'Rateio - Terceiros'													, .T. }, ; //X3_DESCRIC
	{ 'Rateio - Terceiros'													, .T. }, ; //X3_DESCSPA
	{ 'Rateio - Terceiros'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'MH3'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'MH3_FILIAL+MH3_SERRPS+MH3_DOCRPS'										, ; //CHAVE
	'Série do RPS + Num. RPS'												, ; //DESCRICAO
	'Serie RPS + Num. RPS'													, ; //DESCSPA
	'RPS Series + RPS No.'													, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
