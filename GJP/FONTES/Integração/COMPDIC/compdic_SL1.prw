...
/*/
//--------------------------------------------------------------------
User Function COMP_SL1( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	{ 'RFC del Cliente'														, .T. }, ; //X3_DESCSPA
	{ 'Customer CGC/ CPF'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SL1'																	, .T. }, ; //X3_ARQUIVO
	{ 'J5'																	, .T. }, ; //X3_ORDEM
	{ 'L1_TOTFED'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Impostos Fed'														, .T. }, ; //X3_TITULO
	{ 'Impuest Fed'															, .T. }, ; //X3_TITSPA
	{ 'Fed Tax'																, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'SL1'																	, .T. }, ; //X3_ARQUIVO
	{ 'J6'																	, .T. }, ; //X3_ORDEM
	{ 'L1_TOTMUN'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Impostos Mun'														, .T. }, ; //X3_TITULO
	{ 'Impuest Mun'															, .T. }, ; //X3_TITSPA
...
aAdd( aSX3, { ;
	{ 'SL1'																	, .T. }, ; //X3_ARQUIVO
	{ 'J7'																	, .T. }, ; //X3_ORDEM
	{ 'L1_TOTEST'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Impostos Est'														, .T. }, ; //X3_TITULO
	{ 'Impuest Est'															, .T. }, ; //X3_TITSPA
...
aAdd( aSX3, { ;
	...
	{ 'Lei Transparência'													, .T. }, ; //X3_DESCRIC
	{ 'Ley Transparencia'													, .T. }, ; //X3_DESCSPA
...
aAdd( aSX3, { ;
	{ 'SL1'																	, .T. }, ; //X3_ARQUIVO
	{ 'J9'																	, .T. }, ; //X3_ORDEM
	{ 'L1_PRONFCE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Protocolo'															, .T. }, ; //X3_TITULO
	{ 'Protocolo'															, .T. }, ; //X3_TITSPA
	{ 'Protocolo'															, .T. }, ; //X3_TITENG
	{ 'Num. Protocolo da NFCe'												, .T. }, ; //X3_DESCRIC
	{ 'Num. Protocolo da NFCe'												, .T. }, ; //X3_DESCSPA
	{ 'Num. Protocolo da NFCe'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
