...
/*/
//--------------------------------------------------------------------
User Function COMP_AI0( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	{ 'AI0'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'AI0_SALDO'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Saldo VHF'															, .T. }, ; //X3_TITULO
	{ 'Saldo Clien.'														, .T. }, ; //X3_TITSPA
	{ 'Cust. Balanc'														, .T. }, ; //X3_TITENG
	{ 'Saldo do Cliente'													, .T. }, ; //X3_DESCRIC
	{ 'Saldo del cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Customer Balance'													, .T. }, ; //X3_DESCENG
	{ '@E 9,999,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ 'positivo().and.naovazio()'											, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'AI0'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'AI0_SALDPR'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Saldo com PR'														, .T. }, ; //X3_TITULO
	{ 'Saldo com PR'														, .T. }, ; //X3_TITSPA
	{ 'Saldo com PR'														, .T. }, ; //X3_TITENG
	{ 'Saldo com provisórios'												, .T. }, ; //X3_DESCRIC
	{ 'Saldo com provisórios'												, .T. }, ; //X3_DESCSPA
	{ 'Saldo com provisórios'												, .T. }, ; //X3_DESCENG
	{ '@E 9,999,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Lim. Credito'														, .T. }, ; //X3_TITSPA
	{ 'Lim. Credito'														, .T. }, ; //X3_TITENG
	{ 'Limite Crédito'														, .T. }, ; //X3_DESCRIC
	{ 'Limite Crédito'														, .T. }, ; //X3_DESCSPA
	{ 'Limite Crédito'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'SA1->A1_LC'															, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Risco'																, .T. }, ; //X3_TITSPA
	{ 'Risco'																, .T. }, ; //X3_TITENG
	{ 'Risco do Cliente'													, .T. }, ; //X3_DESCRIC
	{ 'Risco do Cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Risco do Cliente'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'SA1->A1_RISCO'														, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ 'A=Risco A;B=Risco B;C=Risco C;D=Risco D;E=Risco E'					, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'AI0'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'AI0_XVENCL'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Venc.Lim.Cre'														, .T. }, ; //X3_TITULO
	{ 'Venc.Lim.Cre'														, .T. }, ; //X3_TITSPA
	{ 'Venc.Lim.Cre'														, .T. }, ; //X3_TITENG
	{ 'Vencimento Limite Credito'											, .T. }, ; //X3_DESCRIC
	{ 'Vencimento Limite Credito'											, .T. }, ; //X3_DESCSPA
	{ 'Vencimento Limite Credito'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'SA1->A1_VENCLC'														, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSIX, { ;
	'AI0'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'AI0_FILIAL+AI0_CODCLI+AI0_LOJA'										, ; //CHAVE
	'Cod. Cliente + Loja'													, ; //DESCRICAO
	'Cod. Cliente + Tienda'													, ; //DESCSPA
	'Cust. Code + Store'													, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	'COD+LOJA'																, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
