...
/*/
//--------------------------------------------------------------------
User Function COMP_CD2( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	{ 'Difal Target Percentage'												, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'CD2'																	, .T. }, ; //X3_ARQUIVO
	{ '32'																	, .T. }, ; //X3_ORDEM
	{ 'CD2_VDDES'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Dif. Destino'														, .T. }, ; //X3_TITULO
	{ 'Dif. Destino'														, .T. }, ; //X3_TITSPA
	{ 'Target Difal'														, .T. }, ; //X3_TITENG
	{ 'Valor Difal UF de Destino'											, .T. }, ; //X3_DESCRIC
	{ 'Valor Difal UF de destino'											, .T. }, ; //X3_DESCSPA
	{ 'Difal Target State Value'											, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	{ 'Difal Source Percentage'												, .T. }, ; //X3_DESCENG
	{ '@E 999.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Aliq. Difal'															, .T. }, ; //X3_TITULO
	{ 'Alíc. Difal'															, .T. }, ; //X3_TITSPA
	{ 'Difal Rate'															, .T. }, ; //X3_TITENG
	{ 'Aliquota interestadual'												, .T. }, ; //X3_DESCRIC
	{ 'Alícuota interestatal'												, .T. }, ; //X3_DESCSPA
	{ 'Interstate Rate'														, .T. }, ; //X3_DESCENG
	{ '@E 999.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Perc. FECP'															, .T. }, ; //X3_TITULO
	{ 'Porc. FECP'															, .T. }, ; //X3_TITSPA
	{ 'FECP %'																, .T. }, ; //X3_TITENG
	{ 'Perc. FECP de destino'												, .T. }, ; //X3_DESCRIC
	{ 'Porc. FECP de destino'												, .T. }, ; //X3_DESCSPA
	{ 'FECP Target Percentage'												, .T. }, ; //X3_DESCENG
	{ '@E 999.99'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Target State FECP'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'CD2'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'CD2_FILIAL+CD2_TPMOV+CD2_SDOC+CD2_DOC+CD2_CODCLI+CD2_LOJCLI+CD2_ITEM+CD2_CODPRO+CD2_IMP', ; //CHAVE
	'Tp.Movimento + Série Doc. + Documento + Cliente + Loja cliente + Item'		, ; //DESCRICAO
	'Tipo de Mov. + Serie Doc. + Documento + Cliente + Tienda clien + Item'		, ; //DESCSPA
	'Transact Tp. + Inv.Series + Document + Customer + CustomrStore + Doc.'		, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'CD2'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'CD2_FILIAL+CD2_TPMOV+CD2_SDOC+CD2_DOC+CD2_CODFOR+CD2_LOJFOR+CD2_ITEM+CD2_CODPRO+CD2_IMP', ; //CHAVE
	'Tp.Movimento + Série Doc. + Documento + Fornecedor + Loja Fornec. + It'	, ; //DESCRICAO
	'Tipo de Mov. + Serie Doc. + Documento + Proveedor + Tienda Prove + Ite'	, ; //DESCSPA
	'Transact Tp. + Inv.Series + Document + Supplier + SupplrStore + Doc. I'	, ; //DESCENG
	'S'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
