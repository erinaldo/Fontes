...
/*/
//--------------------------------------------------------------------
User Function COMP_SZ3( cEmpAmb, cFilAmb )
...
aAdd( aSX2, { ;
	...
	'PDV X CENTRO DE CUSTO'													, ; //X2_NOME
	'PDV X CENTRO DE CUSTO'													, ; //X2_NOMESPA
	'PDV X CENTRO DE CUSTO'													, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'Estacao'																, .T. }, ; //X3_TITSPA
	{ 'Estacao'																, .T. }, ; //X3_TITENG
	{ 'Estacao'																, .T. }, ; //X3_DESCRIC
	{ 'Estacao'																, .T. }, ; //X3_DESCSPA
	{ 'Estacao'																, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistChav("SZ3") .and. ExistCpo("SLG",M->Z3_ESTACAO)'				, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ '€'																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTT",M->Z3_CC)'											, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SZ3'																	, .T. }, ; //X3_ARQUIVO
	{ '04'																	, .T. }, ; //X3_ORDEM
	{ 'Z3_LOCSEC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Armazem Sec.'														, .T. }, ; //X3_TITULO
	{ 'Armazem Sec.'														, .T. }, ; //X3_TITSPA
	{ 'Armazem Sec.'														, .T. }, ; //X3_TITENG
	{ 'Armazem Secundario'													, .T. }, ; //X3_DESCRIC
	{ 'Armazem Secundario'													, .T. }, ; //X3_DESCSPA
	{ 'Armazem Secundario'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZ3'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z3_FILIAL+Z3_ESTACAO+Z3_CC'											, ; //CHAVE
	'Estacao+C.Custo'														, ; //DESCRICAO
	'Estacao+C.Custo'														, ; //DESCSPA
	'Estacao+C.Custo'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ3'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'Z3_FILIAL+Z3_CC+Z3_ESTACAO'											, ; //CHAVE
	'C.Custo+Estacao'														, ; //DESCRICAO
	'C.Custo+Estacao'														, ; //DESCSPA
	'C.Custo+Estacao'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
