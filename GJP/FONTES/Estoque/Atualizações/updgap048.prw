...
/*/
//--------------------------------------------------------------------
User Function UPDGAP048( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDGAP048" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDGAP048" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'VENDAS PDV SEM CUPOM FISCAL'											, ; //X2_NOME
	'VENDAS PDV SEM CUPOM FISCAL'											, ; //X2_NOMESPA
	'VENDAS PDV SEM CUPOM FISCAL'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'ExistCPO("SB1") .AND. U_VldStr()'										, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSIX, { ;
	'SZ2'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z2_FILIAL+Z2_DATA+Z2_PRODUTO'											, ; //CHAVE
	'Data+Produto'															, ; //DESCRICAO
	'Data+Produto'															, ; //DESCSPA
	'Data+Produto'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ2'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'Z2_FILIAL+Z2_PRODUTO+Z2_PDV'											, ; //CHAVE
	'Produto+PDV'															, ; //DESCRICAO
	'Produto+PDV'															, ; //DESCSPA
	'Produto+PDV'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'SZ2'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'Z2_FILIAL+Z2_PDV+Z2_PRODUTO'											, ; //CHAVE
	'PDV+Produto'															, ; //DESCRICAO
	'PDV+Produto'															, ; //DESCSPA
	'PDV+Produto'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
