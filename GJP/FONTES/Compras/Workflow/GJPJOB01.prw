...
ฑฑบPrograma  ณGJPJOB01  บAutor  ณMicrosiga           บ Data ณ  10/06/16   บฑฑ
...
Else
	...
	If lRet
		...
		Do While (cAliasTrb)->(!Eof())
			GJPMail (UsrRetMail((cAliasTrb)->C1_USER), Alltrim(SM0->M0_NOME) + " - Solicita็ใo de Compras "+alltrim((cAliasTrb)->C1_NUM)+" da Filial "+alltrim((cAliasTrb)->C1_FILIAL)+"- LIBERADA","",  , 0, "",alltrim((cAliasTrb)->C1_NUM),alltrim((cAliasTrb)->C1_FILIAL))
			(cAliasTrb)->(DbSkip())
		Enddo
...
cMensagem	+= ""+ CRLF
cMensagem	+= "A Solicita็ใo de Compras "+nNumSC+" da Filial "+alltrim(SM0->M0_NOME)+" foi liberada pelo aprovador.
cMensagem	+= ""+ CRLF
cMensagem	+= ""+ CRLF
cMensagem	+= "Acesse a interface de Solicita็ใo de Compras para dar prosseguimento. " + CRLF
cMensagem	+= ""+ CRLF
cMensagem	+= ""+ CRLF
cMensagem	+= ""+ CRLF
