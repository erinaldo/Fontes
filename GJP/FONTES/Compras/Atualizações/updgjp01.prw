...
/*/
//--------------------------------------------------------------------
User Function UPDGJP01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDGJP01" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDGJP01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX6, { ;
	...
	'MV_PCOMPRA'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Nome do programa ou rdmake da opcao "Imprimir" do'						, ; //X6_DESCRIC
	'Nombre del programa o rdmake de opcion "Imprimir"'						, ; //X6_DSCSPA
	'Program Name or "Printing" option Rdmake in'							, ; //X6_DSCENG
	'menu do "Pedido de Compra"'											, ; //X6_DESC1
	'del menu del "Pedido de Compra"'										, ; //X6_DSCSPA1
	'"Purchase Order" menu.'												, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'GCOMR01'																, ; //X6_CONTEUD
