...
/*/
//-----------------------------------------------------------------------
USER FUNCTION ASFINA27( cEMPREENDI, cQUADRA, cLOTE, cCPFCNPJ, cVENCIMENTO /*cPARCELA*/, cCOMPONENT /*cGRUPO*/, lSilencio )
	LOCAL cRET 		:= ""
	LOCAL oWsdl
	LOCAL oResult	
	LOCAL cResult	:= ""
...
//		cMsg += 		'<parameters xmlns="http://www.totvs.com/">COMPONENTE=' + ALLTRIM(cCOMPONENT) + ';VENCIMENTO=' + ALLTRIM(cVENCIMENTO) + ';GRUPO=' + ALLTRIM(cGRUPO) + ';EMPREENDIMENTO=' + ALLTRIM(cEMPREENDI) + ';QUADRA=' + ALLTRIM(cQUADRA) + ';LOTE=' + ALLTRIM(cLOTE) + ';CPFCNPJ=' + ALLTRIM(cCPFCNPJ) + '</parameters>'
		cMsg += 		'<parameters xmlns="http://www.totvs.com/">COMPONENTE=' + ALLTRIM(cCOMPONENT) + ';VENCIMENTO=' + ALLTRIM(cVENCIMENTO) + ';EMPREENDIMENTO=' + ALLTRIM(cEMPREENDI) + ';QUADRA=' + ALLTRIM(cQUADRA) + ';LOTE=' + ALLTRIM(cLOTE) + ';CPFCNPJ=' + ALLTRIM(cCPFCNPJ) + '</parameters>'
