...
Aadd(aPergs,{"Ate Emissao","","","mv_che","D",8,0,0,"G","","MV_PAR14","","","","31/12/23","","","","","","","","","","","","","","","","","","","","","","","","",""})
Aadd(aPergs,{"De Vencimento","","","mv_chf","D",8,0,0,"G","","MV_PAR15","","","","01/01/80","","","","","","","","","","","","","","","","","","","","","","","","",""})
Aadd(aPergs,{"Ate Vencimento","","","mv_chg","D",8,0,0,"G","","MV_PAR16","","","","31/12/23","","","","","","","","","","","","","","","","","","","","","","","","",""})
...
//3.Tamanho em Pixels
//5.Bold (T/F)
oFont8  := TFont():New("Arial",9,8+nAjuste,.T.,.F.,5,.T.,5,.T.,.F.)
oFont11c := TFont():New("Courier New",9,11+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
oFont10  := TFont():New("Arial",9,10+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
oFont12  := TFont():New("Arial",9,12+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
oFont14  := TFont():New("Arial",9,14+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
oFont20  := TFont():New("Arial",9,20+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
oFont21  := TFont():New("Arial",9,21+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
oFont16n := TFont():New("Arial",9,16+nAjuste,.T.,.F.,5,.T.,5,.T.,.F.)
oFont15  := TFont():New("Arial",9,15+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
oFont15n := TFont():New("Arial",9,15+nAjuste,.T.,.F.,5,.T.,5,.T.,.F.)
oFont14n := TFont():New("Arial",9,14+nAjuste,.T.,.F.,5,.T.,5,.T.,.F.)
oFont24  := TFont():New("Arial",9,24+nAjuste,.T.,.T.,5,.T.,5,.T.,.F.)
...
oPrint:Say  (nRow1+0114,100,aDadosBanco[2],oFont14 )	// [2]Nome do Banco
oPrint:Say  (nRow1+0105,513,aDadosBanco[1]+"-2",oFont21 )		// [1]Numero do Banco

oPrint:Say  (nRow1+0114,1800,"Comprovante de Entrega",oFont10)
oPrint:Line (nRow1+0150,100,nRow1+0150,2300)

oPrint:Say  (nRow1+0180,100 ,"Cedente",oFont8)
oPrint:Say  (nRow1+0230,100 ,aDadosEmp[1],oFont10)				//Nome + CNPJ

oPrint:Say  (nRow1+0180,1060,"Agência/Código Cedente",oFont8)
oPrint:Say  (nRow1+0230,1060,aDadosBanco[3]+"/"+aDadosBanco[4]+"-"+aDadosBanco[5],oFont10)
...
oPrint:Say  (nRow1+0280,100 ,"Sacado",oFont8)
oPrint:Say  (nRow1+0330,100 ,aDatSacado[1],oFont10)				//Nome

oPrint:Say  (nRow1+0280,1060,"Vencimento",oFont8)
oPrint:Say  (nRow1+0330,1060,StrZero(Day(aDadosTit[4]),2) +"/"+ StrZero(Month(aDadosTit[4]),2) +"/"+ Right(Str(Year(aDadosTit[4])),4),oFont10)
...
oPrint:Say  (nRow2+0674,100,aDadosBanco[2],oFont14 )		// [2]Nome do Banco
oPrint:Say  (nRow2+0665,513,aDadosBanco[1]+"-2",oFont21 )	// [1]Numero do Banco
oPrint:Say  (nRow2+0674,1800,"Recibo do Sacado",oFont10)
...
oPrint:Say  (nRow2+0755,400 ,"ATÉ O VENCIMENTO, PREFERENCIALMENTE NO BRADESCO      ",oFont10)
oPrint:Say  (nRow2+0795,400 ,"APÓS O VENCIMENTO, SOMENTE NO BRADESCO      ",oFont10)
...
oPrint:Say  (nRow2+0840,100 ,"Cedente"                                        ,oFont8)
oPrint:Say  (nRow2+0880,100 ,aDadosEmp[1]+"                  - "+aDadosEmp[6]	,oFont10) //Nome + CNPJ

oPrint:Say  (nRow2+0840,1810,"Agência/Código Cedente",oFont8)
...
oPrint:Say  (nRow2+1080,100 ,"Instruções (Todas informações deste bloqueto são de exclusiva responsabilidade do cedente)",oFont8)
oPrint:Say  (nRow2+1180,100 ,aBolText[1]+" "+AllTrim(Transform((aDadosTit[5]*0.02),"@E 99,999.99"))       ,oFont10)
oPrint:Say  (nRow2+1230,100 ,aBolText[2]+" "+AllTrim(Transform(((aDadosTit[5]*0.01)/30),"@E 99,999.99"))  ,oFont10)
oPrint:Say  (nRow2+1280,100 ,aBolText[3]                                        ,oFont10)
...
oPrint:Say  (nRow2+1430,100 ,"Sacado"                                         ,oFont8)
...
oPrint:Say  (nRow2+1589,1880,Substr(aDadosTit[6],1,3)+Substr(aDadosTit[6],4)  ,oFont10)

oPrint:Say  (nRow2+1635,100 ,"Sacador/Avalista",oFont8)
...
oPrint:Say  (nRow3+1964,100,aDadosBanco[2],oFont14 )		// 	[2]Nome do Banco
oPrint:Say  (nRow3+1955,513,aDadosBanco[1]+"-7",oFont21 )	// 	[1]Numero do Banco
...
oPrint:Say  (nRow3+2045,400 ,"ATÉ O VENCIMENTO, PREFERENCIALMENTE NO BRADESCO      ",oFont10)
oPrint:Say  (nRow3+2085,400 ,"APÓS O VENCIMENTO, SOMENTE NO BRADESCO      ",oFont10)

oPrint:Say  (nRow3+2030,1810,"Vencimento",oFont8)
cString := StrZero(Day(aDadosTit[4]),2) +"/"+ StrZero(Month(aDadosTit[4]),2) +"/"+ Right(Str(Year(aDadosTit[4])),4)
nCol	 	 := 1810+(374-(len(cString)*22))
oPrint:Say  (nRow3+2070,nCol,cString,oFont11c)

oPrint:Say  (nRow3+2130,100 ,"Cedente",oFont8)
oPrint:Say  (nRow3+2170,100 ,aDadosEmp[1]+"                  - "+aDadosEmp[6]	,oFont10) //Nome + CNPJ

oPrint:Say  (nRow3+2130,1810,"Agência/Código Cedente",oFont8)
cString := Alltrim(aDadosBanco[3]+"/"+aDadosBanco[4]+"-"+aDadosBanco[5])
nCol 	 := 1810+(374-(len(cString)*22))
oPrint:Say  (nRow3+2170,nCol,cString ,oFont11c)
...
oPrint:Say  (nRow3+2260,1050,aDadosTit[8]										,oFont10) //Tipo do Titulo
...
oPrint:Say  (nRow3+2300,100 ,"Uso do Banco"                                   ,oFont8)

oPrint:Say  (nRow3+2300,505 ,"Carteira"                                       ,oFont8)
oPrint:Say  (nRow3+2330,555 ,aDadosBanco[6]                                  	,oFont10)

oPrint:Say  (nRow3+2300,755 ,"Espécie"                                        ,oFont8)
oPrint:Say  (nRow3+2330,805 ,"R$"                                             ,oFont10)

oPrint:Say  (nRow3+2300,1005,"Quantidade"                                     ,oFont8)
oPrint:Say  (nRow3+2300,1485,"Valor"                                          ,oFont8)

oPrint:Say  (nRow3+2300,1810,"Valor do Documento"                          	,oFont8)
cString := Alltrim(Transform(aDadosTit[5],"@E 99,999,999.99"))
nCol 	 := 1810+(374-(len(cString)*22))
oPrint:Say  (nRow3+2330,nCol,cString,oFont11c)

oPrint:Say  (nRow3+2370,100 ,"Instruções (Todas informações deste bloqueto são de exclusiva responsabilidade do cedente)",oFont8)
oPrint:Say  (nRow3+2470,100 ,aBolText[1]+" "+AllTrim(Transform((aDadosTit[5]*0.02),"@E 99,999.99"))      ,oFont10)
oPrint:Say  (nRow3+2520,100 ,aBolText[2]+" "+AllTrim(Transform(((aDadosTit[5]*0.01)/30),"@E 99,999.99"))  ,oFont10)
oPrint:Say  (nRow3+2570,100 ,aBolText[3]                                        ,oFont10)
oPrint:Say  (nRow3+2620,100 ,aCB_RN_NN[1]                                       ,oFont10) // CODIBAR
...
oPrint:Say  (nRow3+2720,100 ,"Sacado"                                         ,oFont8)
oPrint:Say  (nRow3+2730,400 ,aDatSacado[1]+" ("+aDatSacado[2]+")"             ,oFont10)
...
oPrint:Say  (nRow3+2783,400 ,aDatSacado[3]                                    ,oFont10)
oPrint:Say  (nRow3+2836,400 ,aDatSacado[6]+"    "+aDatSacado[4]+" - "+aDatSacado[5],oFont10) // CEP+Cidade+Estado
oPrint:Say  (nRow3+2836,1750,Substr(aDadosTit[6],1,3)+Substr(aDadosTit[6],4)  ,oFont10)

oPrint:Say  (nRow3+2845,100 ,"Sacador/Avalista"                               ,oFont8)
...
oPrint:FWMsBar("INT25" , 63.9 , 2.5  ,aCB_RN_NN[1],oPrint,.F.   ,Nil  ,Nil  , 0.025 ,1.0    ,Nil    ,Nil  ,"A"  ,.F.)
