...
ฑฑบ Programa ณ FICFGU03 บ Autor ณ TOTVS Protheus     บ Data ณ  05/03/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ PCO - Planning                                             บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FICFGU03 (FI-FIESP;CFG-Configurador;U-Update;Seq.03        ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function FICFGU03(_lShow,aMarcadas)
Local   aSay      := {}
Local   aButton   := {}
...
Local   cDesc6    := ""
Local   cDesc7    := "GAPID048 - Plannig PCO"
Local   lOk       := .F.
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		Else
			MsgStop( "Atualiza็ใo nใo Realizada.", "FICFGU03" )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  05/03/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
If ( lOpen := MyOpenSm0(.T.) )
	...
	If lOpen
		...
		If MyOpenSm0(.T.)
			...
			cAux += Replicate( " ", 128 ) + CRLF
			cAux += "LOG DA ATUALIZACAO DOS DICIONมRIOS - UPGAP093" + CRLF
			cAux += Replicate( " ", 128 ) + CRLF
			cAux += Replicate( "-", 128 ) + CRLF
			cAux += CRLF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  05/03/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	'Status do Orcamento'													, ; //X3_DESCSPA
	'Status do Orcamento'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	'0=Aberto;1=Aguardando Aprov.;2=Aprovado Conselho'						, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'.F.'																	, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Resp.Planilh'															, ; //X3_TITULO
	'Resp.Planilh'															, ; //X3_TITSPA
	'Resp.Planilh'															, ; //X3_TITENG
	'Responsavel Planilha'													, ; //X3_DESCRIC
	'Responsavel Planilha'													, ; //X3_DESCSPA
	'Responsavel Planilha'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Status'																, ; //X3_TITSPA
	'Status'																, ; //X3_TITENG
	'Status do Item'														, ; //X3_DESCRIC
	'Status do Item'														, ; //X3_DESCSPA
	'Status do Item'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Pertence("01")'														, ; //X3_VLDUSER
	'0=Aberto;1=Finalizado'													, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Usuar. Resp.'															, ; //X3_TITULO
	'Usuar. Resp.'															, ; //X3_TITSPA
	'Usuar. Resp.'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tel.Respons'															, ; //X3_TITULO
	'Tel.Respons'															, ; //X3_TITSPA
	'Tel.Respons'															, ; //X3_TITENG
	'Tel.do Responsavel CC'													, ; //X3_DESCRIC
	'Tel.do Responsavel CC'													, ; //X3_DESCSPA
	'Tel.do Responsavel CC'													, ; //X3_DESCENG
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  05/03/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, '* Especํfico FIESP *' )
aAdd( aHlpPor, 'Status do Or็amento' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAK1_XAPROV  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "AK1_XAPROV  " + CRLF

aHlpPor := {}
aAdd( aHlpPor, '* Especifico FIESP *' )
aAdd( aHlpPor, 'Responsแvel por consolidar os itens das' )
aAdd( aHlpPor, "CC'S." )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAK1_XRESPP", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "AK1_XRESPP" + CRLF
...
aHlpPor := {}
aAdd( aHlpPor, '* Especํfico FIESP*' )
aAdd( aHlpPor, 'Status do item no or็amento.' )
aAdd( aHlpPor, '(0-Aberto/1-Finalizado)' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAK2_XSTS  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "AK2_XSTS  " + CRLF
...
aHlpPor := {}
aAdd( aHlpPor, '* Especํfico FIESP *' )
aAdd( aHlpPor, 'Usuแrio do Responsแvel do C.Custo' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PCTT_XUSER  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "CTT_XUSER  " + CRLF

aHlpPor := {}
aAdd( aHlpPor, '* Especํfico FIESP *' )
aAdd( aHlpPor, 'Telefone do Responsแvel do C.Custo' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PCTT_XTEL  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "CTT_XTEL  " + CRLF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  05/03/2012 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
