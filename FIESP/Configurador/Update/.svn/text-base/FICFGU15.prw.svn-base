...
ฑฑบ Programa ณ FICFGU15   บ Autor ณ TOTVS Protheus     บ Data ณ  10/09/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPDSZ7     - Gerado por EXPORDIC / Upd. V.4.10.4 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function FICFGU15( cEmpAmb, cFilAmb )
...
Local   cDesc6    := ""
Local   cDesc7    := "Solicitacao de Contrato"
Local   lOk       := .F.
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPDSZ7" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPDSZ7" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
aAdd( aSX2, { ;
	...
	'SOLICITACAO DE CONTRATO'												, ; //X2_NOME
	'SOLICITACAO DE CONTRATO'												, ; //X2_NOMESPA
	'SOLICITACAO DE CONTRATO'												, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Sts S.Contr.'															, ; //X3_TITULO
	'Sts S.Contr.'															, ; //X3_TITSPA
	'Sts S.Contr.'															, ; //X3_TITENG
	'Status Solic.Contrato'													, ; //X3_DESCRIC
	'Status Solic.Contrato'													, ; //X3_DESCSPA
	'Status Solic.Contrato'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Numero'																, ; //X3_TITSPA
	'Numero'																, ; //X3_TITENG
	'Num.Solicitacao Contrato'												, ; //X3_DESCRIC
	'Num.Solicitacao Contrato'												, ; //X3_DESCSPA
	'Num.Solicitacao Contrato'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'GETSX8NUM("SZ7","Z7_NUM")'												, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Data Solic.'															, ; //X3_TITULO
	'Data Solic.'															, ; //X3_TITSPA
	'Data Solic.'															, ; //X3_TITENG
	'Data da Soicitacao'													, ; //X3_DESCRIC
	'Data da Soicitacao'													, ; //X3_DESCSPA
	'Data da Soicitacao'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'POSICIONE("SB1",1,XFILIAL("SZ7")+SZ7->Z7_PRODUTO,"SB1->B1_DESC")'		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	'Item Conta Contabil'													, ; //X3_DESCRIC
	'Item Conta Contabil'													, ; //X3_DESCSPA
	'Item Conta Contabil'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Classe Ctb.'															, ; //X3_TITULO
	'Classe Ctb.'															, ; //X3_TITSPA
	'Classe Ctb.'															, ; //X3_TITENG
	'Classe de Valor Contabil'												, ; //X3_DESCRIC
	'Classe de Valor Contabil'												, ; //X3_DESCSPA
	'Classe de Valor Contabil'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Outras Cond.'															, ; //X3_TITULO
	'Outras Cond.'															, ; //X3_TITSPA
	'Outras Cond.'															, ; //X3_TITENG
	'Outras Cond. Negociais'												, ; //X3_DESCRIC
	'Outras Cond. Negociais'												, ; //X3_DESCSPA
	'Outras Cond. Negociais'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Flag Revisao'															, ; //X3_TITULO
	'Flag Revisao'															, ; //X3_TITSPA
	'Flag Revisao'															, ; //X3_TITENG
	'Gera Revisao'															, ; //X3_DESCRIC
	'Gera Revisao'															, ; //X3_DESCSPA
	'Gera Revisao'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Informacao Forma Pagto.'												, ; //X3_DESCRIC
	'Informacao Forma Pagto.'												, ; //X3_DESCSPA
	'Informacao Forma Pagto.'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Nr. Contrato'															, ; //X3_TITSPA
	'Nr. Contrato'															, ; //X3_TITENG
	'Numero do Contrato'													, ; //X3_DESCRIC
	'Numero do Contrato'													, ; //X3_DESCSPA
	'Numero do Contrato'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Revisao'																, ; //X3_TITSPA
	'Revisao'																, ; //X3_TITENG
	'Seq. Revisao do Contrato'												, ; //X3_DESCRIC
	'Seq. Revisao do Contrato'												, ; //X3_DESCSPA
	'Seq. Revisao do Contrato'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod.Contigen'															, ; //X3_TITULO
	'Cod.Contigen'															, ; //X3_TITSPA
	'Cod.Contigen'															, ; //X3_TITENG
	'Cod.Contigencia'														, ; //X3_DESCRIC
	'Cod.Contigencia'														, ; //X3_DESCSPA
	'Cod.Contigencia'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Log de WF'																, ; //X3_TITSPA
	'Log de WF'																, ; //X3_TITENG
	'Log de Envio de WF'													, ; //X3_DESCRIC
	'Log de Envio de WF'													, ; //X3_DESCSPA
	'Log de Envio de WF'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Aguardando;2=Enviado'												, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	'Obs PCO'																, ; //X3_TITSPA
	'Obs PCO'																, ; //X3_TITENG
	'Observacoes PCO'														, ; //X3_DESCRIC
	'Observacoes PCO'														, ; //X3_DESCSPA
	'Observacoes PCO'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZ7'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'Z7_FILIAL+Z7_XCDCNTG'													, ; //CHAVE
	'Cod.Contigen'															, ; //DESCRICAO
	'Cod.Contigen'															, ; //DESCSPA
	'Cod.Contigen'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSX7, { ;
	...
	'SB1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'xFilial("SB1")+M->Z7_PRODUTO'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aHlpPor := {}
aAdd( aHlpPor, 'C๓digo da conta para apontamento do Bo-' )
aAdd( aHlpPor, 'letim de Faturamento e Varia็๖es.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ7_CONTA  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "Z7_CONTA  " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Descritivo da Forma de Pagamento para o' )
aAdd( aHlpPor, 'Contrato' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ7_PAGTO  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "Z7_PAGTO  " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Log de Envio de WF' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ7_WFE    ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "Z7_WFE    " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Observacoes PCO' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ7_OBSPCO ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "Z7_OBSPCO " + CRLF
