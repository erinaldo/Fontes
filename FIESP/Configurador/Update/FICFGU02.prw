...
ฑฑบ Programa ณ FICFGU02    บ Autor ณ TOTVS Protheus  บ Data ณ  01/12/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ COM - Condicao de Pagamento no ponto de Entrada            บฑฑ
ฑฑบ          ณ MTCOLSE2                                                   บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FICFGU02 (FI-FIESP;CFG-Configurador;U-Update;Seq.02        ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function FICFGU02(_lShow,aMarcadas)
...
Local   cDesc6    := ""
Local   cDesc7    := "EPID027 - Condi็ใo de Pagamentos 5 dia Util"
Local   lOk       := .F.
Local	cEmpAmb,cFilAmb	:= Nil
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPDSE4" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPDSE4" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  08/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  08/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dias da Cond'															, ; //X3_TITULO
	'Dias Condic.'															, ; //X3_TITSPA
	'Paym.Term Cd'															, ; //X3_TITENG
	'Dias(Dia\Liq\Sem\Qui\Mes)'												, ; //X3_DESCRIC
	'Dias(Dia\Liq\Sem\Qui\Mes)'												, ; //X3_DESCSPA
	'Days-Day\Net\Week\Thu\Mth'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'pertence("D\L\S\Q\F\Z")'												, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'D=Data do Dia;L=Fora o Dia;S=Fora Semana;Q=Fora quinzena;F=Fora Mes;Z=Fora Dezena', ; //X3_CBOX
	'D=Fecha del Dia;L=Pasado el Dia;S=Pasada la Semana;Q=Pasada la Quincena;F=Pasado el Mes;Z=Pasada la Decena', ; //X3_CBOXSPA
	'D=Date of the Day;L=Out day;S=Out Week;Q=Out Two Weeks;F=Out Month;Z=Out 10 Days', ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'IIF(M->E4_XDIAUTL$"123",.F.,.T.)'										, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	'S'																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	'1=5บ Dia Util mantem sexta;2=5บ Dia Util primeira sexta;3=5บ Dia Util qualquer Dia da Semana;4=Mantem o Padrao', ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX7 บ Autor ณ TOTVS Protheus     บ Data ณ  08/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX7, { ;
	'E4_XDIAUTL'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'IIF(M->E4_XDIAUTL$"123","F","L")'										, ; //X7_REGRA
	'E4_DDD'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  08/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Dias da condi็ใo de pagamento, sendo:' )
aAdd( aHlpPor, 'D = Data do dia     L = Fora o dia' )
aAdd( aHlpPor, 'S = Fora Semana     Q = Fora Quinzena' )
aAdd( aHlpPor, 'F = Fora Mes        Z = Fora Dezena' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE4_DDD    ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E4_DDD    " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Controla Dia Util???' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE4_XDIAUTL", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E4_XDIAUTL" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Calcula Pro-Rata? Utilizado na rotina de' )
aAdd( aHlpPor, 'Cronograma Financeiro - CONTRATOS (GCT)' )
aHlpEng := {}
aHlpSpa := {}
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  08/08/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
