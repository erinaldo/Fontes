...
ฑฑบPrograma  ณFIPCOA11  บAutor  ณTOTVS               บ Data ณ  10/01/12   บฑฑ
...
If lContinua
	...
	//ณAtualiza campo AK1_XAPROV=1 (Aguardando Aprov)ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVldFlzOrc บAutor  ณTOTVS               บ Data ณ  11/01/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณValida se pode ser finalizado Digitacao					  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
//ณCaso campo AK1_XAPROV <> 2 apresentar mensagem  ณ
//ณe nao continuar.                                ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู

If AK1->AK1_XAPROV == '1'
	MsgStop("Esta planilha jแ foi finalizada. Verifique!")
	lRet:= .F.
Endif

If AK1->AK1_XAPROV == '2'
	MsgStop("Esta planilha jแ foi aprovada. Verifique!")
	lRet:= .F.
Endif        
...
//ณVerifica se todos os itens de todos os C.Custo estao finalizadosณ
...
If lRet
	...
	While !Eof() .and. AK2->(AK2_FILIAL+AK2_ORCAME+AK2_VERSAO) = AK1->(AK1_FILIAL+AK1_CODIGO+AK1_VERSAO) .and. !lAchou
		If AK2->AK2_XSTS <> '1'
			lAchou	:= .T.
			lRet	:= .F.
			MsgStop("Encontrado um ou mais itens em Aberto. Verifique!","Atencใo")
		Endif
		dbSkip()
	Enddo
Endif
