...
{"PMSEDT4"     , "Ag. Aprov. Al็ada (Financeiro)"           },;
{"BR_PRETO"    , "Rejeit.por Al็ada (Financeiro)"           },;
...
_cUserMas	    := GetMv("FI_MASTVIA",,.F.) // Usuแrios que poderใo ver todo o browse de viagens (sem nenhum filtro)
_aArea   		:= GetArea()
_cUserGrpCom 	:= ""
DbSelectArea("SAJ")
SAJ->(dbSetOrder(1))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFICDVA01  บAutor  ณMicrosiga           บ Data ณ  02/04/14   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Acrescenta Novo Filtro (conforme opcoes da Legenda)        บฑฑ
ฑฑบ          ณ F4                                                         บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Local cCbx  := "Elabora็ใo"
Local aCbx  := { 	"E-Elabora็ใo",;
					"C-Em Processo de Cota็ใo",;
					"U-Ag.Aprov.Solicitante",;
					"S-Ag.Liber.Final (Gestor)",;
					"R-Rejeit.por Al็ada (Financeiro)",;
					"Y-Ag.Pedido de Compras",;
					"F-Pedido de Compras/Ag.Presta็ใo de Contas",;
					"Z-Encerrada",;
					"W-Solicita็ใo Cancelada",;
					"T-Ag.Lib.Conting๊ncia",;
					"Q-Ag.Aprov.Al็ada (Financeiro) ",;
...
ฑฑบPrograma  ณFICDVA01  บAutor  ณMicrosiga           บ Data ณ  02/04/14   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Restaura Filtro Original                                   บฑฑ
ฑฑบ          ณ F12                                                        บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
If (lRet)
	...
	If (lRet)
		...
		If (SZ1->(DbSeek(cFil + cNum)))
			...
			/*
			//Retirado para deixar gerar Presta็ใo de Contas mesmo que nao tenha ADT. Fluxo normal
			If SZ1->Z1_ADIANTA > 0		
				SZ1->Z1_STATUS := "F" //Se tiver saldo de Adiantamento manda para a Prestacao de Contas
			Else
...
If (nOpc != 7)
//	If !(SZ1->Z1_SOLICIT $ __cUserId)
	If nOpc == 3 // Inclusao da Cota็ใo (somente o pessoal de Compras pode realizar esta rotina
		If !(__cUserId $ cUserCom) 
			Aviso("Aviso", "Este usuแrio nใo possui permissใo para Incluir Cota็ใo.", {"Ok"}, 1)
			lRet := .F.
		EndIf
...
//		If !(SZ1->Z1_SOLICIT $ __cUserId) .or. !(ALLTRIM(SZ1->Z1_CCUSTO) $ _cCentroC)
		If !(ALLTRIM(SZ1->Z1_CCUSTO) $ _cCentroC)
			Aviso("Aviso", "Este usuแrio nใo possui permissใo para Analisar Cota็ใo.", {"Ok"}, 1)
			lRet := .F.
		Endif
	Endif
Endif
...
If (SZ1->(DbSeek(cFil + cNum)))
	RecLock("SZ1", .F.)
	SZ1->Z1_STATUS := "C" //Volta para a Cota็ใo para ser Alterado o Fornecedor e os Valores.
	SZ1->(MsUnlock())
...
Local _lLancSC     := PcoExistLc("900002","02","1") // Verifica se existe lan็amento ativo
Local _lBloqSC     := PcoExistLc("900002","02","2") // Verifica se existe bloqueio ativo

If _lBloqSC //O Retorno desta variavel ้ .t. quando o mesmo esta Desativado. Somente faz analise orcamento se o Lancamento estiver ativo
...
If (lRet)
	...
	// Altera็ใo Donizeti 19/12/13 Para passar por parโmetros o Z1_TPVIAJA e nDias
...
//		cNome := AllTrim(UsrRetName(Posicione("SA2", 1, xFilial("SA2") + SZ1->Z1_CODVIAJ + SZ1->Z1_LOJAVIA, "A2_XSUPVIA")))
		...
		//e-mail para o Superior Responsavel de Aprova็ใo Final da Solicitacao.
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFICDVRTC  บAutor  ณFelipe Alves        บ Data ณ  13/11/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If (lRet)
	...
	If (lRet)
		If (Aviso("Confirma็ใo", "Deseja Enviar para Compras?", {"Sim", "Nใo"}, 1) == 1)
			...
			cBody := "Prezado(a) Comprador(a)," + CRLF + CRLF
			cBody += "Informamos que existe a Solicita็ใo de Viagem nบ '" + cNum + "' para sua cota็ใo."
		...
		For nI := 1 To Len(oRateio:aCols)
			If !(oRateio:aCols[nI][6])
				...
				IF oRateio:aCols[nI][5] == 0 .and. lRet
					Aviso("% Invแlido","Lan็ado % Invแlido de Rateio", {"Ok"}, 1)
					lRet := .F.
				ENDIF
			Endif
		Next nI
	...
	If (lRet)
		If !(SZ1->Z1_STATUS $ "X")
	        If SZ1->Z1_STATUS == "Z" // Prestacao de Contas ja Encerrada/Aprovada
				If ApMsgYesNo("Confirma estorno da libera็ใo?","Confirmar")
					lRet := .F.
...
//	Activate MsDialog oDlg Center On Init (EnchoiceBar(oDlg, {|| MsgRun("Gravando informa็๕es, aguarde...", "Solicita็๕es de Viagens",;
...
//			cNome := Posicione("SA2", 1, xFilial("SA2") + SZ1->Z1_CODVIAJ + SZ1->Z1_LOJAVIA, "A2_NOME")
			...
			cNome := AllTrim(UsrRetName(SZ1->Z1_SOLICIT))
			cBody := "Prezado(a) " + cNome + "," + CRLF + CRLF
			cBody += "Informamos que a Presta็ใo de Contas de sua Solicita็ใo de Viagem nบ '" + cNum + "' foi cancelada." + CRLF
			ACSendMail(, , , , cEmail, "SV " + cNum + "", cBody)
			
			Aviso("Aviso", "Solicita็ใo cancelada com sucesso.", {"Ok"}, 1)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณRatOk	   บAutor  ณ Donizeti Lopes      บ Data ณ  17/12/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณValidacao de todas as linhas da getdados                    บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FIESP                                                      บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCheckIt3 บAutor  ณ Donizeti Lopes      บ Data ณ  19/12/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณValidacao de todas as linhas da getdados, verificando  exis-บฑฑ
ฑฑบ          ณt๊ncia de Itens Invalidos                                   บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FIESP                                                      บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFICDVA01  บAutor  ณTOTVS               บ Data ณ  05/11/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
U_FICDVR01(1)
Else     
alert("A Autoriza็ใo nใo pode ser impressa nesse estแgio!")
Endif
Endif
...
U_FICDVR02(1)
Else     
alert("A Presta็ใo de Contas somente poderแ ser impressa depois da Aprova็ใo do Gestor pelo sistema.")
Endif
Endif
