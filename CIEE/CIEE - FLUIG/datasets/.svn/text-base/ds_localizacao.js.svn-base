function createDataset(fields, constraints, sortFields) {
	...
	dataset.addColumn("cdLocalizacaoTransf");
	dataset.addColumn("dsLocalizacaoTransf");
	...
	try {
		...
		if(semResultado)
			return gerarDatasetErro("Não foram localizados dados de localização. Favor verifique a paramtrização no Protheus");
