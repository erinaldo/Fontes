...
ฑฑบPrograma  ณ  GeraArq   บAutor  ณ Totvs       	   บ Data ณ01/01/2015 บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ  ImpRel    บAutor  ณ Totvs       	   บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDescrio ณ Funcao auxiliar chamada pela RPTSTATUS. A funcao RPTSTATUS บฑฑ
ฑฑบ          ณ monta a janela com a regua de processamento.               บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ VerCabec   บAutor  ณ Totvs       	   บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ CriaSX1    บAutor  ณ Totvs       	   บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
aAdd( aSX1, {cPerg,'01','Produto de         ?','จDe Producto       ?','From Product       ?','mv_ch1','C',15,0,0,'G','','mv_par01','','','','','','','','','','','','','','','','','','','','','','','','','SB1','','','','',''} )
aAdd( aSX1, {cPerg,'02','Produto Ate        ?','จA  Producto       ?','To Product         ?','mv_ch2','C',15,0,0,'G','','mv_par02','','','','ZZZZZZZZZZZZ','','','','','','','','','','','','','','','','','','','','','SB1','','','','',''} )
aAdd( aSX1, {cPerg,'03','Grupo de           ?','จFecha Limite      ?','From Group         ?','mv_ch3','C',4,0,0,'G','','mv_par03','','','','01','','','','','','','','','','','','','','','','','','','','','SBM','','','','',''} )
aAdd( aSX1, {cPerg,'04','Grupo Ate          ?','จBloquea/Desbloquea?','To Group           ?','mv_ch4','C',4,0,0,'G','','mv_par04','','','','15','','','','','','','','','','','','','','','','','','','','','SBM','','','','',''} )
aAdd( aSX1, {cPerg,'05','Emissao de         ?','จDe Emision        ?','From Issue         ?','mv_ch5','D',8,0,0,'G','','mv_par05','','','','20120401','','','','','','','','','','','','','','','','','','','','','','','','','',''} )
aAdd( aSX1, {cPerg,'06','Emissao ate        ?','จA  Emision        ?','To Issue           ?','mv_ch6','D',8,0,0,'G','','mv_par06','','','','20120430','','','','','','','','','','','','','','','','','','','','','','','','','',''} )
...
IF lAtuHelp        
	...
	AADD(aHelp, {'01',{'C๓digo inicial do produto.'},{''},{''}}) 
	AADD(aHelp, {'02',{'C๓digo final do produto.'},{''},{''}}) 
	AADD(aHelp, {'03',{'C๓digo inicial do grupo.'},{''},{''}}) 
	AADD(aHelp, {'04',{'C๓digo final do grupo.'},{''},{''}}) 
	AADD(aHelp, {'05',{'Data inicial emissใo.'},{''},{''}}) 
	AADD(aHelp, {'06',{'Data final emissใo.'},{''},{''}})	
