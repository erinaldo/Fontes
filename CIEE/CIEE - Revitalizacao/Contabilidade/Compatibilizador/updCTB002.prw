...
/*/
//--------------------------------------------------------------------
User Function UpdCtb002( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Enviado EAI?'															, ; //X3_TITULO
	'Enviado EAI?'															, ; //X3_TITSPA
	'Enviado EAI?'															, ; //X3_TITENG
	'Enviado EAI'															, ; //X3_DESCRIC
	'Enviado EAI'															, ; //X3_DESCSPA
	'Enviado EAI'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
