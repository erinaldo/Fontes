...
/*/
//--------------------------------------------------------------------
User Function UPGFAT02( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPGFAT02" )
				Else
					MsgStop( "Atualização não Realizada.", "UPGFAT02" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, {{'SA1',.T.},{'N2',.T.},{'A1_XCODSOE',.T.},{'C',.T.},{15,.T.},{0,.T.},{'Codigo SOE',.T.},{'Codigo SOE',.T.},{'Codigo SOE',.T.},{'Codigo SOE',.T.},{'Codigo SOE',.T.},{'Codigo SOE',.T.},{'',.T.},{'',.T.},{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),.T.},{'',.T.},{'',.T.},{0,.T.},{Chr(254) + Chr(192),.T.},{'',.T.},{'',.T.},{'U',.T.},{'N',.T.},{'A',.T.},{'R',.T.},{'€',.F.},{'',.F.},{'',.T.},{'',.T.},{'',.T.},{'',.T.},{'',.F.},{'',.T.},{'',.T.},{'',.T.},{'',.T.},{'',.T.},{'',.T.},{'N',.T.},{'',.T.},{'',.T.},{'N',.T.},{'',.T.},{'',.T.}} )
...
aAdd( aSIX, {'SA1','A','A1_FILIAL+A1_XCODSOE','Codigo SOE','Codigo SOE','Codigo SOE','U','','CODCLISOE','S'} )
//
// Atualizando dicionário
//
