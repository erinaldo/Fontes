...
/*/
//--------------------------------------------------------------------
User Function UPDTes06( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Solicit. Apv'															, ; //X3_TITULO
	'Solicit. Apv'															, ; //X3_TITSPA
	'Solicit. Apv'															, ; //X3_TITENG
	'Solicit.da Aprov. Bordero'												, ; //X3_DESCRIC
	'Solicit.da Aprov. Bordero'												, ; //X3_DESCSPA
	'Solicit.da Aprov. Bordero'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Sts. Apv Bor'															, ; //X3_TITULO
	'Sts. Apv Bor'															, ; //X3_TITSPA
	'Sts. Apv Bor'															, ; //X3_TITENG
	'Status Aprov Bordero'													, ; //X3_DESCRIC
	'Status Aprov Bordero'													, ; //X3_DESCSPA
	'Status Aprov Bordero'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX6, { ;
	...
	'CI_GRPFIWF'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Grupo de Aprovacao de Bordero de Pagamento'							, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
