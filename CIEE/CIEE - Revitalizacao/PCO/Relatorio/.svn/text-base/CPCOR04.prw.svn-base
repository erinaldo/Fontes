...
#INCLUDE "TOPCONN.CH"  
//---------------------------------------------------------------------------------------
/*/{Protheus.doc} CPCOR04
Relat๓rio acompanhamento or็amentแrio por unidade e CR
@author  	Totvs
@since     	01/01/2015
@version  	P.11.8      
@return   	Nenhum
...
IF (nTipoRel:= Aviso("Acompanhamento or็amentแrio por unidade e CR","Informe qual relat๓rio deseja imprimir ?",{"Contแbil","Gerencial"})) > 0
	
	cPerg:= iif(nTipoRel==1,"CPCOR04C","CPCOR04G")  
	C9R04SX1(cPerg,nTipoRel)
	Pergunte(cPerg,.F.)
	
	oReport := TReport():New("CPCOR04","Relat๓rio de acompanhamento or็amentแrio por unidade e CR",cPerg,{|oReport| C9R04IMP(oReport,cTab,aGrpRecFin[nTipoRel],nTipoRel)},"Este relat๓rio irแ imprimir o relat๓rio de acompanhamento or็amentแrio por unidade e CR.")
	oReport:SetTotalInLine(.F.)      
	oReport:SetDynamic()
	oReport:PageTotalBefore(.T.) 
	oReport:bTotalCanPrint:= {|| }
	oReport:SetCustomText( {|| IIF(oReport:NDEVICE==4,{},C9R04CAB(oReport)) } )
	 
	oSection01:= TRSection():New(oReport, "Contribui็๕es e Receitas",{cTab}, aOrdem)	
	TRCell():New(oSection01, "DESCTA"		, cTab	, "Descri็ใo"			,/*Picture*/						, 60	, /*lPixel*/, /*bBlock*/	) 	
...
ฑฑบPrograma  ณ C9R04IMP	  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R04IMP(oReport,cTab,cGrpRecFin,nTipoRel) 
...
Local cCO			:= ""
Local nSubAte		:= 0
local aTotUNIDADE		:= {0,0,0,0,0,0,0,0}
...
// Monta SQL
cQry:= " WITH ACOORC(CONTA,DESCTA,CUNIDADE,CCUSTO,TIPO,ORCADO,REALIZADO,ORCADOAC,REALIZADOAC)"+CRLF
cQry+= " AS("+CRLF
cQry+= " 	SELECT CT1."+cCampConta+" AS CONTA"+CRLF
cQry+= " 		  ,CT1."+cCampDesc+" AS DESCTA"+CRLF
cQry+= " 		  ,AKD1.AKD_ENT05 AS CUNIDADE"+CRLF
cQry+= " 		  ,AKD1.AKD_CC AS CCUSTO"+CRLF
...
cQry+= " 		AND AKD1.AKD_ENT05 = '"+MV_PAR04+"'"+CRLF

if MV_PAR05 == 1
	cQry+= " 		AND AKD1.AKD_CC BETWEEN '"+MV_PAR06+"' AND '"+MV_PAR07+"'"+CRLF
endif
...
cQry+= " 	GROUP BY CT1."+cCampConta+",CT1."+cCampDesc+",AKD1.AKD_ENT05,AKD1.AKD_CC,AKD1.AKD_TIPO"+CRLF
cQry+= " 	UNION ALL"+CRLF
cQry+= " 	SELECT CT1."+cCampConta+" AS CONTA"+CRLF
cQry+= " 		  ,CT1."+cCampDesc+" AS DESCTA"+CRLF
cQry+= " 		  ,AKD2.AKD_ENT05 AS CUNIDADE"+CRLF
cQry+= " 		  ,AKD2.AKD_CC AS CCUSTO"+CRLF
...
cQry+= " 		AND AKD2.AKD_ENT05 = '"+MV_PAR04+"'"+CRLF

if MV_PAR05 == 1
	cQry+= " 		AND AKD2.AKD_CC BETWEEN '"+MV_PAR06+"' AND '"+MV_PAR07+"'"+CRLF
endif
...
cQry+= " 		AND CT1.D_E_L_E_T_=''"+CRLF
cQry+= " 	GROUP BY CT1."+cCampConta+",CT1."+cCampDesc+",AKD2.AKD_ENT05,AKD2.AKD_CC,AKD2.AKD_TIPO"+CRLF
cQry+= " 	UNION ALL"+CRLF
cQry+= " 	SELECT CT1."+cCampConta+" AS CONTA"+CRLF
cQry+= " 		  ,CT1."+cCampDesc+" AS DESCTA"+CRLF
cQry+= " 		  ,AKD1.AKD_ENT05 AS CUNIDADE"+CRLF
...
cQry+= " LEFT JOIN "+RETSQLNAME("CV0")+" CV0 ON CV0_FILIAL='"+XFILIAL("CV0")+"'"+CRLF
cQry+= " 	AND CV0_PLANO='05'"+CRLF
cQry+= " 	AND CV0_CODIGO=CUNIDADE"+CRLF
...
cQry+= " GROUP BY CONTA,DESCTA,CUNIDADE,CV0_DESC,CCUSTO,CTT_DESC01"+CRLF
cQry+= " ORDER BY CUNIDADE ASC,CCUSTO ASC,SUBSTRING(CONTA,1,1) DESC,CONTA ASC "+CRLF
	...
	WHILE (cTab)->(!EOF()) .AND. !oReport:Cancel()	 
		...
		IF cUnidade!=(cTab)->CUNIDADE
			...
			IF !EMPTY(cCO) .AND. MV_PAR10 == 1 .AND. MV_PAR09 != 5
				...
				// Zera totalizadores por UNIDADE
			...
			IF !EMPTY(cCR)
				oSection01:Init()
				oSection01:Cell("DESCTA"			):SetBlock({|| space(2)+"TOTAL CR " + cDescCR 	})
				oSection01:Cell("ORCADO"			):Show()
				oSection01:Cell("REALIZADO"		):Show()
				oSection01:Cell("NOMINAL"		):Show()
				oSection01:Cell("PERCENT"		):Show()
			...
			// Fecha totalizador por UNIDADE
			IF !EMPTY(cUnidade)
				oSection01:Init()
				oSection01:Cell("DESCTA"			):SetBlock({|| "TOTAL UNIDADE " + cDescUnid 	})
				oSection01:Cell("ORCADO"			):Show()
				oSection01:Cell("REALIZADO"		):Show()
				oSection01:Cell("NOMINAL"		):Show()
				oSection01:Cell("PERCENT"		):Show()
				...
				oSection01:Cell("NOMINALAC"		):Show()
				oSection01:Cell("PERCENTAC"		):Show()	
				oSection01:Cell("ORCADO"			):SetBlock({|| aTotUNIDADE[1] 	})
				oSection01:Cell("REALIZADO"		):SetBlock({|| aTotUNIDADE[2]		})
				oSection01:Cell("NOMINAL"		):SetBlock({|| aTotUNIDADE[3] 	})
				oSection01:Cell("PERCENT"		):SetBlock({|| aTotUNIDADE[4] 	})
				oSection01:Cell("ORCADOAC"		):SetBlock({|| aTotUNIDADE[5] 	})
				oSection01:Cell("REALIZADOAC"	):SetBlock({|| aTotUNIDADE[6] 	})
				oSection01:Cell("NOMINALAC"		):SetBlock({|| aTotUNIDADE[7] 	})
				oSection01:Cell("PERCENTAC"		):SetBlock({|| aTotUNIDADE[8] 	})
				oSection01:PrintLine()
				
				// Zera totalizadores por UNIDADE
				aTotUNIDADE:= {0,0,0,0,0,0,0,0}
				cDescUnid:= (cTab)->CV0_DESC
				oReport:SkipLine(1)	
				
				C9R04FEC(2,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
				oReport:EndPage()
				oReport:StartPage()				
				lRecDesp:= .T.			
			ENDIF
			...
			IF MV_PAR10 != 1  .AND. lRecDesp .and. cContax != LEFT((cTab)->CONTA,1)
				C9R04FEC(1,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
				cContax:= LEFT((cTab)->CONTA,1)
				lRecDesp:= .F.	
			ENDIF	
			
			oSection01:Init()
			oSection01:Cell("DESCTA"			):SetBlock({|| "UNIDADE "+ trim((cTab)->CUNIDADE) +" - " +(cTab)->CV0_DESC 	})		
		...
		IF cCR!=(cTab)->CCUSTO
			...
			oSection01:Init()
			oSection01:Cell("DESCTA"			):SetBlock({|| Space(2)+"CR "+ trim((cTab)->CCUSTO) +" - " +(cTab)->CTT_DESC01 	})		
			oSection01:Cell("ORCADO"			):Hide()
			oSection01:Cell("REALIZADO"		):Hide()
			oSection01:Cell("NOMINAL"		):Hide()
			oSection01:Cell("PERCENT"		):Hide()
		...
		// Atualiza totalizadores por UNIDADE
		aTotUNIDADE[1]+= (cTab)->ORCADO
		aTotUNIDADE[2]+= (cTab)->REALIZADO
		aTotUNIDADE[3]:= aTotUNIDADE[2] - aTotUNIDADE[1]
		aTotUNIDADE[4]:= ((aTotUNIDADE[2] - aTotUNIDADE[1]) * 100) / aTotUNIDADE[1]
		aTotUNIDADE[5]+= (cTab)->ORCADOAC
		aTotUNIDADE[6]+= (cTab)->REALIZADOAC
		aTotUNIDADE[7]:= aTotUNIDADE[6] - aTotUNIDADE[5]
		aTotUNIDADE[8]:= ((aTotUNIDADE[6] - aTotUNIDADE[5]) * 100) / aTotUNIDADE[5]	
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R04FEC	  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R04FEC(nTipo,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R04SX1  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R04SX1(cPerg,nTipoRel)
LOCAL aArea    	:= GetArea()
...
if nTipoRel == 1      
	...
	AADD(aDados,{cPerg,'04','Unidade ?','Unidade ?','Unidade ?','MV_CH4','C',TAMSX3("CV0_CODIGO")[1],0,0,'G','','MV_PAR04','','','','','','','','','','','','','','','','','','','','','','','','','CV05','','','','',''} )
	AADD(aDados,{cPerg,'05','Considera CR ?','Considera CR ?','Considera CR ?','MV_CH5','C',1,0,0,'C','','MV_PAR05','Sim','Sim','Sim','','','Nใo','Nใo','Nใo','','','','','','','','','','','','','','','','','','','','','',''} )
	AADD(aDados,{cPerg,'06','CR de ?','CR de ?','CR de ?','MV_CH6','C',TAMSX3("AKD_CC")[1],0,0,'G','','MV_PAR06','','','','','','','','','','','','','','','','','','','','','','','','','CTT','','','','',''} )
	AADD(aDados,{cPerg,'07','CR at้ ?','CR at้ ?','CR at้ ?','MV_CH7','C',TAMSX3("AKD_CC")[1],0,0,'G','','MV_PAR07','','','','','','','','','','','','','','','','','','','','','','','','','CTT','','','','',''} )
	AADD(aDados,{cPerg,'08','Selec. Atividade ?','Selec. Atividade ?','Selec. Atividade ?','MV_CH8','C',1,0,0,'C','','MV_PAR08','Sim','Sim','Sim','','','Nใo','Nใo','Nใo','','','','','','','','','','','','','','','','','','','','','',''} )
	...
	AADD(aDados,{cPerg,'10','Pr๓ximo nivel ?','Pr๓ximo nivel ?','Pr๓ximo nivel ?','MV_CHA','C',1,0,0,'C','','MV_PAR10','Sim','Sim','Sim','','','Nใo','Nใo','Nใo','','','','','','','','','','','','','','','','','','','','','',''} )
...
IF lAtuHelp        
	if nTipoRel == 1 
		...
		AADD(aHelp, {'04',{'Informe o UNIDADE.'},{''},{''}}) 
		AADD(aHelp, {'05',{'Informe o CR inicial.'},{''},{''}}) 
		AADD(aHelp, {'06',{'Informe o CR final.'},{''},{''}})
		AADD(aHelp, {'07',{'Informe o nivel da conta.'},{''},{''}})		
		AADD(aHelp, {'08',{'Informe se seleciona as atividades.'},{''},{''}}) 
		AADD(aHelp, {'09',{'Informe o nivel da conta.','Para o Nivel 5 o parametro pr๓ximo','้ desconsiderado.'},{''},{''}})
		AADD(aHelp, {'10',{'Informe serแ impresso o pr๓ximo nivel da conta.'},{''},{''}})
	else
		AADD(aHelp, {'01',{'M๊s e ano de refer๊ncia.'},{''},{''}})
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R04ATV  บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
DEFINE MSDIALOG oDlg TITLE "Selecione as Atividades" FROM 0,0 TO 300,800 OF oMainWnd PIXEL  
	...
	oGetD01:oBrowse:blDblClick 	:= {|| C9R04MARK() }
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R04MARK บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R04CAB บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015     บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R04CAB(oReport)
Local cChar	:= chr(160) 
...
Local aCabec 	:= {	""; 
			        ...
			        + "         " + cChar;										
					, "         " + cChar + "                                      DETALHAMENTO DAS CONTRIBUIวีES/DESPESAS POR UNIDADE E CENTRO DE RESPONSABILIDADE                      "  ;					
		  			+ "         " + cChar; 
