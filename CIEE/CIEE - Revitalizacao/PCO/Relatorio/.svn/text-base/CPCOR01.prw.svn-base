...
//---------------------------------------------------------------------------------------
/*/{Protheus.doc} CPCOR01
Relat๓rio acompanhamento or็amentแrio por CR
@author  	Totvs
@since     	01/01/2015
@version  	P.11.8      
@return   	Nenhum
...
/*/
//---------------------------------------------------------------------------------------
User Function CPCOR01()
LOCAL oReport  	:= NIL 
Local oSection01	:= NIL 
LOCAL cPerg		:= ""
Local aOrdem		:= {"CR + CONTA"}
...
IF (nTipoRel:= Aviso("Acompanhamento Or็amentแrio por CR","Informe qual relat๓rio deseja imprimir ?",{"Contแbil","Gerencial"})) > 0
	
	cPerg:= iif(nTipoRel==1,"CPCOR01C","CPCOR01G")  
	C9R01SX1(cPerg,nTipoRel)
	Pergunte(cPerg,.F.)
	
	oReport := TReport():New("CPCOR01","Relat๓rio de acompanhamento or็amentแrio por CR",cPerg,{|oReport| C9R01IMP(oReport,cTab,aGrpRecFin[nTipoRel],nTipoRel)},"Este relat๓rio irแ imprimir o relat๓rio de acompanhamento or็amentแrio por CR.")
	oReport:SetTotalInLine(.F.)      
	oReport:SetDynamic()
	oReport:PageTotalBefore(.T.) 
	oReport:bTotalCanPrint:= {|| }
	oReport:SetCustomText( {|| IIF(oReport:NDEVICE==4,{},C9R01CAB(oReport)) } )
...
ฑฑบPrograma  ณ C9R01IMP	  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R01IMP(oReport,cTab,cGrpRecFin,nTipoRel) 
...
// Monta SQL
cQry:= " WITH ACOORC(CONTA,DESCTA,CCUSTO,TIPO,ORCADO,REALIZADO,ORCADOAC,REALIZADOAC)"+CRLF
cQry+= " AS("+CRLF
...
//cQry+= " 		AND AKD1.AKD_CC = '"+MV_PAR04+"'"+CRLF
...
cQry+= " 	GROUP BY CT1."+cCampConta+",CT1."+cCampDesc+",AKD1.AKD_CC,AKD1.AKD_TIPO"+CRLF
cQry+= " 	UNION ALL"+CRLF
cQry+= " 	SELECT CT1."+cCampConta+" AS CONTA"+CRLF
cQry+= " 		  ,CT1."+cCampDesc+" AS DESCTA"+CRLF
cQry+= " 		  ,'"+MV_PAR04+"' AS CCUSTO"+CRLF
...
cQry+= " 		AND CT1.D_E_L_E_T_=''"+CRLF
cQry+= " 	GROUP BY CT1."+cCampConta+",CT1."+cCampDesc+",AKD2.AKD_CC,AKD2.AKD_TIPO"+CRLF
cQry+= " 	UNION ALL"+CRLF
cQry+= " 	SELECT CT1."+cCampConta+" AS CONTA"+CRLF
cQry+= " 		  ,CT1."+cCampDesc+" AS DESCTA"+CRLF
cQry+= " 		  ,'"+MV_PAR04+"' AS CCUSTO"+CRLF
...
cQry+= " GROUP BY CONTA,DESCTA,CCUSTO,CTT_DESC01"+CRLF
cQry+= " ORDER BY CCUSTO ASC,SUBSTRING(CONTA,1,1) DESC,CONTA ASC "+CRLF
	...
	WHILE (cTab)->(!EOF()) .AND. !oReport:Cancel()	 
		...
		IF cCR!=(cTab)->CCUSTO
			...
			IF !EMPTY(cCR)
				...
				C9R01FEC(2,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
				oReport:EndPage()
				oReport:StartPage()				
				lRecDesp:= .T.			
			ENDIF
			...
			IF MV_PAR07 != 1  .AND. lRecDesp .and. cContax != LEFT((cTab)->CONTA,1)
				C9R01FEC(1,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
				cContax:= LEFT((cTab)->CONTA,1)
				lRecDesp:= .F.	
			ENDIF	
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R01CTT	  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ Monta hierarquia de centro de custo					  		บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ CIEE                                                     	บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
USER FUNCTION C9R01CTT(cCusto,cCustoAte)
LOCAL cTab			:= GetNextAlias()
LOCAL cQry			:= ""
local cRet			:= ""
default cCustoAte	:= ""

cQry:= " WITH ESTCR(CCUSTO,CCSUP,CLASSE)"+CRLF
cQry+= " AS("+CRLF
cQry+= "		SELECT CTT_CUSTO AS CCUSTO,CTT_CCSUP AS CCSUP,CTT_CLASSE AS CLASSE FROM "+RETSQLNAME("CTT")+" CTTA"+CRLF
cQry+= "		WHERE CTTA.CTT_FILIAL='"+XFILIAL("CT1")+"'"+CRLF
if empty(cCustoAte)
	cQry+= "		AND CTTA.CTT_CUSTO='"+cCusto+"'"+CRLF
else
	cQry+= " 		AND CTTA.CTT_CUSTO BETWEEN '"+cCusto+"' AND '"+cCustoAte+"'"+CRLF
endif	
cQry+= "		AND CTTA.D_E_L_E_T_=''"+CRLF
cQry+= "		UNION ALL"+CRLF
cQry+= "		SELECT CTT_CUSTO AS CCUSTO,CTT_CCSUP AS CCSUP,CTT_CLASSE AS CLASSE FROM "+RETSQLNAME("CTT")+" CTTB"+CRLF
cQry+= "		INNER JOIN ESTCR EST ON EST.CCUSTO=CTTB.CTT_CCSUP"+CRLF
cQry+= "			AND CTTB.D_E_L_E_T_=''"+CRLF
cQry+= "		WHERE CTTB.CTT_FILIAL='"+XFILIAL("CT1")+"'"+CRLF
cQry+= "		AND CTTB.D_E_L_E_T_=''"+CRLF
cQry+= " )SELECT * FROM ESTCR"+CRLF
cQry+= " WHERE CLASSE='2'"+CRLF

TcQuery cQry NEW ALIAS (cTab) 
(cTab)->(dbSelectArea((cTab)))                    
(cTab)->(dbGoTop())                               	
While (cTab)->(!Eof())        		
	cRet+=	TRIM((cTab)->CCUSTO)+","					    	   	   	   
(cTab)->(dbSkip())	
End  
(cTab)->(dbCloseArea()) 
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R01FEC	  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R01FEC(nTipo,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R01SX1  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R01SX1(cPerg,nTipoRel)
LOCAL aArea    	:= GetArea()
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R01ATV  บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
DEFINE MSDIALOG oDlg TITLE "Selecione as Atividades" FROM 0,0 TO 300,800 OF oMainWnd PIXEL  
	...
	oGetD01:oBrowse:blDblClick 	:= {|| C9R01MARK() }
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R01MARK บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R01CAB บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015     บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R01CAB(oReport)
Local cChar	:= chr(160) 
...
Local aCabec 	:= {	""; 
			        ...
			        + "         " + cChar;					
					, "         " + cChar + "                                            DETALHAMENTO DAS CONTRIBUIวีES/DESPESAS POR CENTRO DE RESPONSABILIDADE                   "  ;
		  			+ "         " + cChar; 
