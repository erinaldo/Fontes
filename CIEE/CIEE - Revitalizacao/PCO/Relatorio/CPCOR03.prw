...
#INCLUDE "TOPCONN.CH"  
//---------------------------------------------------------------------------------------
/*/{Protheus.doc} CPCOR03
Relat๓rio acompanhamento or็amentแrio por unidade
@author  	Totvs
@since     	01/01/2015
@version  	P.11.8      
@return   	Nenhum
...
/*/
//---------------------------------------------------------------------------------------
User Function CPCOR03()
LOCAL oReport  	:= NIL 
Local oSection01	:= NIL 
LOCAL cPerg		:= ""
Local aOrdem		:= {"UNIDADE + CONTA"}
...
IF (nTipoRel:= Aviso("Acompanhamento Or็amentแrio por unidade","Informe qual relat๓rio deseja imprimir ?",{"Contแbil","Gerencial"})) > 0
	
	cPerg:= iif(nTipoRel==1,"CPCOR03C","CPCOR03G")  
	C9R03SX1(cPerg,nTipoRel)
	Pergunte(cPerg,.F.)
	
	oReport := TReport():New("CPCOR03","Relat๓rio de acompanhamento or็amentแrio por unidade",cPerg,{|oReport| C9R03IMP(oReport,cTab,aGrpRecFin[nTipoRel],nTipoRel)},"Este relat๓rio irแ imprimir o relat๓rio de acompanhamento or็amentแrio por unidade.")
	oReport:SetTotalInLine(.F.)      
	oReport:SetDynamic()
	oReport:PageTotalBefore(.T.) 
	oReport:bTotalCanPrint:= {|| }
	oReport:SetCustomText( {|| IIF(oReport:NDEVICE==4,{},C9R03CAB(oReport)) } )
	...
	TRCell():New(oSection01, "PERCENT"  	, cTab	, "Percent"			,PESQPICT("AKD","AKD_VALOR1")	, 10	, /*lPixel*/, /*bBlock*/	)	
	...
	TRCell():New(oSection01, "PERCENTAC"	, cTab	, "Percent Acum."		,PESQPICT("AKD","AKD_VALOR1")	, 10	, /*lPixel*/, /*bBlock*/	)
...
ฑฑบPrograma  ณ C9R03IMP	  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R03IMP(oReport,cTab,cGrpRecFin,nTipoRel) 
...
// Monta SQL
cQry:= " WITH ACOORC(CONTA,DESCTA,CUNIDADE,TIPO,ORCADO,REALIZADO,ORCADOAC,REALIZADOAC)"+CRLF
cQry+= " AS("+CRLF
...
cQry+= " 	GROUP BY CT1."+cCampConta+",CT1."+cCampDesc+",AKD1.AKD_ENT05,AKD1.AKD_TIPO"+CRLF
cQry+= " 	UNION ALL"+CRLF
cQry+= " 	SELECT CT1."+cCampConta+" AS CONTA"+CRLF
cQry+= " 		  ,CT1."+cCampDesc+" AS DESCTA"+CRLF
...
cQry+= " 		AND CT1.D_E_L_E_T_=''"+CRLF
cQry+= " 	GROUP BY CT1."+cCampConta+",CT1."+cCampDesc+",AKD2.AKD_ENT05,AKD2.AKD_TIPO"+CRLF
cQry+= " 	UNION ALL"+CRLF
cQry+= " 	SELECT CT1."+cCampConta+" AS CONTA"+CRLF
cQry+= " 		  ,CT1."+cCampDesc+" AS DESCTA"+CRLF
cQry+= " 		  ,AKD1.AKD_ENT05 AS CUNIDADE"+CRLF
...
cQry+= " GROUP BY CONTA,DESCTA,CUNIDADE,CV0_DESC"+CRLF
cQry+= " ORDER BY CUNIDADE ASC,SUBSTRING(CONTA,1,1) DESC,CONTA ASC "+CRLF
	...
	WHILE (cTab)->(!EOF()) .AND. !oReport:Cancel()	 
		...
		IF cUnidade!=(cTab)->CUNIDADE
			...
			IF !EMPTY(cUnidade)
				...
				C9R03FEC(2,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
				oReport:EndPage()
				oReport:StartPage()				
				lRecDesp:= .T.			
			ENDIF
			...
			IF MV_PAR07 != 1  .AND. lRecDesp .and. cContax != LEFT((cTab)->CONTA,1)
				C9R03FEC(1,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
				cContax:= LEFT((cTab)->CONTA,1)
				lRecDesp:= .F.	
			ENDIF	
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R03FEC	  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R03FEC(nTipo,oReport,oSection01,aTotReceita,aTotDespesa,aTotMargDir,aTotReceFin,aTotSupAvit)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R03SX1  บAutor  ณCarlos Hnerique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R03SX1(cPerg,nTipoRel)
LOCAL aArea    	:= GetArea()
...
if nTipoRel == 1                                 
	...
	AADD(aDados,{cPerg,'04','Unidade ?','Unidade ?','Unidade ?','MV_CH4','C',TAMSX3("AKD_ENT05")[1],0,0,'G','','MV_PAR04','','','','','','','','','','','','','','','','','','','','','','','','','CV05','','','','',''} )
...
IF lAtuHelp        
	if nTipoRel == 1 
		...
		AADD(aHelp, {'04',{'Informe a Unidade.'},{''},{''}}) 
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R03ATV  บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
DEFINE MSDIALOG oDlg TITLE "Selecione as Atividades" FROM 0,0 TO 300,800 OF oMainWnd PIXEL  
	...
	oGetD01:oBrowse:blDblClick 	:= {|| C9R03MARK() }
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R03MARK บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ C9R03CAB บAutor  ณCarlos Henrique	  บ Data ณ01/01/2015     บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
...
ÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛÛ
*/
STATIC FUNCTION C9R03CAB(oReport)
Local cChar	:= chr(160) 
...
Local aCabec 	:= {	""; 
			        ...
			        + "         " + cChar;					
					, "         " + cChar + "                                                    DETALHAMENTO DAS CONTRIBUIวีES/DESPESAS POR UNIDADE                                   "  ;					
		  			+ "         " + cChar; 
