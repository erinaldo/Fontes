...
ฑฑบPrograma  ณ CPCOA16  บ Autor ณ TOTVS              บ Data ณ  17/11/11   บฑฑ
...
User Function CPCOA16
	...
	Local aParametros := {	{ 1 ,"Filial"						,Space(LEN(AK1->AK1_FILIAL))		  ,"@!" 	 ,""  ,""		,".F." ,15 ,.F. },;
								...
								{ 1 ,"Conta orcamentแria de"	,Replicate(" ",LEN(AK2->AK2_CO)) 	  ,"@!" 	 ,""  ,"AK5"  ,""    ,65 ,.F. },;
								{ 1 ,"Conta orcamentแria at้"	,Replicate(" ",LEN(AK2->AK2_CO)) 	  ,"@!" 	 ,""  ,"AK5"  ,""    ,65 ,.T. },;
								...
								{ 1 ,"Unidade at้"				,Replicate(" ",LEN(AK2->AK2_ENT05))  ,"@!" 	 ,""  ,"CV0"  ,""    ,65 ,.T. },;	// Inc RNutti 27/02/2015
								{ 2 ,"Apagar itens da planilha"	,1 ,{"1=Nใo apagar itens da planilha","2=Sim. Apagar itens na faixa informada","3=Sim. Apagar TODOS os registros"} ,100, "", .T.},;
...
// Fim Alt RNutti
	...
	If AK1->(FieldPos("AK1_XAPROV"))>0
		If AK1->AK1_XAPROV <> "0"
			MsgStop("A planilha or็amentแria deve estar com a situa็ใo igual a '0 - Em aberto' para que possa importar dados. Verifique!","Aten็ใo")
...
ฑฑบPrograma  ณA   Plan_Box บAutor  ณ TOTVS            บ Data ณ 16/05/05   บฑฑ
...
ฑฑบPrograma  ณ Rest_Par   บAutor  ณ TOTVS             บ Data ณ 16/05/05   บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัอออออออออออออออออออหออออออัออออออออออออปฑฑ
ฑฑบPrograma  ณ Fim_Wiz    บAutor  ณ TOTVS             บ Data ณ 16/05/05   บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯอออออออออออออออออออสออออออฯออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ xProc   บAutor  ณ TOTVS              บ Data ณ  02/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑณFuno    ณ Ctb025Imp    ณ Autor ณ TOTVS             ณ Data ณ 17/09/08 ณฑฑ
...
//cTexto:= " "
	...
	// Valida Chave da Planilha Orcamentaria
		...
		//cTexto += "A chave da planilha or็amentแria: "+Alltrim((cAliasTmp)->AK2_FILIAL+AK2_ORCAME+AK2_VERSAO)+", informada no arquivo CSV, nใo ้ a mesma da planilha posicionada."+CRLF
			AutoGrLog( "A chave da planilha or็amentแria: "+Alltrim((cAliasTmp)->AK2_FILIAL+AK2_ORCAME+AK2_VERSAO)+", informada no arquivo CSV, nใo ้ a mesma da planilha posicionada." )
			lErro := .T.
		Endif
	...
	// Valida Existencia da Conta Orcamentaria
		...
		//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A conta or็amentแria: "+Alltrim((cAliasTmp)->AK2_CO )+" informada no arquivo CSV, nใo existe no sistema."+CRLF
			AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A conta or็amentแria: "+Alltrim((cAliasTmp)->AK2_CO )+" informada no arquivo CSV, nใo existe no sistema." )
			lErro := .T.
		...
		//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A conta or็amentแria: "+Alltrim((cAliasTmp)->AK2_CO )+" nใo ้ analํtica."+CRLF
			AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A conta or็amentแria: "+Alltrim((cAliasTmp)->AK2_CO )+" nใo ้ analํtica." )
			lErro := .T.
		Elseif AK5->AK5_MSBLQL == "1"
			...
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A conta or็amentแria: "+Alltrim((cAliasTmp)->AK2_CO )+" estแ bloqueada para uso."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A conta or็amentแria: "+Alltrim((cAliasTmp)->AK2_CO )+" estแ bloqueada para uso." )
				lErro := .T.
			ENDIF
		Endif
	...
	// Valida Existencia do Centro de Custo
		If !Empty((cAliasTmp)->AK2_CC)
			...
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O C.R.: "+Alltrim((cAliasTmp)->AK2_CC)+" informada no arquivo CSV, nใo existe no sistema."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O C.R.: "+Alltrim((cAliasTmp)->AK2_CC)+" informada no arquivo CSV, nใo existe no sistema." )
				lErro := .T.
			ElseIf CTT->CTT_CLASSE <> "2"
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O C.R.: "+Alltrim((cAliasTmp)->AK2_CC)+" nใo ้ analํtica."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O C.R.: "+Alltrim((cAliasTmp)->AK2_CC)+" nใo ้ analํtica." )
				lErro := .T.
			ElseIf !ValidaBloq((cAliasTmp)->AK2_CC,Date(),"CTT",.f.)
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O C.R.: "+Alltrim((cAliasTmp)->AK2_CC)+" estแ bloqueada para uso."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O C.R.: "+Alltrim((cAliasTmp)->AK2_CC)+" estแ bloqueada para uso." )
				lErro := .T.
			Endif
		Endif
	...
	// Valida Existencia do Item Contabil
		If !Empty((cAliasTmp)->AK2_ITCTB)
			...
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O Setor: "+Alltrim((cAliasTmp)->AK2_ITCTB)+" informado no arquivo CSV, nใo existe no sistema."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O Setor: "+Alltrim((cAliasTmp)->AK2_ITCTB)+" informado no arquivo CSV, nใo existe no sistema." )
				lErro := .T.
			ElseIf CTD->CTD_CLASSE <> "2"
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O Setor: "+Alltrim((cAliasTmp)->AK2_ITCTB)+" nใo ้ analํtico."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O Setor: "+Alltrim((cAliasTmp)->AK2_ITCTB)+" nใo ้ analํtico." )
				lErro := .T.
			Elseif !ValidaBloq((cAliasTmp)->AK2_ITCTB,Date(),"CTD",.f.)
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O Setor: "+Alltrim((cAliasTmp)->AK2_ITCTB)+" estแ bloqueado para uso."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - O Setor: "+Alltrim((cAliasTmp)->AK2_ITCTB)+" estแ bloqueado para uso." )
				lErro := .T.
			Endif
		Endif
	...
	// Valida Existencia da Classe de Valor
		If !Empty((cAliasTmp)->AK2_CLVLR)
			...
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Atividade: "+Alltrim((cAliasTmp)->AK2_CLVLR)+", informada no arquivo CSV, nใo existe no sistema."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Atividade: "+Alltrim((cAliasTmp)->AK2_CLVLR)+", informada no arquivo CSV, nใo existe no sistema." )
				lErro := .T.
			ElseIf CTH->CTH_CLASSE <> "2"
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Atividade: "+Alltrim((cAliasTmp)->AK2_CLVLR)+", nใo ้ analํtica."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Atividade: "+Alltrim((cAliasTmp)->AK2_CLVLR)+", nใo ้ analํtica." )
				lErro := .T.
			ElseIf !ValidaBloq((cAliasTmp)->AK2_CLVLR,Date(),"CTH",.f.)
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Atividade: "+Alltrim((cAliasTmp)->AK2_CLVLR)+", estแ bloqueada para uso."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Atividade: "+Alltrim((cAliasTmp)->AK2_CLVLR)+", estแ bloqueada para uso." )
				lErro := .T.
			Endif
		Endif
	...
	// Valida Existencia do Setor (Entidade 05)
		If !Empty((cAliasTmp)->AK2_ENT05)
			...
			If !dbSeek(xFilial("CV0")+"05"+(cAliasTmp)->AK2_ENT05)			// Fixo "05" porque no CV0 a Entidade 05 ้ o Plano 05
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Unidade: "+Alltrim((cAliasTmp)->AK2_ENT05)+", informada no arquivo CSV, nใo existe no sistema."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Unidade: "+Alltrim((cAliasTmp)->AK2_ENT05)+", informada no arquivo CSV, nใo existe no sistema." )
				lErro := .T.
			ElseIf CV0->CV0_CLASSE <> "2"
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Unidade: "+Alltrim((cAliasTmp)->AK2_ENT05)+", nใo ้ analํtica."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Unidade: "+Alltrim((cAliasTmp)->AK2_ENT05)+", nใo ้ analํtica." )
				lErro := .T.
			ElseIf !ValidaBloq((cAliasTmp)->AK2_ENT05,Date(),"CV0",.f.)
			//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Unidade: "+Alltrim((cAliasTmp)->AK2_ENT05)+", estแ bloqueada para uso."+CRLF
				AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A Unidade: "+Alltrim((cAliasTmp)->AK2_ENT05)+", estแ bloqueada para uso." )
				lErro := .T.
			Endif
		Endif
	// Fim Inc RNutti
	...
	// Valida Existencia da Classe Orcamentaria
		...
		//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A classe or็แmentแria: "+Alltrim((cAliasTmp)->AK2_CLASSE)+", informada no arquivo CSV, nใo existe no sistema."+CRLF
			AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A classe or็แmentแria: "+Alltrim((cAliasTmp)->AK2_CLASSE)+", informada no arquivo CSV, nใo existe no sistema." )
			lErro := .T.
		Endif
	
	// Valida Existencia da Opera็ใo Or็amentaria
	//	If !Empty((cAliasTmp)->AK2_OPER)
		dbSelectArea("AKF")
		dbSetOrder(1)
		If !dbSeek(xFilial("AKF")+(cAliasTmp)->AK2_OPER)
		//cTexto += "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A opera็ใo or็amentแria: "+Alltrim((cAliasTmp)->AK2_OPER)+", informada no arquivo CSV, nใo existe no sistema."+CRLF
			AutoGrLog( "Linha " + Alltrim((cAliasTmp)->LINHA)+ " - A opera็ใo or็amentแria: "+Alltrim((cAliasTmp)->AK2_OPER)+", informada no arquivo CSV, nใo existe no sistema." )
			lErro := .T.
		Endif
	//	Endif
/*
...
*/
	...
	//MsgStop("Ocorreram erros na valida็ใo do arquivo CSV. O processo foi abortado!"+CRLF+"Por favor, verifique o arquivo "+Alltrim(cFile)+" gerado no mesmo diret๓rio do arquivo importado para mais detalhes.","Aten็ใo")
		...
		Define MsDialog oDlg Title "Importa็ใo de Planilha" From 3, 0 to 340, 417 Pixel
	...
	//	If MV_PAR12 == "1"
			...
			//			IF Aviso("Os itens existentes na Planilha Or็amentแria serใo MANTIDOS conforme parโmetro selecionado.",{"Continuar","Abortar"},1) <> 1
			...
			//Apaga os Dados
		//	Alt RNutti 27/02/2015	
		//	MsgRun('Excluindo lan็amentos. Aguarde...',, {|| xDelOrcTrh(MV_PAR12) } )
				MsgRun('Excluindo lan็amentos. Aguarde...',, {|| xDelOrcTrh(MV_PAR14) } )		// Fim Alt RNutti 27/02/2015
			Endif
		...
		// Processa Importacao
			...
			//ณLocaliza qual e o maior ID para a Conta Orcamentariaณ
	...
	//cTexto += "Importa็ใo realizada com sucesso!"+CRLF
		AutoGrLog( "Importa็ใo realizada com sucesso!" )
	Endif
...
//U_GRAVATXT(cFile,cTexto)
	...
	//Aviso("Importa็ใo de Planilha","A importa็ใo foi concluํda com ๊xito!"+CRLF+CRLF+"Por favor, verifique o arquivo "+Alltrim(cFile)+" gerado no mesmo diret๓rio do arquivo importado para mais detalhes."+CRLF+CRLF+"ษ necessแrio fechar a planilha or็amentแria e abri-la novamente para visualizar os dados importados.",{"OK"},2)
		Aviso("Importa็ใo de Planilha","A importa็ใo foi concluํda com ๊xito!"+CRLF+CRLF+"ษ necessแrio fechar a planilha or็amentแria e abri-la novamente para visualizar os dados importados.",{"OK"},2)
	Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณxDelOrcTrhบ Autor ณ TOTVS              บ Data ณ  22/08/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//ณQuery para obter recnos da tabela AK2 ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณxDelOrc	บ Autor ณ Claudinei Ferreira บ Data ณ  22/08/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Deleta dados da Pl. Orcamentaria antes da importacao do csvบฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ  xGeraOrcบ Autor ณ TOTVS              บ Data ณ  27/11/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Deleta dados da Pl. Orcamentaria antes da importacao do csvบฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑบPrograma  ณ xIncConta บAutor ณ TOTVS               บ Data ณ 21/11/11   บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณxPcoA122  บAutor  ณ TOTVS              บ Data ณ  02/09/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณSI16IMPLANบAutor  ณ TOTVS              บ Data ณ  02/09/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑบPrograma  ณAux_Det_Lan บAutor  ณ TOTVS            บ Data ณ  06/14/13   บฑฑ
