...
User Function IMP_CXC() //CONTATO X CATEGORIA
...
FT_FUSE("C:\Ap8\Protheus_Data\CSV\Contatos X Categorias.txt")
FT_FGOTOP()
...
While !FT_FEOF()
	...
	RecLock("SZY",.T.)
	SZY->ZY_FILIAL  := "01"
	SZY->ZY_COD     := _cCateg      //Codigo da Categoria
	SZY->ZY_DESC    := _cDesc
	SZY->ZY_CODCONT := _cCodigo
	SZY->ZY_ID      := _cID
	MSUnLock()
