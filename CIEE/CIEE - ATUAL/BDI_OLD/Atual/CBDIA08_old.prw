...
EndIf
cQuery  += "ZS_CODCONT ,"
cQuery  += "ENDERECO, ZS_BAIRRO, ZS_MUN, ZS_EST, ZS_CEP,"
cQuery  += "UM_TRTCARG, "
...
Else
	cQuery  += "'', "
EndIf
cQuery  += "ISNULL(ZS_BAIRRO,''), "
cQuery  += "ISNULL(ZS_MUN,''), "
cQuery  += "ISNULL(ZS_EST,''), "
cQuery  += "ISNULL(Substring(ZS_CEP,1,5)+'-'+Substring(ZS_CEP,6,3),''), "
cQuery  += "ISNULL(GRUPO,''), "
