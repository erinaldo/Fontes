...
oget2   := MsNewGetDados():New(41,2,160,372,nGetd,"u_fLinOk()","u_fTudOk()","+AC8_ITEM",aCampos,/*freeze*/,999,/*fieldok*/,/*superdel*/,/*delok*/,oDlg2,aheader2,acols2)

// Esta chamada traz a tela de Contatos X Entidade
@ 175, 250 BUTTON "Entidade"   ACTION u_CBDIA03Alt() SIZE 40,15 PIXEL OF oDlg2

ACTIVATE MSDIALOG oDlg2 ON INIT EnchoiceBar(oDlg2,{||nOpcA:=1,Iif(u_fTudOk(),oDlg2:End(),nOpcA:=0)},{|| Iif(u_fCanc(),oDlg2:End(),nOpcA:=0)})
...
@ 23, 026 MSGET cCodigo2 When .F. SIZE 30,7 PIXEL OF oDlg
@ 23, 080 MSGET cNome2   When .F. SIZE 90,7 PIXEL OF oDlg
...
If _fPrograma == "U_CBDIA07J"
	...
	oGet3 := MsNewGetDados():New(41,2,160,372,,,,,aCampos,/*freeze*/,,/*fieldok*/,/*superdel*/,/*delok*/,oDlg,aheader3,acols3)

//	If Len(aCols)>0
		@ 175, 200 BUTTON "Enderecos" ACTION u_CBDIA07k() SIZE 40,15 PIXEL OF oDlg
		@ 175, 250 BUTTON "Perfil"    ACTION u_CBDIA03Man() SIZE 40,15 PIXEL OF oDlg
//	EndIf
...
Else
	...
	oGet3 := MsNewGetDados():New(41,2,160,372,nGetd,"u_Mod2LinOk()","u_Mod2TudOK()","+ZQ_ITEM",aCampos,/*freeze*/,,/*fieldok*/,/*superdel*/,/*delok*/,oDlg,aheader3,acols3)
...
//	EndIf
	...
	ACTIVATE MSDIALOG oDlg ON INIT EnchoiceBar(oDlg,{|| Iif(u_Mod2TudOk(),oDlg:End(),nOpcA:=0)},{|| Iif(u_Mod2Canc(),oDlg:End(),nOpcA:=0)})
...
While !EOF() .And. SZT->ZT_FILIAL + SZT->ZT_CODCONT + SZT->ZT_CODENT == xFilial("SZT") + cCodigo1 + _cEntid
	...
	AADD(aCols4,{SZT->ZT_ITEM, SZT->ZT_CODEND, SZT->ZT_END, ZT_ENDPAD, .F.})
