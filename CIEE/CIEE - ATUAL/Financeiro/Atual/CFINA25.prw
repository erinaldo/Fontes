...
Aadd( aCores, { "Alltrim(E5_SITUACA) <> 'C' .And. Empty(E5_NATREC) .And. (ALLTRIM(E5_NATUREZ) = '6.08.01' .Or. ALLTRIM(E5_NATUREZ) = '33080101')"	, "BR_AMARELO" 	})
...
Aadd( aCores, { "Alltrim(E5_SITUACA) <> 'C' .And. (ALLTRIM(E5_NATUREZ) = '6.08.01' .Or. ALLTRIM(E5_NATUREZ) <> '33080101')"						, "BR_VERMELHO"	})
...
cCond      :=	"E5_MOEDA=='NI' .and. Alltrim(E5_SITUACA) <> 'C' .and. (ALLTRIM(E5_NATUREZ) = '6.08.01' .Or. AllTrim(SE5->E5_NATUREZ) == '33080101') .and. "+;
...
//	If AllTrim(SE5->E5_NATUREZ) == "6.08.01"
	If AllTrim(SE5->E5_NATUREZ) == "6.08.01" .Or. AllTrim(SE5->E5_NATUREZ) == "33080101"
/* alteracao dia 21 e 22/03/07 pelo analista Emerson
...
*/
		...
		If _lRetAlt == 1 // Alteracao confirmada
			If CFINA25_CTB() // Cria a Contabilizacao do registro alterado
				If AllTrim(SE5->E5_NATREC) == cNat888		//"8.88.88"
					u_CFINA25_1(aCols)
				EndIf
