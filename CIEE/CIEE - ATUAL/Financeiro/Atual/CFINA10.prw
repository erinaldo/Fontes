...
*/
Aadd( aCores, { "ALLTRIM(E2_NATUREZ) == '"+cNat999+"' "  											, "BR_VERDE"  	} )
Aadd( aCores, { "ALLTRIM(E2_NATUREZ) <> '"+cNat999+"' .AND. EMPTY(E2_BANCO) .and. EMPTY(E2_LD) .and. EMPTY(E2_NUMAP) .AND. alltrim(E2_TIPO) <> 'FL'"		, "BR_AMARELO"	} )
Aadd( aCores, { "ALLTRIM(E2_NATUREZ) <> '"+cNat999+"' .AND. EMPTY(E2_BCOBOR) .and. EMPTY(E2_NUMAP) .AND. alltrim(E2_TIPO) <> 'FL'"						, "BR_AZUL"		} )
Aadd( aCores, { "ALLTRIM(E2_NATUREZ) <> '"+cNat999+"' .AND. ((alltrim(E2_TIPO) == 'FL') .OR. (!EMPTY(E2_BANCO) .OR. !EMPTY(E2_BCOBOR)) .OR. !EMPTY(E2_LD).OR. !EMPTY(E2_NUMAP)) "	, "BR_VERMELHO"			} )
...
//If Substr(Alltrim(M->E2_NATUREZ),1,4) $ "0401|0402" // "6.10|6.11" 
If (cEmpAnt=="01" .And. Substr(Alltrim(M->E2_NATUREZ),1,4) $ "0401|0402") .Or. (cEmpAnt<>"01" .And. Substr(Alltrim(M->E2_NATUREZ),1,4) $ "6.10|6.11")
