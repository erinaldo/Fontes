...
Do While SE5TMP->(!EOF())
	...
	/*	aVetor :={	{"E2_PREFIXO"	,SE5TMP->E5_PREFIXO	,Nil},;
	{"E2_NUM"	 	,SE5TMP->E5_NUMERO 	,Nil},;
	{"E2_PARCELA"	,SE5TMP->E5_PARCELA	,Nil},;
	{"E2_TIPO"		,SE5TMP->E5_TIPO 	,Nil},;
	{"E2_FORNECE"	,SE5TMP->E5_CLIFOR	,Nil},;
	{"E2_LOJA"  	,SE5TMP->E5_LOJA	,Nil},;
	{"AUTMOTBX" 	,SE5TMP->E5_MOTBX  	,Nil},;		//MOTIVO BAIXA
	{"AUTBANCO"		,SE5TMP->E5_BANCO  	,Nil},;     //BANCO
	{"AUTAGENCIA"	,SE5TMP->E5_AGENCIA	,Nil},;     //AGENCIA
	{"AUTCONTA" 	,SE5TMP->E5_CONTA	,Nil},;     //CONTA
	{"AUTDTBAIXA"	,SE5TMP->E5_DATA	,Nil},;     //DATA BAIXA
	{"AUTDTDEB"		,SE5TMP->E5_DATA	,Nil},;     //DATA DO DEBITO
	{"AUTHIST"		,SE5TMP->E5_HISTOR	,Nil},;     //HISTORICO
	{"AUTVLRPG"		,SE5TMP->E5_VALOR 	,Nil}}
	
	MSExecAuto({|x,y,z,w| Fina080(x,y,z,w)},aVetor,5,.F.,Iif(_nPos>0,_nPos,)) //Cancelamento da Baixa do Titulo
	
	If lMsErroAuto
	MsgAlert("Cancelamento da Baixa do tํtulo nใo foi executada, veja o LOG de erro","Aten็ใo")
	Mostraerro()
	Return()
	EndIf
	*/
