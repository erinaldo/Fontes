...
±±≥FunáÑo	 ≥ CFINR011 ≥ Autor ≥ Andy Pudja   		    ≥ Data ≥ 20.10.92 ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥DescriáÑo ≥ Relatorio de Fluxo de Caixa                      		  ≥±±
...
aAdd(_aPerg,{cPerg,"07","Gera Exportac„o    ?","","","mv_ch7","N",01,0,0,"C","","mv_par07","Sim","","","","","Nao","","","","","","","","","","","","","","","","","","","","",""})
...
//⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø
//≥ Envia controle para a funáÑo SETPRINT 						 ≥
//¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒø±±
±±≥FunáÑo	 ≥ FluxoCIEE ≥ Autor ≥ Andy Pudja           ≥ Data ≥ 20.10.92 ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥DescriáÑo ≥ Fluxo de Caixa                                             ≥±±
±±√ƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¥±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
//⁄ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø
//≥ DefiniáÑo da Exportacao                 				     ≥
//¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ
If mv_par07==1
	_cArq := AllTrim(MV_PAR08)+"FL"+SUBSTR(DTOS(dDataBase),3,6)+".flx"
	_lFez := .T.
	If (_nArq := fCreate(_cArq)) == -1
		_cMsg := "N„o foi possÌvel criar o Arquivo de ExportaÁ„o " + _cArq + "."
		MsgAlert(_cMsg, "AtenÁ„o!")
		_lFez := .F.
		Return
	EndIf
EndIf
...
ElseIf mv_par01==3
	If mv_par06==1
		Tit := OemToAnsi("Analitico de ")+DTOC(mv_par02) + " a " +Dtoc(mv_par03)+" por Data e CompetÍncia"  // por Data e Beneficiario
	Else
		Tit := OemToAnsi("Sintetico de ")+DTOC(mv_par02) + " a " +Dtoc(mv_par03)+" por Data e CompetÍncia"  // por Data e Beneficiario
	EndIf
ElseIf mv_par01==4
	If mv_par06==1
...
ElseIf mv_par01==3
	IndRegua("TMP", _cArqTrab, "E5_XCOMPET+DTOS(E5_DTDISPO)+E5_BANCO+E5_NUMCHEQ+E5_DOCUMEN+E5_RECPAG+E5_NATUREZ+STR(E5_VALOR,17,2)",,, "Criando indice...", .T.)
ElseIf mv_par01==4
...
// MANUAL lancamentos do SE5 para TR-Tarifa, TB-Transferencia, BA-Pgto Bolsa Auxilio por Carta, FL-Ficha LanÁamento, AP- AplicaÁ„o
// Contas de Consumo
// Prestacao de Contas
// CNI
...
// Este relatorio trata as Contas de Consumo atravÈs dos registros SE5 do tipo "CC "
...
// Os creditos do CNI tb s„o lanÁados automaticamente no Extrato Bancario, no entanto para o Fluxo
...
If mv_par10 == 1
	...
	*/
	...
	ElseIf mv_par11 == 2
		...
		cQuery += "       (E5_TIPODOC IN ('BA')      AND E5_TIPO IN ('FL ')                                   AND E5_RECONC <>  ' ' AND E5_FLUXO  =  ' ' ) )"
	ElseIf mv_par11 == 3
		//		cQuery += " AND ( (E5_TIPODOC IN ('  ')      AND E5_MOEDA IN ('TB','BA','AP','CD','ES','GE','DD','RG','RS','DE','BC') AND (E5_RECONC <> ' ' OR (E5_RECONC =  ' '  AND E5_FLUXO  <> ' ' )) ) OR "
		cQuery += " AND ( (E5_TIPODOC IN ('  ')      AND E5_MOEDA IN ('TB','BA','AP','CD','ES','GE','DD','RG','RS','DE','BC','NI') AND (E5_RECONC <> ' ' OR (E5_RECONC =  ' '  AND E5_FLUXO  <> ' ' )) ) OR "
		...
		While !Eof()
			For _nI:=1 to Len(_aRank)
				If DTOS(_aRank[_nI,1]) <= DTOS(TMP->E5_DTDISPO) .And. DTOS(TMP->E5_DTDISPO) <= DTOS(_aRank[_nI,2])
					...
					TMP->E5_SEMANA := " - Semana de "+DTOC(_aRank[_nI,1])+" atÈ "+DTOC(_aRank[_nI,2])
					msUnLock()
				EndIf
			Next _nI
			dbSelectArea("TMP")
...
While !Eof()
	...
	While !Eof() .And. _cE5_ORDEM == E5_ORDEM
		...
		While &(cCondWhile)
			...
			If mv_par06 == 1
				If E5_MOEDA $ "RC"
					@li,112 PSAY  AllTrim(U_DePaNat2013(E5_NATREC)) + " " + E5_FLUXO
				Else
					@li,112 PSAY  AllTrim(U_DePaNat2013(E5_NATUREZ)) + " " + E5_FLUXO
				EndIf
			...
			*/
			...
			If mv_par07 == 1 .And. mv_par06 == 1 .And. mv_par10 == 1 .And. mv_par11 == 2 // Gerar o arquivo somente para opÁ„o AnalÌtico, Conciliados e Realizados
...
*/
AAdd(_aPerg,{cPerg,"01","Agrupamento        ?","","","mv_ch1","N",01,0,0,"C","","mv_par01","Data","","","","","Natureza","","","","","Competencia","","","","","Documento","","","","","Conta Corrente","","","","","",""}) // chamado n. 22008 alterado por CG em 19/01/07
aAdd(_aPerg,{cPerg,"02","Da  Data           ?","","","mv_ch2","D",08,0,0,"G","","mv_par02",""    ,"","","","",""        ,"","","","",""           ,"","","","",""         ,"","","","",""              ,"","","","","",""})
aAdd(_aPerg,{cPerg,"03","Ate Data           ?","","","mv_ch3","D",08,0,0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
aAdd(_aPerg,{cPerg,"04","Da  Natureza       ?","","","mv_ch4","C",15,0,0,"G","","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
aAdd(_aPerg,{cPerg,"05","Ate Natureza       ?","","","mv_ch5","C",15,0,0,"G","","mv_par05","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
...
aAdd(_aPerg,{cPerg,"13","Competencia De     ?","","","mv_chd","C",07,0,0,"G","","mv_par13","","","","","","","","","","","","","","","","","","","","","","","","","","","","","@E 99/9999"})
aAdd(_aPerg,{cPerg,"14","Competencia Ate    ?","","","mv_che","C",07,0,0,"G","","mv_par14","","","","","","","","","","","","","","","","","","","","","","","","","","","","","@E 99/9999"})
...
User Function DePaNat2013(cNat2013)
