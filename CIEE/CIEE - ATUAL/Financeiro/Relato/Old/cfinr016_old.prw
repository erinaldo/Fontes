...
aAdd(aRegs,{cPerg,"03","Da  Natureza       ?","","","mv_ch3","C",15,0,0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","","SED","",""})
aAdd(aRegs,{cPerg,"04","Ate Natureza       ?","","","mv_ch4","C",15,0,0,"G","","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","","SED","",""})
...
Do Case
	Case cEmpant == '01'
		Titulo := "Relatorio Natureza(s) Financeira(s)  -  CIEE / SP"
	Case cEmpant == '03'
		Titulo := "Relatorio Natureza(s) Financeira(s)  -  CIEE / RJ"
	Case cEmpant == '05'
		Titulo := "Relatorio Natureza(s) Financeira(s)  -  CIEE / NACIONAL"
EndCase
...
Cabec1 := OemToAnsi("DATA        BENEFICIARIO                   DOCUMENTO         CONTA CORRENTE          ENTRADAS          SAIDAS     ORIGEM    NATUREZA")
Cabec2 := OemToAnsi("")
...
While !Eof()
	...
	ElseIf SE5->E5_MOEDA $ "ES"
		...
		TMP->E5_DOCUMEN  := SE5->E5_DOCUMEN
		TMP->E5_RECONC   := SE5->E5_RECONC
	ElseIf SE5->E5_MOEDA $ "FL;AP;CD;GE;DD;RG;CC;PC;CI;NI;RC"
	...
	While !Eof() .And. _cE5_NATUREZ == E5_NATUREZ
		...
		While &(cCondWhile)
			...
			If !EMPTY(E5_DOCUMEN)
							...
							Else
								...
								Else
									Do Case //alteracao 23/03 emerson
										Case E5_MOEDA $ "CC"
											@li,043 PSAY "DM "+AllTrim(E5_DOCUMEN)
											cDoc := "DM "+AllTrim(E5_DOCUMEN)
											@li,065 PSAY +AllTrim(E5_CONTA)
										Case E5_MOEDA $ "RC"
											@li,043 PSAY "RC "+AllTrim(E5_DOCUMEN)
				...
				Else
					If Left(E5_DOCUMEN,2)=="PC"
						@li,043 PSAY "BD"+Subs(E5_DOCUMEN,3,10)
			...
			If mv_par05 == 1
				@li,114 PSAY E5_NATUREZ
				@li,125 PSAY E5_NATREC
			ElseIf mv_par05 == 2
				@li,114 PSAY E5_NATUREZ
			ElseIf mv_par05 == 3
				If !Empty(E5_NATREC)
