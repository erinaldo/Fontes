...
ฑฑบPrograma  ณ CFINR014 บ Autor ณ AP6 IDE            บ Data ณ  08/03/04   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Relatorio de Consulta de Pagamento SE2                     บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
Private CONTFL       := 01
Private m_pag        := 01
Private wnrel        := "FINR14" // Coloque aqui o nome do arquivo usado para impressao em disco
...
Private _aAliases    := {}
Private _aMatriz     := {}
Private cabec1       :="Titulo      Emissao   Fornecedor                Valor Tit       Valor Liq  Bordero   AP        Cheque    FL        Conta     Natureza  Vencto.   Baixa     Concilacao  Historico"
Private cabec2       :=""
...
While !Eof()
	...
	While &(cCondWhile)
		...
		@ nLin, 043 PSay  SE2TMP->E2_VALOR   Picture "@E 999,999,999.99"
		@ nLin, 059 PSay  SE2TMP->E2_VALLIQ  Picture "@E 999,999,999.99"		
		@ nLin, 075 PSay  SE2TMP->E2_NUMBOR
		@ nLin, 085 PSay  SE2TMP->E2_NUMAP        
		@ nLin, 095 PSay  _cCheque                
        @ nLin, 105 PSay  _cFL                    
		@ nLin, 115 PSay  _cConta                 
		@ nLin, 125 PSay  SE2TMP->E2_NATUREZ      
		@ nLin, 135 PSay  SE2TMP->E2_VENCREA      
		@ nLin, 145 PSay  SE2TMP->E2_BAIXA        
		@ nLin, 155 PSay  _dConc                  
//		@ nLin, 165 PSay  AllTrim(_cUsuario1)
		@ nLin, 167 PSay  SE2TMP->E2_HIST         
	...
	If nLin > 55
		...
		nLin := 8
	Endif
	@ nLin, 043 PSay Replicate("-", 14)
	@ nLin, 059 PSay Replicate("-", 14)
	nLin++
	@ nLin, 000 PSay  "SubTotal"
	@ nLin, 043 PSay  _nSubTotTit  Picture "@E 999,999,999.99"
	@ nLin, 059 PSay  _nSubTotLiq  Picture "@E 999,999,999.99"
	_nSubTotTit := 0
	_nSubTotLiq := 0
	nLin ++
	nLin ++
...
nLin++
@ nLin, 000 PSay  "Total"
@ nLin, 043 PSay  _nTotalTit  Picture "@E 999,999,999.99"
@ nLin, 059 PSay  _nTotalLiq  Picture "@E 999,999,999.99"
...
@ nLin, 043 PSay  _nTotalReg  Picture "@E 999,999,999"
