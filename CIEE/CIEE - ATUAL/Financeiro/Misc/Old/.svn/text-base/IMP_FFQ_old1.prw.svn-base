...
Do Case
	...
	*/
	...
	If cEmpant == '01' //SP
		cDirect    := "\arq_txt\contabilidade\SP\FFQ\" 
		cDirectImp := "\arq_txt\contabilidade\SP\FFQ\Importado\"
	ElseIf cEmpant == '03' //RJ
		cDirect    := "\arq_txt\contabilidade\RJ\FFQ\"
		cDirectImp := "\arq_txt\contabilidade\RJ\FFQ\Importado\"
	EndIf
