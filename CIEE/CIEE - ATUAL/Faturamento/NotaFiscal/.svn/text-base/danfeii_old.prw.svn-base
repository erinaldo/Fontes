...
//alterado pelo analista Emerson Natali. variavel MAXITEMC passamos para 045 conforme solicitado. ESPECIFICO CIEE
...
Next nX                        
*///-----------------------------
//------  Incluído em 02/04/2013
If SM0->M0_CODIGO=="01"		// CIEE SP
	oDanfe:Say(nLinCalc,098,Left(cStrAux,At("EMPR",cStrAux)-1), oFont12N:oFont )
	nLinCalc+=10
	oDanfe:Say(nLinCalc,098,SubStr(cStrAux,At("EMPR",cStrAux)), oFont12N:oFont )
	nLinCalc+=10
Else
	oDanfe:Say(nLinCalc,098,Left(cStrAux,At("ESC",cStrAux)-1), oFont12N:oFont )
	nLinCalc+=10
	oDanfe:Say(nLinCalc,098,SubStr(cStrAux,At("ESC",cStrAux)), oFont12N:oFont )
	nLinCalc+=10
EndIf
//-------------------------------
