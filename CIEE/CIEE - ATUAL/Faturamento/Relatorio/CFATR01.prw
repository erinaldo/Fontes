...
cQuery := "SELECT DISTINCT D2_DOC, D2_SERIE, D2_EMISSAO, D2_TOTAL, D2_ITEM, C5_PESOL, C5_VOLUME1 "
...
TCSetField('TRAB', "D2_EMISSAO"	, "D", 8, 0 )
TCSetField('TRAB', "C5_PESOL"  	, "N", TamSX3("C5_PESOL")[1]  , TamSX3("C5_PESOL")[2]   )
TCSetField('TRAB', "C5_VOLUME1" , "N", TamSX3("C5_VOLUME1")[1], TamSX3("C5_VOLUME1")[2] )
TCSetField('TRAB', "D2_TOTAL"   , "N", TamSX3("D2_TOTAL")[1]  , TamSX3("D2_TOTAL")[2]   )
...
While TRAB->(!Eof())
	...
	cChave := TRAB->D2_DOC+C5_XCR
	aAdd(aNFCR, { TRAB->D2_EMISSAO, TRAB->C5_XCR, TRAB->CTT_DESC01, TRAB->D2_DOC, TRAB->C5_VOLUME1, TRAB->C5_PESOL, 0, cDepto } )
	_nI := Len(aNFCR)
	
	While TRAB->(!Eof()) .And. TRAB->(D2_DOC+C5_XCR)==cChave
		aNFCR[_nI][7] += TRAB->D2_TOTAL
		TRAB->(dbSkip())
	End

End
		
For _nI:=1 to Len(aNFCR)	
	...
	@li , 000 Psay aNFCR[_nI][1]
	@li , 013 Psay aNFCR[_nI][2]
	@li , 024 Psay aNFCR[_nI][3]
	@li , 066 Psay aNFCR[_nI][4]
	@li , 077 Psay aNFCR[_nI][5] Picture "@E 999,999,999"
	@li , 090 Psay aNFCR[_nI][6] Picture "@E 9999,999.99"
	@li , 103 Psay aNFCR[_nI][7] Picture "@E 9999,999,999.99"
	@li , 120 Psay aNFCR[_nI][8]
	
	cPlan += '  <TR style="HEIGHT: 15.75pt" height=21>'
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl68>"+RetCpo(aNFCR[_nI][1])+"</td>"
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl68>"+RetCpo(aNFCR[_nI][2])+"</td>"
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl68>"+aNFCR[_nI][3]+"</td>"
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl68>"+RetCpo(aNFCR[_nI][4])+"</td>"
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl68>"+TransForm(aNFCR[_nI][5],"@E 999,999,999")+"</td>"
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl69>"+TransForm(aNFCR[_nI][6] ,"@E 9999,999.99")+"</td>"
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl69>"+TransForm(aNFCR[_nI][7],"@E 9999,999,999.99")+"</td>"
	cPlan += "<TD style='BORDER-LEFT: medium none; BORDER-TOP: medium none' class=xl69>"+aNFCR[_nI][8]+"</td>"
	cPlan += '  </TR>'
