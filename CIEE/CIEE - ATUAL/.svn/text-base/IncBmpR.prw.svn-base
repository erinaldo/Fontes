...
ฑฑบPrograma  ณNOVO3     บAutor  ณMicrosiga           บ Data ณ  07/21/10   บฑฑ
...
@ 90, 9 to 475,724 Dialog oDlg Title OemToAnsi("Exemplo de Inclusใo de Bitmaps de forma automแtica no Reposit๓rio")
...
//@ 124, 251 Button OemToAnsi("_Selecionar diret๓rio dos Arquivos") Size 79,16 Action SelArq( @aItens )
