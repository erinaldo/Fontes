...
//_cChave := SUBS(CT2->CT2_KEY,3,8)+SUBS(CT2->CT2_KEY,20,6)+SUBS(CT2->CT2_KEY,26,2)+SUBS(CT2->CT2_KEY,17,3)+SUBS(CT2->CT2_KEY,11,6)
        _cChave := SUBS(CT2->CT2_KEY,3,3)+SUBS(CT2->CT2_KEY,6,6)+SUBS(CT2->CT2_KEY,12,6)+SUBS(CT2->CT2_KEY,18,2) 
        
       // SUBS(CT2->CT2_KEY,3,3)  = Serie
       // SUBS(CT2->CT2_KEY,6,6)  = Numero
       // SUBS(CT2->CT2_KEY,12,6) = Fornecedor
       // SUBS(CT2->CT2_KEY,18,2) = Loja
