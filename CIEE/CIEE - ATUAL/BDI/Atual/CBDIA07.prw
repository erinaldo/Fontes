...
If nCont >0
	While !EOF()
		...
		AADD( aCOLS,{TMP->U5_CODCONT, TMP->U5_CONTAT, TMP->U5_DGRUPO, TMP->U5_DESC, TMP->U5_DNIVEL, TMP->U5_EMAIL, TMP->U5_ATIVO, .F.})
		dbSelectArea("TMP")
		dbSkip()
	End
Else
...
@ 270, 150 BUTTON "Categoria"		ACTION u_CBDIA07L() SIZE 40,15 PIXEL OF oDlg	// Rotina de Inclusao da Categoria da Pessoa Fisica
@ 270, 200 BUTTON "Enderecos"		ACTION u_CBDIA07a() SIZE 40,15 PIXEL OF oDlg	// Rotina de Inclusao de Endereco
@ 270, 250 BUTTON "Contato BDI"		ACTION u_CBDIA07c() SIZE 40,15 PIXEL OF oDlg	// Esta chamada traz a tela de Contatos X Contatos BDI
@ 270, 300 BUTTON "Novo Contato"	ACTION u_CBDIA07d() SIZE 40,15 PIXEL OF oDlg	// Rotina de Inclusao de Contato
...
_nPos4  := ascan( aHeader, { |x| x[2] = "U5_ATIVO"})	// CONTATO ATIVO
cAtivo  := aCols[n,_nPos4]

If cAtivo == "2"
	msgbox("Registo esta   I N A T I V O  ! ! !")
EndIf
...
If cAtivo == "2"
	oget2   := MsNewGetDados():New(41,2,160,372,,"u_CatLinOK","u_CatTudOK","+ZY_ITEM",aCampos,/*freeze*/,999,/*fieldok*/,/*superdel*/,/*delok*/,oDlg2,aheader2,acols2)
Else
	nGetd   := GD_INSERT+GD_UPDATE+GD_DELETE
	oget2   := MsNewGetDados():New(41,2,160,372,nGetd,"u_CatLinOK","u_CatTudOK","+ZY_ITEM",aCampos,/*freeze*/,999,"u_CatField"/*fieldok*/,/*superdel*/,/*delok*/,oDlg2,aheader2,acols2)
EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCatField  บAutor  ณMicrosiga           บ Data ณ  05/09/07   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณValida a Categoria digitada para verificar se esta ATIVA    บฑฑ
ฑฑบ          ณou INATIVA                                                  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
User Function CatField()

_lRet := .T.

DbSelectArea("SZW")
DbSetOrder(1)
If DbSeek(xFilial("SZW")+M->ZY_COD)
	If SZW->ZW_ATIVO == "2"
		msgbox("Registo esta   I N A T I V O  ! ! !")
		_lRet := .F.
	EndIf
...
Do Case
	Case _fPrg == "U_CBDIA07E" // Contato
		...
		_nPos3  := ascan( aHeader, { |x| x[2] = "U5_CONTAT"})		// NOME DO CONTATOS
		cNome   := aCols[n,_nPos3]
		_nPos4  := ascan( aHeader, { |x| x[2] = "U5_ATIVO"})		// CONTATOS ATIVO
		cAtivo  := aCols[n,_nPos4]
		_cTipo  := "F"
		_cCampo := "ZS_CODCONT"
	Case _fPrg == "U_CBDIA07F" // Entidade
		...
		cNome   := aCols[n,_nPos3]
		_nPos4  := ascan( aHeader, { |x| x[2] = "ZM_ATIVO"})		// ENTIDADE ATIVA
		cAtivo  := aCols[n,_nPos4]
		_cTipo  := "J"
		_cCampo := "ZS_CODENT"
	Case _fPrg == "U_CBDIA07I" // Contatos BDI
		...
		_nPos4  := ascan( aHeader2, { |x| x[2] = "U5_ATIVO"})		// CONTATO ATIVO
		cAtivo  := aCols2[n,_nPos4]
		_cTipo  := "F"
		_cCampo := "ZS_CODCONT"
EndCase
...
dbSeek( xFilial("SZS") + _cTipo + cCodigo ,.t. ) //Pessoa Fisica ou Juridica
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCBDIA07a  บAutor  ณMicrosiga           บ Data ณ  09/13/06   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณCBDIA07a - Rotina de Enderecos                              บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Else
	dbSetOrder(2)
EndIf
dbSeek( xFilial("SZS") + _cTipo + cCodigo + aCols2[n,1] ,.t. ) //Pessoa Fisica ou Juridica
...
If cAtivo == "2"
	oget2   := MsNewGetDados():New(41,2,160,372,,"u_fLinOk()","u_fTudOk()","+AC8_ITEM",,/*freeze*/,999,/*fieldok*/,/*superdel*/,/*delok*/,oDlg_a,aheader2,acols2)
Else
	nGetd   := GD_INSERT+GD_UPDATE+GD_DELETE
	aCampos := {}
	AADD(aCampos,"AC8_COD")
	oget2   := MsNewGetDados():New(41,2,160,372,nGetd,"u_fLinOk()","u_fTudOk()","+AC8_ITEM",aCampos,/*freeze*/,999,"u_ContField()"/*fieldok*/,/*superdel*/,/*delok*/,oDlg_a,aheader2,acols2)
EndIf

@ 175, 250 BUTTON "Entidade"   ACTION u_CBDIA03Alt() SIZE 40,15 PIXEL OF oDlg_a // Esta chamada traz a tela de Contatos X Entidade
...
User Function ContField()

_lRet := .T.

DbSelectArea("SA2")
DbSetOrder(1)
If DbSeek(xFilial("SA2")+M->AC8_COD)
	If SA2->A2_MSBLQL == "2"
		msgbox("Registo esta   I N A T I V O  ! ! !")
		_lRet := .F.
	EndIf
...
ElseIf  _fPrograma == "U_CBDIA07J"
	...
	_nPos4   := ascan( aHeader2, { |x| x[2] = "U5_ATIVO"})   // CONTATOS ATIVO
	cAtivo   := aCols2[n,_nPos4]
Else
	_nPos2   := ascan( aHeader, { |x| x[2] = "U5_CODCONT"}) // CONTATOS
...
Else
	...
	If cAtivo == "2"
		oGet3 := MsNewGetDados():New(41,2,160,372,,"u_Mod2LinOk()","u_Mod2TudOK()","+ZQ_ITEM",aCampos,/*freeze*/,,/*fieldok*/,/*superdel*/,/*delok*/,oDlg1,aheader3,acols3)
	Else
		nGetd := GD_INSERT+GD_UPDATE+GD_DELETE
...
Else
	...
	If cAtivo == "2"
		oGet4 := MsNewGetDados():New(41,2,160,372,,"u_TraLinOK()","u_TraTudOK()","+ZT_ITEM",aCampos,/*freeze*/,,/*fieldok*/,/*superdel*/,/*delok*/,oDlg,aheader4,acols4)
	Else
		nGetd   := GD_INSERT+GD_UPDATE+GD_DELETE
...
Else
	...
	If cAtivo == "2"
		oGet4 := MsNewGetDados():New(41,2,160,372,,"u_TraLinOK()","u_TraTudOK()","+ZR_ITEM",aCampos,/*freeze*/,,/*fieldok*/,/*superdel*/,/*delok*/,oDlg,aheader4,acols4)
	Else
		nGetd := GD_INSERT+GD_UPDATE+GD_DELETE
...
If _opcao == 1 // botao <OK> da Tela de Inclusao
	...
	//Grava a Categoria do Contato na tabela de Amarracao Contatos x Categoria
	If !Empty(SU5->U5_CATEG)
		DbSelectArea("SZY")
		DbSetOrder(1)
		RecLock("SZY",.T.)
		SZY->ZY_FILIAL  := xFilial("SZY")
		SZY->ZY_ITEM    := "0001"
		SZY->ZY_CODCONT := SU5->U5_CODCONT
		SZY->ZY_COD     := SU5->U5_CATEG
		SZY->ZY_DESC    := SU5->U5_DESCAT
		MsUnlock()
	EndIf
	...
	While !EOF()
		...
		AADD( aCols,{TMP->U5_CODCONT, TMP->U5_CONTAT, _cDGRUPO, _cDESC, _cDNIVEL, TMP->U5_EMAIL, TMP->U5_ATIVO, .F.})
...
If nCont > 0
	While !EOF()
		AADD( aCOLS,{TMP->ZM_CODENT , TMP->ZM_NOME, TMP->ZM_ATIVO, .F.})
		dbSelectArea("TMP")
		dbSkip()
	End
Else
...
//If nCont > 0
	...
	_fCabec(cCabec)
	dbSeek("A2_MSBLQL")		//Ativo ou Inativo
	_fCabec(cCabec)
//EndIf
...
If nCont > 0
	While !EOF()
		AADD( aCOLS,{TMP->A2_COD, TMP->A2_NOME, TMP->A2_MSBLQL, .F.})
		dbSelectArea("TMP")
		dbSkip()
	End
Else
...
cNome   := aCols[n,_nPos3]
_nPos4  := ascan( aHeader, { |x| x[2] = "A2_MSBLQL"})   // CONTATO ATIVO
cAtivo  := aCols[n,_nPos4]
...
While !EOF() .And. AC8->AC8_FILIAL + AC8->AC8_COD == xFilial("SA2") + cCodigo
	...
	If DbSeek(xFilial("SU5")+AC8->AC8_CODCON)
		...
		_cAtivo   := SU5->U5_ATIVO
	EndIf
	aAdd( aCOLS2,{AC8->AC8_CODCON, _cNomCont, _cAtivo, .F.})
	dbSelectArea("AC8")
	dbSkip()
End
	...
	Else
		...
		If _lFound
			If lOk
				...
				nDel ++
			Else
				cMsg := "Nao foi possivel deletar o item "+aCols3[nI,1]+", o mesmo possui amarracao (Perfil)"
				msgbox(cMsg)
				lRet := .F.
				Return(lRet)
			Endif
...
//------------------------------------------------------------------------------------------------------
		...
		If _lFound
			If lOk
				...
				nDel ++
			Else
				cMsg := "Nao foi possivel deletar o item "+aCols3[nI,1]+", o mesmo possui amarracao (Enderecos)"
				msgbox(cMsg)
				lRet := .F.
				Return(lRet)
			Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  |Mod2GrvEndบAutor  ณEmerson Natali      บ Data ณ  27/07/2006 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
DbSelectArea("SZM")
DbSetOrder(1)
If DbSeek(xFilial("SZM")+M->ZQ_CODENT)
	_lAcho	:= .T.
	_cAtivo	:= SZM->ZM_ATIVO
EndIf

If _lAcho .and. _cAtivo == "2"
	_ret := .F.
	msgbox("Registo esta   I N A T I V O  ! ! !")
EndIf
...
DbSelectArea("SQ0")
DbSetOrder(1)
If DbSeek(xFilial("SQ0")+M->ZQ_GRUPO)
	_lAcho 	:= .T.
	_cAtivo := SQ0->Q0_ATIVO
EndIf
