...
If _cProg == "U_CBDIR08"
	DbSelectArea("SZO")
	If M->ZO_ORDEM == "1" //nome
		CALLCRYS("ETIQ2", cParams, cOpcoes)
	ElseIf M->ZO_ORDEM == "2" //cep+ nome
		CALLCRYS("ETIQ3", cParams, cOpcoes)
	EndIf
Else
	DbSelectArea("SZO")
	If M->ZO_ORDEM == "1" //nome
		CALLCRYS("ETIQUET1", cParams, cOpcoes)
	ElseIf M->ZO_ORDEM == "2" //cep+ nome
		CALLCRYS("ETIQUET2", cParams, cOpcoes)
	EndIf
