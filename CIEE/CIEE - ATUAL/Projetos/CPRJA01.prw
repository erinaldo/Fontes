...
If ProcName(11) <> "U_VALSSI"
	...
	If Empty(M->ZP_LISTALT) .AND. M->ZP_CANCEL == '2'
		MsgAlert(OemToAnsi("Obrigat๓rio informar Lista de Altera็๕es efetuadas!!!"))
		Return(.F.)
	EndIf	
Else
		...
		If 	_xAlt == 1
			If !Empty(SZP->ZP_CONCLUS) .and. Empty(SZP->ZP_ACEITE) .and. SZP->ZP_ARQUIVO == "2"
				...
				For nW:=1 to 2
					...
					AADD(aMsg, " ")
					aAdd(aMsg, '<p><a href="'+'http://187.94.62.86:8282/workflow/messenger/emp' +cEmpAnt  + '/' + "000016" + '/' + alltrim(cProcess) + '.html">clique aqui</a> para Aprova็ใo/Rejei็ใo.</p>')
					AADD(aMsg, " ")
					AADD(aMsg, " ")
...
//Linha,coluna
DEFINE MSDIALOG oDlg FROM  0,0 TO 515,425 TITLE "Renegocia็ใo de prazo de SSI" PIXEL
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณAtuPdfSSI บAutor  ณFabio Zanchim       บ Data ณ  04/2014    บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Atualiza o PDF da SSI                           			  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Protheus 11                                                บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
