...
Else
	...
	If Empty(M->ZP_PREVINI) .Or. Empty(M->ZP_DTPREV)
		MsgAlert(OemToAnsi("Data Prevista inicial e final sใo obrigatorias!"))
		Return(.F.)
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณIncSSI  บAutor  ณFabio Zanchim        บ Data ณ  25/03/08   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Inclusao de SSI                               			  บฑฑ
ฑฑบ          ณ 28/11/13 - A execu็ใo do TWFProcess dentro do Axinclui     บฑฑ
ฑฑบ          ณ apresenta problemas.                                       บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Protheus 8                                                 บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
oProcess:cBody  	:= OemToAnsi("Solicita็ใo "+SZP->ZP_NRSSI+" incluํda!") +_cEOL
	...
	If aPags[_nCont,1]
		...
		If 	_xAlt == 1
			If !Empty(SZP->ZP_CONCLUS) .and. Empty(SZP->ZP_ACEITE) .and. SZP->ZP_ARQUIVO == "2"
				...
				If ApMsgYesNo('Deseja anexar documento no e-mail de conclusใo da SSI '+SZP->ZP_NRSSI+' ?')
					cAttach:=cGetFile('*.*','Documentos',,,.F.,GETF_ONLYSERVER)
				EndIf
				
				_cAssunto  	:= OemToAnsi("Conclusใo da SSI n๚mero "+SZP->ZP_NRSSI +" !")
				//PutMv('MV_WFHTML',.F.)
				...
				//_cNome := cUserName
				aMsg := {}
				aaDD(aMsg, "Segue Conclusใo da SSI "+SZP->ZP_NRSSI+" para aprova็ใo.")
				AADD(aMsg, " ")
				aAdd(aMsg, '<p><a href="'+'http://fenix:8081/workflow/messenger/emp' +cEmpAnt  + '/' + "000016" + '/' + alltrim(cProcess) + '.html">clique aqui</a> para Aprova็ใo/Rejei็ใo.</p>')
				AADD(aMsg, " ")
				AADD(aMsg, " ")
				...
				EndIf             
				//WFNotifyAdmin em U_fEnviaLink somente permite cTo... nใo hแ cCC
				_cTo:=Alltrim(SZP->ZP_EMAIL1)+';'+Alltrim(SZP->ZP_EMAIL2)+';sistemas@cieesp.org.br;mauricio@cieesp.org.br'
...
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Tela de Aloca็ใo de SSI                                    บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
Else
	...
	If _xAlt == 1
		...
		_cAssunto  	:= OemToAnsi("Aloca็ใo da SSI n๚mero "+SZP->ZP_NRSSI +" !")
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณRENEGSSI  บAutor  ณFabio Zanchim       บ Data ณ  10/2013    บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Renocia็ใo de Dt. Previsao Final e Justificativa  		  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Protheus 11                                                บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
If !(Empty(SZP->ZP_CONCLUS) .And. SZP->ZP_CANCEL=='2' .and. Empty(SZP->ZP_ACEITE) .And. SZP->ZP_APROV=='S' .And. SZP->ZP_ALOC=='S')//Pendente
	Aviso( "Renegocia็ใo", "A SSI nใo esta em desenvolvimento para que possa ser renegociada.", {"Ok"}, 2)
	Return
EndIf
...
If dbSeek(xFilial('PAK')+cSSI)
	While !Eof() .And. xFilial('PAK')==PAK_FILIAL .And. PAK_NRSSI==cSSI
		...
		Aadd(aSay,'PRINTCOREm '+DtoC(PAK_DATA)+' : '+'Previsใo de '+DtoC(PAK_PRVANT)+' para '+DtoC(PAK_PRVNOV))
...
//Linha,coluna
DEFINE MSDIALOG oDlg FROM  0,0 TO 460,425 TITLE "Renegocia็ใo de prazo de SSI" PIXEL
...
TSay():New(5,105,{|| "Previsใo Anterior"},oDlg,,,.F.,.F.,.F.,.T.,,,GetTextWidth(0,Trim('Previsใo Anterior')),15,.F.,.F.,.F.,.F.,.F.)
oGet:=TGet():New(5,152,{|u| Iif(PCount()>0,dDtVelha:=u,dDtVelha)},oDlg,020,009,""  ,,,,,.F.,,.T.,,.F.,,.F.,.F.,,.T.,.F.,,'dDtVelha',,,,.T.)

TSay():New(18,105,{|| 'Nova Previsใo'},oDlg,,,.F.,.F.,.F.,.T.,,,GetTextWidth(0,Trim('Nova Previsใo')),15,.F.,.F.,.F.,.F.,.F.)
oGet:=TGet():New(18,152,{|u| Iif(PCount()>0,dDtNova:=u,dDtNova)},oDlg,,7,,,,,,.F.,,.T.,,.F.,,.F.,.F.,,.F.,.F.,,'dDtNova',,,,.T.)

//SCROLL DO HISTORICO -----------------------------------------------------------------------------------------------------------------------------
@ 032,004 TO 162,210 LABEL "Hist๓rico" OF oDlg PIXEL
//Altura, Largura
@ 040,008 SCROLLBOX oScroll HORIZONTAL VERTICAL SIZE 118,198 of oDlg BORDER
nTop:=4
...
//INSERวAO DA JUSTIFICATIVA --------------------------------------------------------------------------------------------------------------------
@ 164,004 TO 205,212 LABEL "Justificativa" OF oDlg PIXEL
//Linha, Coluna                      Size Largura,Comprimento
@ 171,008 GET oMemo  VAR cJustif MEMO SIZE 198,30 OF oDlg PIXEL

DEFINE SBUTTON FROM 210,150 TYPE 2  ENABLE OF oDlg ACTION (lRet:=.F.,oDlg:End())
DEFINE SBUTTON FROM 210,180 TYPE 1  ENABLE OF oDlg ACTION (Iif(VldReneG(dDtVelha,dDtNova,cJustif),(lRet:=.T.,oDlg:End()),Nil))
ACTIVATE MSDIALOG oDlg CENTERED
...
If lRet
	...
	//Envia e-mail informando a Renegocia็ใo
...
*
* EnvWFReneg()
* Envia WF de Renegocia็ใo do Prazo
*
--------------------------------------------------------------*/
Static Function EnvWFReneg(cUsrReneg,dDtPrazo,cJustif)

Local oProcess,oHtml
Local _cAssunto  	:= OemToAnsi("Renegocia็ใo da SSI n๚mero "+SZP->ZP_NRSSI +" !")

oProcess:= TWFProcess():New("000002", "Workflow Renegocia็ใo de SSI")
...
oProcess:cCc  		:= 'sistemas@cieesp.org.br;mauricio@cieesp.org.br'
oProcess:bReturn	:= NIL
oProcess:cBody  	:= OemToAnsi("Solicita็ใo "+SZP->ZP_NRSSI+" Renegociada!") +CRLF
oProcess:cBody 		+= OemToAnsi("Esta ้ uma mensagem automแtica. Por favor, nใo responda!!!")
...
*
* VldReneG()
* Valida็ใo da tela de Renegocia็ใo de prazo
*
--------------------------------------------------------------*/
...
If dDtNova<=dDtVelha
	lRet:=.F.
	Aviso( "Dt Previsao", "A nova previsใo de entrega deve ser superior a data ja estipulada.", {"Ok"}, 2)
EndIf
If lRet .And. Empty(cJustif)
	lRet:=.F.
	Aviso( "Justificativa", "Informe o motivo de altera็ใo do prazo da SSI.", {"Ok"}, 2)
EndIf
