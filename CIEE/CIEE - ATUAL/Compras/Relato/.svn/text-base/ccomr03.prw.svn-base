...
±±ºPrograma  ³CCOMR03   ºAutor  ³ Felipe Raposo      º Data ³  06/01/03   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Relatorio especifico de relacao de notas fiscais de entra- º±±
±±º          ³ da.                                                        º±±
±±º          ³ Esse relatorio foi adaptado porque o padrao nao filtra as  º±±
±±º          ³ despesas e os descontos concedidos na nota. Ele utiliza os º±±
±±º          ³ campos F1_VALDESC e F1_DESPESA e o CIEE precisa que seja   º±±
±±º          ³ utilizado os campos D1_VALDESC e D1_DESPESA.               º±±
±±º          ³                                                            º±±
