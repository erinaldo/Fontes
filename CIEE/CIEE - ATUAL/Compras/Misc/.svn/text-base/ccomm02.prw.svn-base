...
ฑฑบPrograma  ณccomm02   บ Autor ณ Felipe Raposo      บ Data ณ  27/01/03   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Reprocessa os campos da aba "Compras" e "Ultima Compra" do บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณccomm02a  บ Autor ณ Felipe Raposo      บ Data ณ  27/01/03   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Reprocessa os campos da aba "Compras":                     บฑฑ
ฑฑบ          ณ A2_PRICOM, A2_ULTCOM, A2_VRACUMR, A2_VRACUMD, A2_COTVEN1,  บฑฑ
ฑฑบ          ณ A2_MDESC, A2_MATRASO e A2_MCOMP.                           บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ CIEE.                                                      บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
//ณ Query para os campos 1a compra,        ณ
//ณ Ultima Compra e Vlr. Acum. em Reais.   ณ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Query para o campo Maior Compra.       ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
_cQry2 :=;   // Ok.
"UPDATE " + RetSQLName("SA2") + _EOL +;
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Query para o campo Maior Atraso.       ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
_cQry3 :=;   // Ok.
"UPDATE " + RetSQLName("SA2") + _EOL +;
"SET A2_MATRASO = " + _EOL +;
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Query para o campo Maior Desconto.     ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Query para o campo Cots. Vencidas.     ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
_cQry5 :=;   // Ok.
"UPDATE " + RetSQLName("SA2") + _EOL +;
"SET A2_COTVEN1 = " + _EOL +;
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Query para os campos Vlr. da Ultima    ณ
//ณ Compra, Desc. da Ultima Compra.        ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
_cQry6 :=;   // Ok.
"UPDATE " + RetSQLName("SA2") + _EOL +;
"SET " + _EOL +;
"A2_VALORUC = F1_VALBRUT, " + _EOL +;
"A2_DESCUC  = RTRIM(ROUND(F1_DESCONT/F1_VALBRUT, 2)) + '% - $' + RTRIM(ROUND(0.00 + F1_DESCONT, 2)) +' PC'+D1_PEDIDO" + _EOL +;
"FROM " + _EOL +;
"( " + _EOL +;
"	SELECT A2_COD XX_COD, A2_LOJA XX_LOJA, " + _EOL +;
"	( " + _EOL +;
"		SELECT TOP 1 F1_DOC + F1_SERIE FROM " + RetSQLName("SF1") + " SF1, " + RetSQLName("SD1") + " SD1 "+ _EOL +;
"		WHERE " + _EOL +;
"		F1_FORNECE = A2_COD AND F1_LOJA = A2_LOJA AND F1_DOC=D1_DOC AND F1_SERIE=D1_SERIE AND " + _EOL +;
"		SF1.D_E_L_E_T_ <> '*' " + _EOL +;
"		ORDER BY F1_DTDIGIT DESC " + _EOL +;
"		) NOTA FROM " + RetSQLName("SA2") + " SA2 " + _EOL +;
"	WHERE " + _EOL +;
"	SA2.D_E_L_E_T_ <> '*' " + _EOL +;
") A, " + RetSQLName("SA2") + " SA2, " + RetSQLName("SD1") + " SD1, "+ RetSQLName("SF1") + " SF1 WHERE " + _EOL +;
"(A2_COD = XX_COD AND A2_LOJA = XX_LOJA) AND (F1_DOC=D1_DOC AND F1_SERIE=D1_SERIE) AND" + _EOL +;
"(F1_FORNECE = XX_COD AND F1_LOJA = XX_LOJA AND F1_DOC + F1_SERIE = NOTA) AND " + _EOL +;
"SA2.D_E_L_E_T_ <> '*'AND SD1.D_E_L_E_T_ <> '*' AND SF1.D_E_L_E_T_ <> '*'"

//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Query para os os fornecedores          ณ
//ณ res sem nota no sistema.               ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
_cQry7 :=;   // Ok.
"UPDATE " + RetSQLName("SA2") + _EOL +;
"SET " + _EOL +;
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Query para o campo Atraso da Ultima    ณ
//ณ Compra.                                ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
_cQry8 :=;   // Ok.
"UPDATE " + RetSQLName("SA2") + _EOL +;
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Grava as queries em arquivo .SQL       ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
//ณ Processa as queries e verifica se foi corretamente.    ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
_cMsg := "Nใo foi possํvel atualizar o cadastro de fornecedores (SA2)." + _EOL +;
...
For _nAux1 := 1 to len(_aProc)
	...
	If TcSqlExec(_cQry&(_cAux1)) != 0
		_cMsg += TcSQLError()
		APMsgAlert(OemToAnsi(_cMsg), OemToAnsi("Aten็ใo - Query " + AllTrim(str(_nAux1))))
		Return -1
	Endif
Next _nAux1
