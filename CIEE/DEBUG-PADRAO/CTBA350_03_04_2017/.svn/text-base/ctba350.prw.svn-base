...
IF nOpca == 1
	...
	#IFNDEF TOP
		If nThread > 1
			Help(" ",1,"NONDBACCESS" ,,"Rotina de efetivação multithread é exclusiva para ambientes com Banco de dados Relacional (SGDB). A rotina será executada de forma padrão." ,3,0)	
			nThread := 1
		Endif
	#ENDIF
EndIf
