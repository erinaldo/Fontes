...
/* ===============================================================================
WSDL Location    http://localhost:8283/ws/CIEE.apw?WSDL
...
User Function _AFWRESG ; Return  // "dummy" function - Internal Use 
...
cSoap += '<FSERVICE xmlns="http://localhost:8283/">'
cSoap += WSSoapValue("INMSG", ::cINMSG, cINMSG , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</FSERVICE>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://localhost:8283/FSERVICE",; 
	"DOCUMENT","http://localhost:8283/",,"1.031217",; 
	"http://localhost:8283/CIEE.apw")
