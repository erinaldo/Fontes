...
Static Function Impsr7()
 ...
 DO WHILE !EOF()
   ...
   ENDIF    
	...
	_CodFunc :=  STRZERO(VAL(ZZ1->FUNCAO),4)    
...
//       If cFilDest = "07" 
	...
	ElseIf ZZ1->MOTIVO $ "PR*pr*Pr"
	   SR7->R7_TIPO := "012"      
	ElseIf UPPER(ZZ1->MOTIVO) $ "AD"
	   SR7->R7_TIPO := "014"      	   
	ElseIf UPPER(ZZ1->MOTIVO) $ "AQ"
	   SR7->R7_TIPO := "016"    	   
	ElseIf UPPER(ZZ1->MOTIVO) $ "RC"
	   SR7->R7_TIPO := "015"    	   
    ENDIF
