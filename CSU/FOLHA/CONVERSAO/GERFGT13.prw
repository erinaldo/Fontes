...
User Function GERFGT13()

 Local	oDlg	:= NIL


 Private cPerg	:= PADR("CONFGT" ,LEN(SX1->X1_GRUPO))
 Private aInfo	    := {}
 Private aDepende   := {}
 Private nDepen  	:= 0


 @ 096,042 TO 323,505 DIALOG oDlg TITLE OemToAnsi("GERACAO DO FGTS 13 SALARIO")
 @ 008,010 TO 084,222
...
// 		DATARQ := IIF(SUBS(MV_PAR01,13,1)="9","19"+SUBS(MV_PAR01,13,2),"20"+SUBS(MV_PAR01,13,2))+ "01"
        ...
        Endif 
		    ...
		    SRD->RD_TIPO2  := "I"
		    SRD->RD_HORAS  := 0 
		    SRD->RD_VALOR  := (ZZ1->BASEFGT1)*0.08
       		SRD->RD_STATUS := "I"
