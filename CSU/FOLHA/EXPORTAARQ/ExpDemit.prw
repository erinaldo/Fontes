...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
User Function ExpDemit(aParams)
Local 	aSay       := {}
Local 	aButton    := {}
Local 	nOpc       := 0
Local 	cTitulo    := ""
Local	cDesc1     := "Esta rotina ira fazer a exportacao do cadastro"
Local	cDesc2 	   := "de Funcionarios  demitidos para a Intermedica."
Local	cDesc3 	   := ""
...
private ntenta  := 2
Private cPlanos := GetMv("MV_PLAINT",,"27/")
...
aadd(aRet, {"ESTADO CIVIL",                                           "O",  "190", "190", "",    "U_RETESC(SRA->RA_ESTCIVI)",  "", "" , "D", "N" } )
...
aadd(aRet, {"CำDIGO DO PLANO",                                        "O",  "233", "236", "",    "U_RETCPL()",  "", "" , "D", "N" } )
...
aadd(aRet, {"CำDIGO DE IDENTIFICAวรO DA EMPRESA JUNTO A INTERMษDICA", "O",  "284", "291", "",    "U_RetPla('1')",  "", "" , "D", "N" } )
...
aadd(aRet, {"Nบ CำDIGO DA EMPRESA NA INTERMษDICA",                    "N",  "309", "316", "",    "U_RetPla('1')",  "", "" , "D", "N" } )
...
aadd(aRet, {"DATA DE VALIDADE",                                       "N",  "415", "422", "",    "",  "", "" , "D", "N" } )
...
aadd(aRet, {"PARENTESCO DO DEPENDENTE EM RELAวรO AO TITULAR",         "O",  "044", "045", "",      "U_RETPAR()",  "", "" , "D", "N" } )
...
aadd(aRet, {"CำDIGO DO PLANO",                                        "O",  "107", "110", "",      "U_RETCPL()",  "", "" , "D", "N" } )
...
aadd(aRet, {"NOME DA MรE DO BENEFICIมRIO",                            "N",  "185", "224", "",      "SRB->RB_MAE",  "", "" , "E", "T" } )
...
aadd(aRet, {"PARENTESCO DO AGREGADO EM RELAวรO AO TITULAR",           "O",  "044", "045", "",      "U_RETPAR()",  "", "" , "D", "N" } )
aadd(aRet, {"DATA DE NASCIMENTO DDMMYYYY",                            "O",  "046", "053", "",      "U_Retdata(SRB->RB_DTNASC)",  "", "" , "D", "N" } )
aadd(aRet, {"SEXO",                                                   "O",  "054", "054", "",      "U_RETSEX(SRB->RB_SEXO)",  "", "" , "D", "N" } )
aadd(aRet, {"ESTADO CIVIL",                                           "O",  "055", "055", "'1'",      "",  "", "" , "D", "N" } )
aadd(aRet, {"CำDIGO DO PLANO",                                        "O",  "056", "059", "",      "U_RETCPL()",  "", "" , "D", "N" } )
...
aadd(aRet, {"NOME DA MรE DO BENEFICIมRIO",                            "N",  "170", "209", "",      "SRB->RB_MAE",  "", "" , "E", "T" } )
