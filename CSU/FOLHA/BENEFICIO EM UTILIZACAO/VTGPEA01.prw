...
ฑฑบPrograma  ณ VTGPEA01 บAutor  ณ Adilson Silva      บ Data ณ 03/06/2011  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Lancamentos do Vale Transporte.                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
User Function VTGPEA01( nOpcAuto )                                    

Local aIndexSRA  := {}
Local cFiltraSRA

Private bFiltraBrw := {|| Nil}
Private cCadastro := OemToAnsi( "Vale Transporte" )

Private aRotina := { { "Pesquisar"     , "AxPesqui"  		  	, 0 , 1},;
					 { "Visualizar"     , "U_x01VTGPEA(,,2)"	, 0 , 2},;
					 { "Incluir"        , "U_x01VTGPEA(,,3)"	, 0 , 3},;
					 { "Alterar"        , "U_x01VTGPEA(,,4)"	, 0 , 4},;
					 { "Calculo"        , "U_VTGPEM01(,,4)"		, 0 , 4},;
					 { "Emite Mapa"     , "U_VTGPER01(,,4)"		, 0 , 4} }
...
Else
   ...
   cFiltraRh  := CHKRH("VTGPEA01","SRA","1")
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVTGPEA01  บAutor  ณMicrosiga           บ Data ณ  04/24/07   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Lancamentos e Calculo do Vale Transporte.                  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ MP8                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
User Function x01VTGPEA(cAlias,nReg,nOpcx)
...
Local lAxPesqui    := .F. 
Local cPesqOrd      
Local lPesqFun     := GETMV("GP_TRAPESQ",,"S") == "S"
...
// Alias Utilizado
Private cAliasPai := "ZTA"
Private cAliasFlh := "ZTB"

// arrays usados no GDMONTACOLS para o alias ZTA e ZTB
// Campos Nao Mostrados
Private aNoCpoPai := { "ZTA_FILIAL" , "ZTA_MAT" }
Private aNoCpoFlh := { "ZTB_FILIAL" , "ZTB_MAT" , "ZTB_DIAS" }
...
Begin Sequence
   ...
   // Matricula
   @ aObjSize[1,1] , aObjSize[1,2] GROUP oGroup TO ( aObjSize[1,3] ),( ( aObjSize[1,4]/100*10 - 4 ) )	LABEL OemToAnsi( "Matricula:" ) OF oDlg PIXEL
   oGroup:oFont:= oFont
   // Nome
   @ aObjSize[1,1] , ( ( aObjSize[1,4]/100*10 ) ) GROUP oGroup TO ( aObjSize[1,3] ),( aObjSize[1,4]/100*80 - 4 ) LABEL OemToAnsi( "Nome:" ) OF oDlg PIXEL
   oGroup:oFont:= oFont
   // Admissao
   ...
   // Matricula
	@ ( ( aObjSize[1,3] ) - ( aObjSize[1,1] ) - 15 ) , ( aObjSize[1,2] + 5 ) SAY StrZero(Val(SRA->RA_MAT),Len(SRA->RA_MAT)) SIZE 050,10 OF oDlg PIXEL FONT oFont
   // Nome
   @ ( ( aObjSize[1,3] ) - ( aObjSize[1,1] ) - 15 ) , ( ( aObjSize[1,4]/100*10 ) + 5 ) SAY OemToAnsi(SRA->RA_NOME) SIZE 146,10 OF oDlg PIXEL FONT oFont
   // Admissao
   @ ( ( aObjSize[1,3] ) - ( aObjSize[1,1] ) - 15 ) , ( ( aObjSize[1,4]/100*80 ) + 5 ) SAY Dtoc(SRA->RA_ADMISSA) SIZE 050,10 OF oDlg PIXEL FONT oFont

   // Meios de Transporte
   @ aObjSize[2,1] , aObjSize[2,2] GROUP oGroup TO ( aObjSize[2,3] ), ( aObjSize[2,4] )	LABEL ""	OF oDlg PIXEL
   oGroup:oFont:= oFont
   @ ( ( ( ( aObjSize[2,3] ) - ( aObjSize[2,1] ) ) / 2 ) + ( aObjSize[2,1] - 3 ) ) , ( ( aObjSize[2,2] ) + 180 )		SAY "Vale Transporte"		SIZE 150,10 OF oDlg PIXEL FONT oFont
   ...
   oGroup:oFont:= oFont
   @ ( ( ( ( aObjSize[4,3] ) - ( aObjSize[4,1] ) ) / 2 ) + ( aObjSize[4,1] - 3 ) ) , ( ( aObjSize[4,2] ) + 180 )		SAY "Historico - Vale Transporte"		SIZE 150,10 OF oDlg PIXEL FONT oFont
   ...
   oGetFlh := MsNewGetDados():New(											;
                                   ...
                                   "U_VT02LinOk()",							; // funcao para validar a edicao da linha - ulinhaOK
                                   "U_VT02TudOk()",							; // funcao para validar todos os registros da GetDados - uTudoOK
                                   NIL,										; // cIniCPOS
                                   NIL,										; // aAlter
                                   0,										; // nfreeze
                                   99999,									; // nMax
   ...
   If lPesqFun
      ...
      //@ ((aObjSize[6,1])+17),((aObjSize[6,4])/100*92)  		BUTTON   "Ok" 			SIZE 021.5,009 	PIXEL OF oDlg ACTION ( fPosZTB(cPesqFiltro) )
   EndIf
...
#IFDEF TOP
   // Query Para ZTA
   aQueryPai    := Array( 1 )
   aQueryPai[1] := "ZTA_FILIAL = '" + cFil + "' AND ZTA_MAT = '" + cMat + "' AND D_E_L_E_T_ = ' '"

   // Query Para ZTB
   aQueryFlh    := Array( 1 )
   aQueryFlh[1] := "ZTB_FILIAL = '" + cFil + "' AND ZTB_MAT = '" + cMat + "' AND D_E_L_E_T_ = ' '"
#ENDIF
...
Static Function MontaVirtuais(nOpcX)
 ...
 IF ( nOpcX <> 3 ) //Quando Nao for Inclusao
   	lDaRefresh := .T.
    // descri็ใo do meio para ZTA
 	nPosMeio := GdFieldPos( "ZTA_MEIO"	, aHeadPai )
 	nPosDesc := GdFieldPos( "ZTA_DESC"	, aHeadPai )
 	For nX := 1 To Len( aColsPai )
 		aColsPai[ nX , nPosDesc ] := fDesc( "SRN" , aColsPai[ nX , nPosMeio ] , "RN_DESC" )
 	Next nX
 
 	// DESCRICAO DO MEIO PARA O ZTB
 	nPosMeio := GdFieldPos( "ZTB_MEIO"	, aHeadFlh )
 	nPosDesc := GdFieldPos( "ZTB_DESC"	, aHeadFlh )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVTGPEA01  บAutor  ณMicrosiga           บ Data ณ  04/27/07   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Static Function fCheckDel()
 ...
 Local nPosDatarq := GdFieldPos( "ZTB_DATARQ" , aHeadAux )
...
Static Function MontaCols()  
 ...
 //Ajusta campos ZTB_DATARQ no Formato MMAAAA
 nPosDatarq := GdFieldPos( "ZTB_DATARQ", aHeadFlh )
 nPosCodigo := GdFieldPos( "ZTB_COD"   , aHeadFlh )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿ */
User Function VT01LinOk()

 Local lRet     := .T.
 Local nPosCod  := GdFieldPos( "ZTA_COD"    , aHeadPai )
 Local nPosTipo := GdFieldPos( "ZTA_TIPO"   , aHeadPai )
 Local nPosQde  := GdFieldPos( "ZTA_QDEDIA" , aHeadPai )
 ...
 If lRet .And. nPosQde > 0
    If aCols[n,nPosQde] <= 0
       Aviso("ATENCAO","Quantidade de Vales por Dia Nใo Informado!",{"Retornar"})
       lRet := .F.
    EndIf
 EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณVTGPEA01  บAutor  ณMicrosiga           บ Data ณ  04/25/07   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Else //Inclusao ou Alteracao
   If !fCompArray( aColsAux , aColsAnt )
      ...
      //Ajusta campos ZTB_DATARQ no Formato AAAAMM
      If cAlias == "ZTB"      
          nPosDatarq := GdFieldPos( "ZTB_DATARQ", aHeaderAux )
          If nPosDatarq > 0
...
If lGravarAntes 
   MsAguarde( { || fAuxGrava( "ZTA" , cFil , cMat , aVirtual1 , aColsRec1 , nOpcx , .T. ),;
                   fAuxGrava( "ZTB" , cFil , cMat , aVirtual2 , aColsRec2 , nOpcx , .F. ) },;
