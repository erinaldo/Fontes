...
±±³Fun‡„o    ³ CSUAODONT³ Autor ³ Douglas David         ³ Data ³ Jul/2013 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡„o ³ Relatório Assistência Odontológica						  ³±±
...
*/
User Function CSUAODONT()
Local wnrel:= "CSUAODONT"
Local cString  := ""
Local tamanho    := "G"
Local limite     := 132
Local titulo     := "Relatorio Assistencia Odontologica"
Local cDesc1     := "Relatorio Assistencia Odontologica"
Local cDesc2     := "Impressão de dados Tabela RHK x Base Inter Notre(SRA)- Ass.Odontologica"
Local cDesc3     := " "
Local Pg		 := "CSUAODONT"
...
Processa( {|lEnd| CSUPGODT(@lEnd)}, "Aguarde...","Executando rotina.", .T. )
Return
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡„o    ³ CSUPGODT		³ Autor ³ Douglas David     ³ Data ³ Jul/2013 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
cCONS +="LEFT JOIN "+RetSqlName('RCC')+ " RCC ON RCC_CODIGO='S013' AND SUBSTRING (RCC_CONTEU,1,2)=RHK_PLANO AND RCC.D_E_L_E_T_='' "
...
{||DlgToExcel({{"GETDADOS", "RELATÓRIO DE ASSISTÊNCIA ODONTOLÓGICA", aCabExcel,aItensExcel}})})
return
