...
// Teste de Importacao
User Function TesI1CSU()
Return u_CSUJ001( { .F., '05', '01' }  )
User Function TesI2CSU()
Return u_CSUJ001( { .F., '05', '02' }  )
User Function TesI3CSU()
Return u_CSUJ001( { .F., '05', '03' }  )
User Function Tes10CSU()
Return u_CSUJ001( { .F., '05', '10' }  )
User Function Tes06CSU()
Return u_CSUJ001( { .F., '05', '06' }  )
...
Private cPaswd 	 := '%tvt49@opi'  //GETMV( 'CS_PASSWD' )   
