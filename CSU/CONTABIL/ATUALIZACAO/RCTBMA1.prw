...
ฑฑบPrograma  ณRCTBMA1   บAutor  ณEdival Alves Junior/Vinํcius Greg๓rioบ Data ณ  06/01/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Tela de marcacao do rateamento.                                             บฑฑ
ฑฑบ          ณ                                                                             บฑฑ
...
Private aInd  		:= {}
Private cMarca		:= ""
Private cCadastro	:= OemToAnsi("Contabiliza็ใo de Documentos de Entrada")
...
/*Private aRotina 	:= {	{"Pesquisar",		'U_CTBMA1PE()'			,0,4},;
							{"Proc. Marcados",	'U_CTBMA1PR()'			,0,4},;
							{"Inverter Marca",	'U_CTBMA1IM()' 			,0,4},;							
							{"Visualizar",		'U_CTBMA1VI()'			,0,4},;
							{"Legenda",			'U_CTBMA1LEG()'			,0,4}}*/
...
BeginSql alias Qry
	...
	WHERE F1_FILIAL >= ' '
    	...
    	AND EV_LOJA = F1_LOJA
    	AND ((EV_XCODRAT BETWEEN %Exp:cRatDe% AND %Exp:cRatAte%) OR (EV_XCODRAT = ' '))
	    AND SEV.%notDel%   
...
//ณVG - verificar quais notas tem todas as naturezas atreladasณ
//ณa um c๓digo de rateio.                                     ณ
...
ฑฑบPrograma  ณCTBMA1IM  บAutor  ณ Vinํcius Greg๓rio  บ Data ณ 11/01/2011  บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCTBMA1MT  บAutor  ณ Vinํcius Greg๓rio  บ Data ณ 11/01/2011  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCTBMA1MC  บAutor  ณ Vinํcius Greg๓rio  บ Data ณ 11/01/2011  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑณFuno    ณCTBMA1LEG     ณAutor  ณ Vinํcius Greg๓rio     ณ Data ณ 11/01/10 ณฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function CTBMA1LEG()

Local aLegenda := { 	{"BR_VERDE"		, "Docs Disponํveis para processamento" },;
						{"BR_VERMELHO"	, "Doc. Indisponํveis para processamento" }}
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCTBMA1PE  บAutor  ณ Vinํcius Greg๓rio  บ Data ณ 11/01/2011  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCTBMA1VI  บAutor  ณVinํcius Greg๓rio   บ Data ณ  12/01/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCTBMA1PR  บAutor  ณV. Greg๓rio         บ Data ณ  11/01/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Local cLctoDeb	:= "RLD"//Tabela de Rateio
Local cLctoCrd	:= "RLC"//Centro de Custo Transit๓rio
...
//ณVG - 2011.06.09                ณ
//ณvariแvel de data para armazenarณ
//ณa database durante o           ณ
//ณprocessamento.                 ณ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณVG - 2011.02.21 - Inclusใo das outras entidades contแbeisณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
Private CXITTRAN	:= ""
Private CXCLTRAN	:= ""
...
nQtdCtb			:= 0		//Tatiana A. Barbosa - OS 0201/12 - 02/2012
...
For nLoop	:= 1 to Len(aProc)
	...
	dbSelectArea("SEV")
	dbSetOrder(1)//EV_FILIAL+EV_PREFIXO+EV_NUM+EV_PARCELA+EV_TIPO+EV_CLIFOR+EV_LOJA+EV_NATUREZ        //Tatiana A. Barbosa - OS 0201/12 - 02/2012
	dbGoTop()
//	dbSeek("  "+SUBSTR(cChavSEV,3,3)+SUBSTR(cChavSEV,6,9),.F.)		//Tatiana A. Barbosa - OS 0201/12 - 02/2012
	...
	Do While !EOF() 
		If SEV->EV_PREFIXO==SUBSTR(cChavSEV,3,3) .and. SEV->EV_NUM==SUBSTR(cChavSEV,6,9) .and. SEV->EV_TIPO==SUBSTR(cChavSEV,18,3);		//Tatiana A. Barbosa - OS 0201/12 - 02/2012
			...
			Do while !EOF() .and. ZB8->(ZB8_FILIAL+ZB8_CODRAT+ZB8_ANOMES+ZB8_REVISA) == xFilial("ZB8")+SEV->EV_XCODRAT+cAnoMes+cUltRev
				...
				aAdd(aLctoDeb,{SEV->EV_NATUREZ,;								//ณ1- Natureza                              ณ
			...
			//ณVG - 2011.06.09                           ณ
			//ณconfigura a database para a contabiliza็ใoณ
			//ณsegundo a data de digita็ใo da nota.      ณ
	...
	If nQtdCtb > 0	
		...
		RecLock("SF1",.F.)
			SF1->F1_XPRORAT	:= '1'
			SF1->F1_XDTCONT	:= dDataAnt//VG - 2011.06.09 - Data em que o rateio foi processado.
			SF1->F1_XUSRCON	:= __cUserID
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณVG - 2011.06.06 - Altera็ใo da dataณ
			//ณde contabiliza็ใo para ser igual เ ณ
			//ณdata de digita็ใo do documento de  ณ
			//ณentrada.                           ณ
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณVG - 2011.06.09               ณ
	//ณRetorna a database do sistema.ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	dDataBase	:= dDataAnt
