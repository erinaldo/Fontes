...
// *** contábeis referentes as provisoes de titulos a pagar da CSU.
// *** Data: 29/01/2001
...
@ 200,1 TO 380,450 DIALOG oLeTxt TITLE OemToAnsi("Imp. de Lançamentos Contábeis ref. as Provisões de Contas a Pagar")
@ 02,10 TO 060,215
@ 10,018 Say " Esta rotina tem como objetivo a importação dos lançamentos contábeis ref."	SIZE 196,0
@ 18,018 Say " as provisões de Contas a Pagar. Esta importação será efetuada através de "	SIZE 196,0
