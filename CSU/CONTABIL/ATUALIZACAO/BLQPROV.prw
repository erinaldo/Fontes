...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±			                                                               ±±
±± Funcao: BLQPROV  	Autor: Tatiana A. Barbosa	Data: 23/08/10	       ±±
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±						  												   ±±
±±	Descricao: 	ValidaÁ„o de senha para acesso a rotina         		   ±± 
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±± 																		   ±±
±±			Alteracoes: 											 	   ±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±			                                                               ±±
±± Funcao: AltBlqProv  	Autor: Tatiana A. Barbosa	Data: 23/08/10	       ±±
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±						  												   ±±
±±	Descricao: 	Bloquear/Desbloquear a movimentaÁ„o das provisıes 		   ±± 
±± 				(inclus„o, alteraÁ„o e exclus„o)						   ±±  
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±± 																		   ±±
±±			Alteracoes: 											 	   ±±
...
If _bOk            
	If Alltrim(GetMv("MV_PROVBLQ")) == "Bloqueado"
   		MsgAlert( "Bloqueio realizado com sucesso!!!")
 	Else 
 		If Alltrim(GetMv("MV_PROVBLQ")) == "Desbloqueado"
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±			                                                               ±±
±± Funcao: Dlg1Prov  	Autor: Tatiana A. Barbosa	Data: 23/08/10	       ±±
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±						  												   ±±
±±	Descricao: 	Tela para confirmaÁ„o do bloqueio/desbloqueio da   		   ±± 
±± 				movimentaÁ„o de provisıes       						   ±±  
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±± 																		   ±±
±±			Alteracoes: 											 	   ±±
...
oDlg:cName := "oDlg"
oDlg:cCaption := "Bloqueio de Movimentos de Provisıes"
oDlg:nLeft := 0
oDlg:nTop := 0
oDlg:nWidth := 315
oDlg:nHeight := 218
...
oSay2:cName := "oSay2"
oSay2:cCaption := "Esta rotina destina-se a realizar o bloqueio/desbloqueio de movimentos de provisıes (inclus„o, alteraÁ„o e exclus„o)."
oSay2:nLeft := 9
oSay2:nTop := 13
oSay2:nWidth := 276
oSay2:nHeight := 49
...
oSay4:cName := "oSay4"
oSay4:cCaption := GetMv("MV_PROVBLQ")
oSay4:nLeft := 186
oSay4:nTop := 70
oSay4:nWidth := 93
oSay4:nHeight := 17
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±			                                                               ±±
±± Funcao: ProvBlqSenha  	Autor: Tatiana A. Barbosa	Data: 23/08/10     ±±
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±						  												   ±±
±±	Descricao: 	Tela para digitaÁ„o de senha de acesso a rotina  		   ±± 
±±																		   ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±± 																		   ±±
±±			Alteracoes: 											 	   ±±
...
oDlg_1:cName := "oDlg_1"
oDlg_1:cCaption := "ValidaÁ„o de Acesso"
oDlg_1:nLeft := 0
oDlg_1:nTop := 0
oDlg_1:nWidth := 284
oDlg_1:nHeight := 110
