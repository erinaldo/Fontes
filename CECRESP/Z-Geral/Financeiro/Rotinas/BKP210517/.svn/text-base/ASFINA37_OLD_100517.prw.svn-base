...
//					Valid CarregaSa6(@cBcoOrig,@cAgenOrig,@cCtaOrig,.F.,,,@cNaturOri)	SIZE 10, 08 OF oPanel PIXEL hasbutton
	...
	If lSpbInUse	
		@ 104,009 MSGET cBenef100 Picture "@S21" Valid !Empty(cBenef100) SIZE 95, 08 OF oPanel PIXEL
	...
	Else
		@ 104,009 MSGET cBenef100 Picture "@S21" Valid !Empty(cBenef100) SIZE 155, 08 OF oPanel PIXEL
	Endif
