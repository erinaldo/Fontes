...
Chamado pelo PE SE5FI080 e FINA090
...
USER FUNCTION ASFINA42()
	...
	LOCAL cFKA_IDORIG	:= ""
	LOCAL cMOTBAI		:= ""
	LOCAL cE2_FILIAL	:= SE2->E2_FILIAL
...
//	ALERT( "CAL:" + cFUN + " FUN: " + FUNNAME() + " NUM: " + SE2->E2_NUM + " PRE: " + SE2->E2_PREFIXO + " E5_NUM: " + SE5->E5_NUMERO + " E5_PRE: " + SE5->E5_PREFIXO )
	...
	IF SE2->E2_XBCOFIL <> cFilAnt .AND. !EMPTY(SE2->E2_XBCOFIL) // se for pagamento de mutuo
		...
		IF SE5->E5_TIPODOC = "VL"
			cMOTBAI 	:= GETNEWPAR( "AS_MOTMUT", "MUT", SE2->E2_XBCOFIL )
			
			cE5_FILIAL	:= cE5_XBCOFIL
			...
			cE5_NATUREZ	:= SE5->E5_NATUREZ
			cE5_BANCO	:= SE5->E5_BANCO
			cE5_AGENCIA	:= SE5->E5_AGENCIA
			cE5_CONTA	:= SE5->E5_CONTA
			cE5_BENEF	:= SE5->E5_BENEF
			cE5_HISTOR	:= "EMPRESA ORIGEM " + cE2_FILIAL
