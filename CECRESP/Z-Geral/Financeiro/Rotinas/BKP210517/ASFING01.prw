...
Programa para validação do campo E2_CODBAR para 
utilização do pagfor.

Função chamada por gatilho do campo E2_CODBAR

Função para Validação de Código de Barras (CB) e Representação|
