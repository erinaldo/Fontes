...
USER FUNCTION ASFINA31()
	...
	PRIVATE cSITSE1		:= ALLTRIM(GETNEWPAR( "AS_SITSE1", "", cFILANT )) // Situações dos títulos a receber securitizados. Sep. p/ '|'. Exemplo: 0|1
	PRIVATE cSITSE9		:= ALLTRIM(GETNEWPAR( "AS_SITSE9", "", cFILANT )) // Situações dos títulos a receber securitizados vencidos. Sep. p/ '|'. Exemplo: 2
	...
	@ 026, 002 Say "Venc Real"		SIZE 40,7 OF oPanel PIXEL
	@ 026, 035 MSGET dVencIni	SIZE 54,8 OF oPanel PIXEL HASBUTTON
	@ 026, 100 Say "a" 		SIZE 40,7 OF oPanel PIXEL
	@ 026, 117 MSGET dVencFim	Valid dVencFim >= dVencIni ;
	SIZE 54,8 OF oPanel PIXEL HASBUTTON

	@ 038, 002 Say "Emissão" 		SIZE 40,7 OF oPanel PIXEL
	@ 038, 035 MSGET dEmisDe 	SIZE 54,8 OF oPanel PIXEL HASBUTTON
	@ 038, 100 Say "a" 		SIZE 40,7 OF oPanel PIXEL  //"a"
	@ 038, 117 MSGET dEmisAte   Valid dEmisAte >= dEmisDe ;
	SIZE 54,8 OF oPanel PIXEL HASBUTTON

	@ 050, 002 Say "Cliente" 		SIZE 40,7 OF oPanel PIXEL
	@ 050, 035 MSGET cCliDe F3 "CLI" SIZE 54,8 OF oPanel PIXEL HASBUTTON
	@ 050, 100 Say "a" 		SIZE 40,7 OF oPanel PIXEL
	@ 050, 117 MSGet cCliAte F3 "CLI" Valid cCliAte >= cCliDe SIZE 54,8 OF oPanel PIXEL HASBUTTON

	@ 062, 002 Say "Prefixo" 		SIZE 40,7 OF oPanel PIXEL
	@ 062, 035 MSGET cPrefDe 	SIZE 54,8 OF oPanel PIXEL
	@ 062, 100 Say "a" 		SIZE 40,7 OF oPanel PIXEL
	@ 062, 117 MSGET cPrefAte Valid cPrefAte >= cPrefDe SIZE 54,8 OF oPanel PIXEL

	@ 074, 002 Say "Título" 		SIZE 40,7 OF oPanel PIXEL
	@ 074, 035 MSGET cNumDe 		SIZE 54,8 OF oPanel PIXEL
	@ 074, 100 Say "a" 		SIZE 40,7 OF oPanel PIXEL
	@ 074, 117 MSGet cNumAte Valid cNumAte >= cNumDe SIZE 54,8 OF oPanel PIXEL
	
	@ 062, 180 Say "Contrato de" 	SIZE 40,7 OF oPanel PIXEL
	@ 062, 220 MSGET cContTINI		SIZE 54,8 OF oPanel PIXEL
	@ 074, 180 Say "Contrato ate" 	SIZE 40,7 OF oPanel PIXEL
	@ 074, 220 MSGET cContTINF Valid cPrefAte >= cPrefDe SIZE 54,8 OF oPanel PIXEL
