...
USER FUNCTION ASFINA37()
	...
	// Sugerir parâmetros
	cNaturOri	:= PADR(GETNEWPAR("AS_NMUTORI",cNaturOri),TamSX3("E5_NATUREZ")[1]," ") //GETNEWPAR("AS_NMUTORI",cNaturOri)
	cNaturDes	:= PADR(GETNEWPAR("AS_NMUTDES",cNaturOri),TamSX3("E5_NATUREZ")[1]," ") //GETNEWPAR("AS_NMUTDES",cNaturDes)              
...
STATIC FUNCTION ExecTransf()
	...
	IF lRet
		U_ASFINA58(cFilOri,cFilDes,cLoteMut,"P#R", SE5->E5_VALOR ) 
	ENDIF	
